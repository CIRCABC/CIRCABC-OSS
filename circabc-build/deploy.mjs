...
// disable service worker for Angular 18
...
if (isSCircabc) {
  await $`mvn --settings settings.xml -Ps-circabc clean deploy -Dbackend-target.env=${environment} -Drevision=4.2.0.0-SNAPSHOT`;
} else {
