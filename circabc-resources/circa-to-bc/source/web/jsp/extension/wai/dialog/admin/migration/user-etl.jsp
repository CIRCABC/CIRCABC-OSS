...
<circabc:displayer id="displayer12" rendered="#{MigrationETLBean.firstStep}">
		...
		<div class="ContentMainForm">
			<circabc:panel id="panelAddSelectIteration" label="#{cmsg.importation_etl_dialog_select_iteration}" styleClass="panelAddContentGlobal" styleClassLabel="panelAddContentLabel" tooltip="#{cmsg.importation_etl_dialog_select_iteration}">
				...
				<h:dataTable value="#{MigrationETLBean.iterationsDataModel}" var="row"
				      ...
				      <h:column>
						...
						<h:selectOneRadio value="#{MigrationETLBean.selectedIteration}"  onclick="dataTableSelectOneRadio(this);">
...
<circabc:displayer id="displayer123" rendered="#{MigrationETLBean.secondStep}">
	...
	<h:form acceptcharset="UTF-8" id="FormPrincipalSelectSecon">
		...
		<div class="ContentMainForm">
			<h:inputHidden id="selectListAnchor" value="#{MigrationETLBean.lastVisitedAnchor}"/>
			...
			<circabc:displayer id="displayerEditUser" rendered="#{MigrationETLBean.userToEdit != null}">
				<circabc:panel id="edit-user-panel" styleClass="infoPanel" styleClassLabel="infoContent"  >
					...
					<h:panelGrid columns="4" cellpadding="3" cellspacing="3" border="0" style="padding-top: 4px;"
						...
						<h:inputText value="#{MigrationETLBean.searchForUid}" onkeypress="if (event.keyCode == 13){ document.getElementById('FormPrincipalSelectSecon:manual-edit-search-uid').click(); return false;}"/>
						<h:commandButton id="manual-edit-search-uid" value="#{cmsg.importation_etl_dialog_action_search_uid}" actionListener="#{MigrationETLBean.searchEcas}" rendered="true" title="#{cmsg.importation_etl_dialog_action_search_uid}" onclick="submit();showWaitProgress();" image="/images/icons/comparetoprevious.png" >
						...
						<h:inputText value="#{MigrationETLBean.searchForMoniker}" onkeypress="if (event.keyCode == 13){ document.getElementById('FormPrincipalSelectSecon:manual-edit-search-moniker').click(); return false;}"/>
						<h:commandButton id="manual-edit-search-moniker" value="#{cmsg.importation_etl_dialog_action_search_moniker}" actionListener="#{MigrationETLBean.searchEcas}" rendered="true" title="#{cmsg.importation_etl_dialog_action_search_moniker}" onclick="submit();showWaitProgress();" image="/images/icons/comparetoprevious.png" >
						...
						<h:inputText value="#{MigrationETLBean.searchForEmail}" onkeypress="if (event.keyCode == 13){ document.getElementById('FormPrincipalSelectSecon:manual-edit-search-email').click(); return false;}"/>
						<h:commandButton id="manual-edit-search-email" value="#{cmsg.importation_etl_dialog_action_search_email}" actionListener="#{MigrationETLBean.searchEcas}" rendered="true" title="#{cmsg.importation_etl_dialog_action_search_email}" onclick="submit();showWaitProgress();" image="/images/icons/comparetoprevious.png" >
						...
						<h:inputText value="#{MigrationETLBean.searchForCn}" onkeypress="if (event.keyCode == 13){ document.getElementById('FormPrincipalSelectSecon:manual-edit-search-cn').click(); return false;}"/>
						<h:commandButton id="manual-edit-search-cn" value="#{cmsg.importation_etl_dialog_action_search_cn}" actionListener="#{MigrationETLBean.searchEcas}" rendered="true" title="#{cmsg.importation_etl_dialog_action_search_cn" onclick="submit();showWaitProgress();" image="/images/icons/comparetoprevious.png" >
					...
					<circabc:panel id="edit-user-panel-sub2"  styleClass="signup_rub_title">
						<h:outputFormat value="#{cmsg.importation_etl_dialog_action_available_propositions}:" escape="false" >
							<circabc:param value="#{MigrationETLBean.userToEdit.person.userId.value}" />
							<circabc:param value="#{MigrationETLBean.userToEdit.person.email.value}" />
						</h:outputFormat>
					</circabc:panel>
					<f:verbatim><br /></f:verbatim>

					<h:dataTable value="#{MigrationETLBean.userToEdit.propositionsKeys}" var="key"
				                rowClasses="selectedItemsRow,selectedItemsRowAlt"
				                styleClass="selectedItems" headerClass="selectedItemsHeader"
				                cellspacing="0" cellpadding="4">
					      ...
					      <h:column>
					         ...
					         <h:outputText value="#{MigrationETLBean.userToEdit.propositions[key].moniker}" />
					      </h:column>
					      <h:column>
					         <f:facet name="header">
					            <h:outputText value="#{cmsg.importation_etl_dialog_full_name}" />
					         </f:facet>
					         <h:outputText value="#{MigrationETLBean.userToEdit.propositions[key].firstname}&nbsp;#{MigrationETLBean.userToEdit.propositions[key].lastname}" escape="false"/>
					      </h:column>
					   	  <h:column>
					         <f:facet name="header">
					            <h:outputText value="#{cmsg.importation_etl_dialog_email}" />
					         </f:facet>
					         <h:outputText value="#{MigrationETLBean.userToEdit.propositions[key].email}" />
					      </h:column>
						<h:column>
					         <f:facet name="header">
					            <h:outputText value="#{cmsg.importation_etl_dialog_action}" />
					         </f:facet>
							<circabc:actionLink actionListener="#{MigrationETLBean.removeSelection}"
							...
							<circabc:actionLink actionListener="#{MigrationETLBean.updateSelection}"
			...
			<circabc:panel id="panelvalidUserDataModel" label="#{cmsg.importation_etl_dialog_valid_list}" styleClass="panelAddContentGlobal" styleClassLabel="panelAddContentLabel" tooltip="#{cmsg.importation_etl_dialog_valid_list}">
				<f:verbatim><br /></f:verbatim>
				<h:dataTable value="#{MigrationETLBean.validUserDataModel}" var="val"
			                rowClasses="selectedItemsRow,selectedItemsRowAlt"
			                styleClass="selectedItems" headerClass="selectedItemsHeader"
			                cellspacing="0" cellpadding="4">
					...
					<h:column>
						...
						<circabc:actionLink actionListener="#{MigrationETLBean.makePathologic}"
			...
			<circabc:panel id="panelinvalidUserDataModel" label="#{cmsg.importation_etl_dialog_invalid_list}" styleClass="panelAddContentGlobal" styleClassLabel="panelAddContentLabel" tooltip="#{cmsg.importation_etl_dialog_invalid_list}">
				<f:verbatim><br /></f:verbatim>
				<h:dataTable value="#{MigrationETLBean.invalidUserDataModel}" var="inval"
			                rowClasses="selectedItemsRow,selectedItemsRowAlt"
			                styleClass="selectedItems" headerClass="selectedItemsHeader"
			                cellspacing="0" cellpadding="4">
				  ...
				  <h:column>
					 ...
					 <h:outputText value="#{MigrationETLBean.incAnchorCounter}" />
			      </h:column>
				  ...
				  <h:column>
						...
						<circabc:actionLink actionListener="#{MigrationETLBean.makeValid}"
							image="/images/icons/approve.gif" value="#{cmsg.importation_etl_dialog_action_make_valid}" tooltip="#{cmsg.importation_etl_dialog_action_make_valid}" showLink="false" styleClass="pad6Left" >
							<circabc:param name="anchor" value="ninvalidAnchor#{MigrationETLBean.anchorCounter}" />
						</circabc:actionLink>
						<f:verbatim>&nbsp;</f:verbatim>
						<circabc:actionLink actionListener="#{MigrationETLBean.selectForEditing}"
							image="/images/icons/blog_update.png" value="#{cmsg.importation_etl_dialog_action_select_edit}" tooltip="#{cmsg.importation_etl_dialog_action_select_edit}" showLink="false" styleClass="pad6Left" >
							<circabc:param name="anchor" value="ninvalidAnchor#{MigrationETLBean.anchorCounter}" />
						</circabc:actionLink>
						<f:verbatim>&nbsp;</f:verbatim>
...
<circabc:displayer id="displayer1234" rendered="#{MigrationETLBean.thirdStep}">
		...
		<div class="ContentMainForm">
			<circabc:panel id="panelAddSelectIteration" label="#{cmsg.add_content_label}" styleClass="panelAddContentGlobal" styleClassLabel="panelAddContentLabel" tooltip="#{cmsg.add_content_label_tooltip}">
				<circabc:panel id="etl--warning" styleClass="infoPanel" styleClassLabel="infoContent" >
					...
					<h:outputText id="etl-text-warning" value="#{MigrationETLBean.message}" escape="false" />
				</circabc:panel>
			</circabc:panel>
		</div>
	</h:form>
