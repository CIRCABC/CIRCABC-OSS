...
/**
 * Adapt the Security Ranking property.
 *
 * @author Yanick Pignot
 */

public class SecurityRankingPropertyAdapter extends PropertyAdapterBase
{

	@Override
	public TypedProperty unmarshal(String propertyStringValue) throws Exception
	{
		return new TypedProperty.SecurityRankingProperty(propertyStringValue);
	}
