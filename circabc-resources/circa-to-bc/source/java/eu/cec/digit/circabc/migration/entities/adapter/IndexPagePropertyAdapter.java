...
/**
 * Adapt the information service default index page property.
 *
 * @author Yanick Pignot
 */

public class IndexPagePropertyAdapter extends PropertyAdapterBase
{

	@Override
	public TypedProperty unmarshal(String propertyStringValue) throws Exception
	{
		return new TypedProperty.IndexPageProperty(propertyStringValue);
	}
