...
/**
 * Adapt the Dynamic Property 4 property.
 *
 * @author Yanick Pignot
 */

public class DynamicProperty4Adapter extends PropertyAdapterBase
{

	@Override
	public TypedProperty unmarshal(String propertyStringValue) throws Exception
	{
		return new TypedProperty.DynamicProperty4(propertyStringValue);
	}
