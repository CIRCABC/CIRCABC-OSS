...
/**
 * Adapt the Postal Address property.
 *
 * @author Yanick Pignot
 */

public class PostalAddressPropertyAdapter extends PropertyAdapterBase
{

	@Override
	public TypedProperty unmarshal(String propertyStringValue) throws Exception
	{
		return new TypedProperty.PostalAddressProperty(propertyStringValue);
	}
