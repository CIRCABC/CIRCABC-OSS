...
/**
 * Adapt the Dynamic Property 3 property.
 *
 * @author Yanick Pignot
 */

public class DynamicProperty3Adapter extends PropertyAdapterBase
{

	@Override
	public TypedProperty unmarshal(String propertyStringValue) throws Exception
	{
		return new TypedProperty.DynamicProperty3(propertyStringValue);
	}
