...
/**
 * Adpat the xml date time and jre date  at the unmarshal/marshal time.
 *
...
public class DateTimeAdapter extends XmlAdapter<String, Date>
{
	...
	{
		return DateAdapterUtils.marshalDateTime(jreDate);
	}

	@Override
	public Date unmarshal(String xmlDate) throws Exception
	{
		return DateAdapterUtils.unmarshalDateTime(xmlDate);
	}
}
