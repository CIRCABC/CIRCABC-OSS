...
/**
* Adapt the password property.
*
* @author Slobodan Filipovic
*/

public class PasswordPropertyAdapter extends PropertyAdapterBase
{

	@Override
	public TypedProperty unmarshal(String propertyStringValue) throws Exception
	{
		return new TypedProperty.PasswordProperty(propertyStringValue);
	}
