...
/**
 * Adapt the calendar week start day property.
 *
 * @author Yanick Pignot
 */

public class WeekStartDayPropertyAdapter extends PropertyAdapterBase
{

	@Override
	public TypedProperty unmarshal(String propertyStringValue) throws Exception
	{
		return new TypedProperty.WeekStartDayProperty(propertyStringValue);
	}
