...
/**
 * Adapt the Dynamic Property 5 property.
 *
 * @author Yanick Pignot
 */

public class DynamicProperty5Adapter extends PropertyAdapterBase
{

	@Override
	public TypedProperty unmarshal(String propertyStringValue) throws Exception
	{
		return new TypedProperty.DynamicProperty5(propertyStringValue);
	}
