...
/**
 * Adapt the interest group contact information property.
 *
 * @author Yanick Pignot
 */

public class ContactInfoPropertyAdapter extends PropertyAdapterBase
{

	@Override
	public TypedProperty unmarshal(String propertyStringValue) throws Exception
	{
		return new TypedProperty.ContactInfoProperty(propertyStringValue);
	}
