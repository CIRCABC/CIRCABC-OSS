...
/**
 * Adapt the First Name property.
 *
 * @author Yanick Pignot
 */

public class FirstNamePropertyAdapter extends PropertyAdapterBase
{

	@Override
	public TypedProperty unmarshal(String propertyStringValue) throws Exception
	{
		return new TypedProperty.FirstNameProperty(propertyStringValue);
	}
