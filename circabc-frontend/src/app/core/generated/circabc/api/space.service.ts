...
export class SpaceService {
     ...
     * @param skipExpiredItems If true, expired items (based on bprop:expiration_date) are skipped. Default is false. 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getChildren(id: string, language?: string, guest?: boolean, limit?: number, page?: number, order?: string, folderOnly?: boolean, fileOnly?: boolean, skipExpiredItems?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<PagedNodes>;
    public getChildren(id: string, language?: string, guest?: boolean, limit?: number, page?: number, order?: string, folderOnly?: boolean, fileOnly?: boolean, skipExpiredItems?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<PagedNodes>>;
    public getChildren(id: string, language?: string, guest?: boolean, limit?: number, page?: number, order?: string, folderOnly?: boolean, fileOnly?: boolean, skipExpiredItems?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<PagedNodes>>;
    public getChildren(id: string, language?: string, guest?: boolean, limit?: number, page?: number, order?: string, folderOnly?: boolean, fileOnly?: boolean, skipExpiredItems?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        if (id === null || id === undefined) {
        ...
        if (skipExpiredItems !== undefined && skipExpiredItems !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>skipExpiredItems, 'skipExpiredItems');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getSubspaces(id: string, language?: string, sort?: string, order?: string, skipExpiredItems?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<Array<Node>>;
    public getSubspaces(id: string, language?: string, sort?: string, order?: string, skipExpiredItems?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpResponse<Array<Node>>>;
    public getSubspaces(id: string, language?: string, sort?: string, order?: string, skipExpiredItems?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<HttpEvent<Array<Node>>>;
    public getSubspaces(id: string, language?: string, sort?: string, order?: string, skipExpiredItems?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        if (id === null || id === undefined) {
