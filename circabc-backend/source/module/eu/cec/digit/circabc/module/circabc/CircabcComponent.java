...
public class CircabcComponent extends AbstractModuleComponent {
  ...
  private void runMakeStatisticFolderSecure(
    final RetryingTransactionHelper txnHelper
  ) {
  ...
  private void makeSecureStatFolder() {
    ...
    NodeRef statisticsFolder = nodeService.getChildByName(
      getManagementService().getCircabcDictionaryNodeRef(),
        ...
        public String convert(ArrayList source) {
          ...
          try {
            for (Object element : source) {
              result
                .append(
                  DefaultTypeConverter.INSTANCE.convert(String.class, element)
                )
                .append(" ");
            }
            ...
            throw new TypeConversionException(
              "Failed to convert ArrayList to String: " + source,
              e
            );
          }
        }
      ...
      new TypeConverter.Converter<HashMap, String>() {
        public String convert(HashMap source) {
          ...
          try {
            ...
            throw new TypeConversionException(
              "Failed to convert HashMap to String: " + source,
              e
            );
          }
        }
  ...
  private void runCreateTemplateUser(
    final RetryingTransactionHelper txnHelper
  ) {
  ...
  private void runCreateMachineTranslationUser(
    final RetryingTransactionHelper txnHelper
  ) {
      ...
      new AuthenticationUtil.RunAsWork<Object>() {
        public Object doWork() {
          txnHelper.doInTransaction(
            createCircabcAdminUserCallback,
            false,
            true
          );
  ...
  private void runCreateMachineTranslationSpace(
    final RetryingTransactionHelper txnHelper
  ) {
  ...
  private void runCreateMachineTranslationSpaceEUSurvey(
    final RetryingTransactionHelper txnHelper
  ) {
    final RetryingTransactionCallback<Object> createMTCallback =
      new RetryingTransactionCallback<Object>() {
  ...
  private void runSetGuestReadPermissionOnVersionStoreCallback(
    ...
    final RetryingTransactionCallback<
      Object
    > setGuestReadPermissionOnVersionStoreCallback =
      new RetryingTransactionCallback<Object>() {
        public Object execute() throws Throwable {
  ...
  private void runCreateFaqLinksFolder(
    final RetryingTransactionHelper txnHelper
  ) {
    final RetryingTransactionCallback<Object> setCreateFaqsFolderCallback =
      new RetryingTransactionCallback<Object>() {
  ...
  private void runUpdateSupportMailTemplate(
    final RetryingTransactionHelper txnHelper
  ) {
    final RetryingTransactionCallback<
      Object
    > setGuestReadPermissionOnMailTemplateCallback =
      new RetryingTransactionCallback<Object>() {
        public Object execute() throws Throwable {
  ...
  private void setGuestReadPermissionOnMailTemplate() {
    ...
    if (templatesRef != null) {
      NodeRef mailsRef = nodeService.getChildByName(
        templatesRef,
        ContentModel.ASSOC_CONTAINS,
        "mails"
      );
      ...
      if (mailsRef != null) {
        NodeRef supportRef = nodeService.getChildByName(
          mailsRef,
          ContentModel.ASSOC_CONTAINS,
          "supportRequest"
        );
        ...
        if (supportRef != null) {
          NodeRef templateMailRef = nodeService.getChildByName(
            supportRef,
            ContentModel.ASSOC_CONTAINS,
            "default.ftl"
          );
  ...
  private void createTemplateUser() {
    final CircabcUserDataBean templateUser =
      mailPreferencesService.getTemplateUserDetails();
  ...
  private void createCircabc() {
    if (managementService.getCircabcNodeRef() == null) {
      ...
      final String description = CircabcConfiguration.getProperty(
        CircabcConfiguration.CIRCABC_ROOT_NODE_DESCRIPTION_PROPERTIES
      );
      final String title = CircabcConfiguration.getProperty(
        CircabcConfiguration.CIRCABC_ROOT_NODE_TITLE_PROPERTIES
      );

      final NodeRef circabcNodeRef = managementService.createCircabc(
        companyHome
      );
  ...
  private void createMTEUS() {
    if (CircabcConfig.ENT && !CircabcConfig.ECHA) {
      ...
      if (circabcHome != null) {
        ...
        NodeRef mtNodeRef = nodeService.getChildByName(
          circabcHome,
          ContentModel.ASSOC_CONTAINS,
          mtRootSpaceName
        );
        if (mtNodeRef == null) {
          ...
          permissionService.setInheritParentPermissions(mtNodeRef, false);
          final CircabcUserDataBean mtUser =
            translationService.getMTUserDetails();
          permissionService.setPermission(
            mtNodeRef,
            mtUser.getUserName(),
            PermissionService.CONTRIBUTOR,
  ...
  private void createCircabcAdminUser() {
    ...
    String adminName = CircabcConfiguration.getProperty(
      CircabcConfiguration.ROOT_ADMIN_NAME_PROPERTIES
    );
    if (personService.getUserNamesAreCaseSensitive()) {
      adminName = adminName.toLowerCase();
    }

    String adminMail = CircabcConfiguration.getProperty(
      CircabcConfiguration.ROOT_ADMIN_MAIL_PROPERTIES
    );
    if (personService.getUserNamesAreCaseSensitive()) {
    ...
    if ((circabcNodeRef != null) && !personService.personExists(adminName)) {
      ...
      if (!CircabcConfig.USE_LDAP) {
        ...
        final CircabcUserDataBean ldapUserDetail =
          userService.getLDAPUserDataByUid(adminName);
      ...
      circabcRootProfileManagerService.addPersonToProfile(
        circabcNodeRef,
        circaBCAdmin.getUserName(),
        profile
      );
    }
  }
  ...
  private void setGuestReadPermissionOnVersionStore() {
    ...
    final NodeRef versionRootNodeRef = nodeService.getRootNode(
      this.serviceRegistry.getVersionService().getVersionStoreReference()
    );
