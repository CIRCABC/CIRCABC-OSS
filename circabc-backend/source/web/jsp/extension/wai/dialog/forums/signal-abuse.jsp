...
<circabc:panel id="contentMainSignalAbuse" styleClass="contentMainForm">

		<f:verbatim><br /></f:verbatim>

		<!--  Fill the message -->

		<circabc:panel id="signal-abuse-section-reason" styleClass="signup_rub_title">
			<h:outputText value="#{cmsg.moderation_signal_abuse_dialog_section_message}" />
		</circabc:panel>
		...
		<circabc:panel id="signal-abuse-section-post-details" styleClass="signup_rub_title">
