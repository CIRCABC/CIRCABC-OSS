...
<!--  New keyword panel -->
	...
	<h:selectOneMenu id="set-keywords-language" value="#{DialogManager.bean.selectedLanguage}" onchange="updateList()" valueChangeListener="#{SetKeywordsDialog.updateList}" immediate="true"  >
	...
	<h:selectManyListbox id="set-keywords-list" style="width:250px" size="6">
	...
	<circabc:panel id="add-keywords-second-section" styleClass="signup_rub_title">
		<h:outputText id="set-keywords-add-to-list-space" value="2.&nbsp;#{cmsg.set_document_keyword_dialog_section_add}" escape="false" />
	</circabc:panel>
