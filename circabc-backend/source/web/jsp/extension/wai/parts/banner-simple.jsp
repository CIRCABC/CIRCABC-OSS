...
<div id="bannerBackground">
	...
	<div id="langsSelector">
                      <script type="text/javascript" language="JavaScript">
							document.write('<h:selectOneMenu id="language" style="font-size:11pt;" value="#{UserPreferencesBean.language}" onchange="document.forms[0].submit(); return true;"><f:selectItems value="#{UserPreferencesBean.languages}" /></h:selectOneMenu>');
						</script>
                ...
                <div id="linkBox">
                	...
                	<c:if test="${!NavigationBean.echaEnabled}">
	                    ...
	                    <div id="linkBoxTools">
								<ul>
										<!-- search -->				
										<li class="first"><a accesskey="4" href="http://ec.europa.eu/geninfo/query/search_${currentLocale}.html" target="_blank">Search</a></li>
										|
										<!-- contact -->			
										<li>
											<circabc:displayer rendered="#{NavigationBean.enterpriseEnabled}">
												...
												<div id="contactLinkDiv">
													...
													<h:outputText escape="false" value="#{cmsg.contact_message_part_one }"></h:outputText>
													<h:outputText escape="false" value="#{cmsg.contact_message_part_two }"></h:outputText>
													<img src="${currentContextPath}/images/extension/mails.png" alt="mails" style="float:right;"/>
													<h:outputText escape="false" value="#{cmsg.contact_message_part_three}"></h:outputText>
													
													
													
															<hr noshade="noshade" style="color:#F5F5F5;"/>
															<br/>
															<b><h:outputText value="#{cmsg.contact_message_or}"></h:outputText></b>
															<br/>
											...
											<circabc:displayer rendered="#{NavigationBean.enterpriseEnabled == false}">
												<a id="contactLink" accesskey="7" href="<h:outputText value="#{NavigationBean.bannerContactLink}"></h:outputText>" >Contact</a>
        ...
        <div id="path">
            <div>
                <ul>
					...
					&gt;
                    <li>
						<circabc:actionLink tooltip="" href="#{NavigationBean.circabcRootLink}" value="#{NavigationBean.appName}"></circabc:actionLink>
					</li>
                </ul>
            </div>
        </div>
