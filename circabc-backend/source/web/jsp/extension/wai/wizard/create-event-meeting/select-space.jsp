...
<circabc:panel id="selectSpaceWizardMainForm" styleClass="contentFullPage">
	...
	<circabc:nodeSelector id="space-selector"
				rootNode="#{WaiWizardManager.bean.libraryId}"
				initialSelection="#{WaiWizardManager.bean.libraryId}"
				label="#{msg.select_destination_prompt}"
				value="#{WaiWizardManager.bean.appointment.librarySection}"
