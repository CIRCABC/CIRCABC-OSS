...
<tr><td class="paddingRow"></td></tr>
<tr>
<td><nobr><h:outputText value="binding"/>:</nobr></td>
<td>
<h:selectOneMenu id="subscriptions" value="#{WizardManager.bean.actionProperties.binding}">
        <f:selectItem id="CREATE_NEW" itemLabel="CREATE_NEW" itemValue="CREATE_NEW" />
        <f:selectItem id="CREATE_NEW_WITH_UUID" itemLabel="CREATE_NEW_WITH_UUID" itemValue="CREATE_NEW_WITH_UUID" />
        <f:selectItem id="REMOVE_EXISTING" itemLabel="REMOVE_EXISTING" itemValue="REMOVE_EXISTING" />
        <f:selectItem id="REPLACE_EXISTING" itemLabel="REPLACE_EXISTING" itemValue="REPLACE_EXISTING" />
        <f:selectItem id="UPDATE_EXISTING" itemLabel="UPDATE_EXISTING" itemValue="UPDATE_EXISTING" />
        <f:selectItem id="THROW_ON_COLLISION" itemLabel="THROW_ON_COLLISION" itemValue="THROW_ON_COLLISION" />
    </h:selectOneMenu>
</td>
</tr>
<tr><td class="paddingRow"></td></tr>
