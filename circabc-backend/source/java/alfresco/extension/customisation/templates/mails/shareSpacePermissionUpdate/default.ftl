                    ...
                    <tr>
                      <td align="left">
                      	<h1 style="font-family: Helvetica, Arial, sans-serif; font-size: 28px; font-weight:normal; color: #2C3E50; margin:0; mso-line-height-rule:exactly;">
                      		${formatMessage("share_space_permission_update_title")}</h1>
                      </td>
                    </tr>
                    <tr>
                      <td align="center" height="25" style="height:25px; font-size: 0;">&nbsp;</td>
                    ...
                    <tr>
                      <td align="left" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; line-height: 25px; color: #2C3E50;"> 
                        ...
                        <br>
							...
							${formatMessage("share_space_permission_update_body_new",
								fullName(me),
								location.name,
                      ...
                      <table role="presentation" border="0" cellspacing="0" cellpadding="0" class="mobile-btn-container">
                          <tr>
                            <td align="center" style="border-radius: 3px;" bgcolor="#8dcb6c">
                            	<a href="${libraryAccessUrl(location)}" title="Read more" target="_blank" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 15px 25px; border: 1px solid #8dcb6c; display: inline-block;" class="mobile-btn">
			...
			<table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; line-height: 25px; color: #2C3E50;">
		             ...
		             <b>${formatMessage("share_space_your_ig")}</b>: ${formatMessage("mails_common_href", titleOrName(yourinterestGroup), groupAccessUrl(yourinterestGroup))} ${formatMessage("share_space_your_ig_perm")}<br />
					<b>${formatMessage("share_space_permission_update_permission")}</b>: ${profile}<br />
					<b>${formatMessage("share_space_location")}</b>: ${formatMessage("mails_common_href", circabcPath(location), libraryAccessUrl(location))}<br />
					<b>${formatMessage("share_space_access")}</b>: ${formatMessage("mails_common_href", libraryAccessUrl(location), libraryAccessUrl(location))}<br />
