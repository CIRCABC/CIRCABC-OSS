                ...
                <td><table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td align="left" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; line-height: 25px; color: #2C3E50;"> 
							${formatMessage("notification_message_group_members_new",
			...
			<table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" style="font-family: Helvetica, Arial, sans-serif; font-size: 16px; line-height: 25px; color: #2C3E50;">
					...
					<#if fromUser??><b>${formatMessage("mails_new_group_from_user")} </b>${fullName(fromUser)}<br/></#if>
			       ...
			       <#if attachments?exists><br/><br/><b>${formatMessage("email_label_attachments")}: </b><br/>
			       	<#list attachments as attachment>
						<#if attachment.properties['cm:name'] ? exists><a href="${libraryAccessUrl(attachment)}" target="_blank">${attachment.properties['cm:name']}: </a><br/></#if>
						<#if (attachment_has_next)><br/> </#if>
					</#list>
