    ...
    public void execute(WebScriptRequest req, WebScriptResponse res) throws IOException
    {
        ...
        try
        {
            ...
            if(transformException != null)
            {
                ...
                // change original Alfresco code WL does not like CRLF characters in header values
                res.setHeader(TRANSFORM_EXCEPTION_HEADER, transformException.getMessage().replace("\n", "").replace("\r", "")); 
                res.setStatus(HttpStatus.SC_NO_CONTENT);
            }
            else
            {
