...
public class CategoriesApiImpl implements CategoriesApi {
  ...
  public void groupIdDeleteRequestPost(GroupDeletionRequest body) {
    ...
    String title = interestGroup.getTitle() != null
      ? interestGroup.getTitle().getDefaultValue()
      : null;
    ...
    String description = interestGroup.getDescription() != null
      ? interestGroup.getDescription().getDefaultValue()
      : null;
  ...
  public void categoriesIdGroupRequestDeleteApprovalPost(
    ...
    if (body.getArgument() != null && body.getAgreement() == -1) {
      ...
      leaders
        ...
        .forEach(leader -> {
          EmailDefinition emailDef_leaders =
