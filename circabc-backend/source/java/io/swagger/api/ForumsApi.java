...
public interface ForumsApi {
  /**
   * get the content of a forums returns a list of forums/topics or any kind of
   * child of this node
  ...
  /**
   * create a new empty topic within one forum this does not create any post
   * inside mapped url
   * /forums/{id}/content
   */
  ...
  /**
   * toggle the moderation of a forum. acceptAll is only considered if moderation
   * is being disabled
