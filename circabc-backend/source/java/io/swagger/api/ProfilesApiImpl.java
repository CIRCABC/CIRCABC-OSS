...
public class ProfilesApiImpl implements ProfilesApi {
  ...
  public Profile profilesIdPut(NodeRef profileRef, Profile body) {
    ...
    List<ChildAssociationRef> dirRefAssoc = nodeService.getChildAssocs(
      profileRef,
      CircabcModel.PROP_IG_ROOT_SERVICE_ASSOC,
      DIRECTORY
    );
    ...
    List<ChildAssociationRef> libRefAssoc = nodeService.getChildAssocs(
      profileRef,
      CircabcModel.PROP_IG_ROOT_SERVICE_ASSOC,
      LIBRARY
    );
    ...
    List<ChildAssociationRef> nwsRefAssoc = nodeService.getChildAssocs(
      profileRef,
      CircabcModel.PROP_IG_ROOT_SERVICE_ASSOC,
      NEWSGROUP
    );
    ...
    List<ChildAssociationRef> evtsRefAssoc = nodeService.getChildAssocs(
      profileRef,
      CircabcModel.PROP_IG_ROOT_SERVICE_ASSOC,
      EVENT
    );
    ...
    List<ChildAssociationRef> infRefAssoc = nodeService.getChildAssocs(
      profileRef,
      CircabcModel.PROP_IG_ROOT_SERVICE_ASSOC,
      INFORMATION
    );
    ...
    List<ChildAssociationRef> visRefAssoc = nodeService.getChildAssocs(
      profileRef,
      CircabcModel.PROP_IG_ROOT_SERVICE_ASSOC,
      VISIBILITY
    );
  ...
  private void applyLibraryPermissions(NodeRef profileRef, Profile body) {
    ...
    permissionService.setPermission(
      serviceRef,
      body.getGroupName(),
      body.getPermissions().get(LIBRARY_KEY),
      true
    );
  }
  ...
  private void applyInformationPermissions(NodeRef profileRef, Profile body) {
    ...
    permissionService.setPermission(
      serviceRef,
      body.getGroupName(),
      body.getPermissions().get(INFORMATION_KEY),
      true
    );
  }
  ...
  private void applyNewsgroupsPermissions(NodeRef profileRef, Profile body) {
    ...
    permissionService.setPermission(
      serviceRef,
      body.getGroupName(),
      body.getPermissions().get(NEWSGROUP_KEY),
      true
    );
  }
  ...
  private void applyEventsPermissions(NodeRef profileRef, Profile body) {
    ...
    permissionService.setPermission(
      serviceRef,
      body.getGroupName(),
      body.getPermissions().get(EVENT_KEY),
      true
    );
  }
  ...
  public final Set<String> getInvitedUsers(
    NodeRef nodeRef,
    ...
    final String userGroupName = (String) nodeService.getProperty(
      ...
      QName.createQName(
        ...
        profilePrefix + "InvitedUsersGroup"
      )
    );
