...
public class TopicsApiImpl implements TopicsApi {
  ...
  /**
   * @see io.swagger.api.TopicsApi#topicsIdRepliesPost(java.lang.String,
    ...
    if (
      ...
      if (nbLimit != -1) {
        final PagingResults<FileInfo> list = getFileFolderService()
          .list(topicRef, true, false, new HashSet<QName>(), null, pr);
  ...
  public List<Attachement> getAttachments(String id) {
    ...
    List<Attachement> attachments = attachementBusinessSrv.getAttachements(
      postNodeRef
    );
  ...
  public void addFileAttachment(
    ...
    try {
      ESAPI.validator()
        .getValidFileName("submitted file", name, allowedFileExtensions, false);
   ...
   */
  public void setAttachementBusinessSrv(
    AttachementBusinessSrv attachementBusinessSrv
  ) {
