...
public class UserManager {
  ...
  private static final String SEARCH_EMAIL_LUCENE =
    "TYPE:\\'{'http\\://www.alfresco.org/model/content/1.0\\'}'person +@cm\\:email:\"{0}\"";
   ...
   */
  public Serializable getUserPreference(
  ...
  private NodeRef getOrCreateUserPreferencesRef(
    ...
    if (
      nodeService.hasAspect(person, ApplicationModel.ASPECT_CONFIGURABLE) ==
      false
    ) {
      if (createIfMissing) {
   ...
   */
  public final void setConfigurableService(
