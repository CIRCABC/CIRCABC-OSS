...
public class ValidationManager {
  ...
  private static final String MSG_UNEXISTING_REF =
    "business_validation_unexisting_ref";
  private static final String MSG_NORIGHT_REF =
    "business_validation_noright_ref";
  ...
  private static final String MSG_INVALID_NAME =
    "business_validation_invalid_name";
  private static final String MSG_NO_FIRSTNAME =
    "business_validation_no_firstname";
  private static final String MSG_NO_LASTNAME =
    "business_validation_no_lastname";
  private static final String MSG_NO_EMAIL = "business_validation_no_email";
  private static final String MSG_DUPLICATE_EMAIL =
    "business_validation_duplicate_email";
  private static final String MSG_INVALID_EMAIL =
    "business_validation_invalid_email";
  private static final String MSG_EXPIRATION =
    "business_validation_expiration_before_today";
  private static final String MSG_NOT_CONTENT =
    "business_validation_not_a_content";
  private static final String MSG_NOT_SPACE = "business_validation_not_a_space";
  private static final String MSG_NOT_SHARED_SPACE =
    "business_validation_not_a_shared_space";
  private static final String MSG_NOT_LOCKED =
    "business_validation_not_a_locked_content";
  private static final String MSG_NOT_WORKING_COPY =
    "business_validation_not_a_working_copy";
  private static final String MSG_NOT_IN_LIBRARY =
    "business_validation_not_in_library";
  private static final String MSG_NOT_A_IG =
    "business_validation_not_an_interestgroup";
  private static final String MSG_NOT_PERSON =
    "business_validation_not_a_person";
  private static final String MSG_GUEST = "business_validation_guest";
  private static final String MSG_NO_USERNAME =
    "business_validation_no_username";
  private static final String MSG_DUPLICATE_USERNAME =
    "business_validation_duplicate_username";
  private static final String MSG_NOT_IN_INFORMATION =
    "business_validation_not_in_information";
  private static final String MSG_NOT_IN_DIRECTROY =
    "business_validation_not_in_directory";
  private static final String MSG_NOT_IN_NEWSGROUP =
    "business_validation_not_in_newsgroup";
  private static final String MSG_NOT_IN_CALENDAR =
    "business_validation_not_in_calendar";
  private static final String MSG_NOT_IN_SURVEYS =
    "business_validation_not_in_survey";

  private static final String MSG_LOCKED = "business_validation_a_locked";
  private static final String MSG_WORKING_COPY =
    "business_validation_a_working_copy";
   ...
   */
  public void validateCanEditProperties(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateNotNull(nodeRef, stack);
   ...
   */
  public void validateCanUpdateContent(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateNotNull(nodeRef, stack);
   ...
   */
  public void validateCanAddChild(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateNotNull(nodeRef, stack);
   ...
   */
  public void validateUpdatableContent(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
   ...
   */
  public void validateSharedSpace(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
   ...
   */
  public void validateLockedContent(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateContent(nodeRef, stack);
   ...
   */
  public void validateWorkingCopyContent(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateContent(nodeRef, stack);
   ...
   */
  public void validateInterstGroup(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateNotNull(nodeRef, stack);
   ...
   * service
   */
  public void validateInformationChild(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateNotNull(nodeRef, stack);
   ...
   * service
   */
  public void validateLibraryChild(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateNotNull(nodeRef, stack);
   ...
   * service
   */
  public void validateDirectoryChild(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateNotNull(nodeRef, stack);
   ...
   * service
   */
  public void validateNewsgroupChild(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateNotNull(nodeRef, stack);
   ...
   * service
   */
  public void validateCalendarChild(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateNotNull(nodeRef, stack);
   ...
   */
  public void validateSurveyChild(
    final NodeRef nodeRef,
    final BusinessStackError stack
  ) {
    validateNotNull(nodeRef, stack);
   ...
   */
  private boolean validateHasText(
  ...
  private BusinessStackError append(
    final BusinessStackError stack,
    String message
  ) {
