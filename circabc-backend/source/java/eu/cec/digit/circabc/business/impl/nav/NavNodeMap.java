...
public class NavNodeMap implements NavNode, Serializable {
  ...
  private Map<String, RuntimePropertyResolver> runtimeProperties =
    new HashMap<>(12);
   ...
   */
  public NavNodeMap(
    final NodeRef nodeId,
    final Map<String, PropertyItem> properties,
  ...
  public final void addPropertyResolver(
    String name,
    RuntimePropertyResolver resolver
  ) {
  ...
  public boolean containsKey(Object key) {
    return (
      getProperties().containsKey(key) || runtimeProperties.containsKey(key)
    );
  }
