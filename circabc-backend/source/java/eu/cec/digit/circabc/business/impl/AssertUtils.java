...
public abstract class AssertUtils {
  ...
  private static final String MSG_EMPTY_COLLECTION =
    "business_error_empty_collection";
  private static final String MSG_EMPTY_STRING = "business_error_empty_string";

  private AssertUtils() {}

  public static void notNull(final Object object)
    throws BusinessRuntimeExpection {
    if (object == null) {
      throw new BusinessRuntimeExpection(
        MSG_GENERIC,
  ...
  public static void notEmpty(final Map map) throws BusinessRuntimeExpection {
    ...
    if (map.size() < 1) {
      throw new BusinessRuntimeExpection(
        MSG_EMPTY_COLLECTION,
        new IllegalArgumentException(
          "The map is empty and MUST have at least one element."
        )
      );
    }
  }
  ...
  public static void canAccess(final File file)
    throws BusinessRuntimeExpection {
    ...
    if (file == null) {
      ...
      cause = new IOException(
        "Cannot obtain read permission on uploaded file : " +
