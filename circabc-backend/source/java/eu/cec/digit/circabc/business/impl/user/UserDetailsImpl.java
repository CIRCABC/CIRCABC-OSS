...
public class UserDetailsImpl implements Serializable, UserDetails {
  ...
  public final Boolean getGlobalNotification() {
    final Boolean notfication = (Boolean) getProperty(
  ...
  public final String getUserInterfaceLanguage() {
    final String lang = (String) getPreference(
  ...
  public final String getDisplayId() {
    final String displayName = (String) getProperty(
  ...
  public boolean isPersonalDataHidden() {
    if (personalDataHidden == null) {
      ...
      if (
        currentUser == null ||
        currentUser.equals(CircabcConstant.GUEST_AUTHORITY)
      ) {
  ...
  private Serializable getProperty(
    final QName qname,
    final boolean checkUpdated
  ) {
    if (
      checkUpdated &&
      updatedProperties != null &&
      updatedProperties.containsKey(qname)
    ) {
  ...
  private Serializable getPreference(
    final QName qname,
    final boolean checkUpdated
  ) {
    if (getOriginalPreferences() == null) {
      ...
      if (
        ...
        updatedPreferences.containsKey(qname)
      ) {
