 ...
 */
public class SpaceBusinessImpl
  extends ContainerBaseBusinessService
  implements SpaceBusinessSrv {
  ...
  public NodeRef createSpace(
    ...
    return createSpace(
      ...
      title,
      description,
      getConfigManager().getIcon(ContentModel.TYPE_FOLDER, iconName),
      expirationDate
    );
  }
