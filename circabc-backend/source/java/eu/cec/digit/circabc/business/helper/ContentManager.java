...
public class ContentManager {
  ...
  private NodeRef createContent(
    ...
    final QName validAssocQName = associationQname == null
      ? ContentModel.ASSOC_CONTAINS
      : associationQname;
    final QName validTypeQName = childTypeQName == null
  ...
  private void updateContent(
    ...
    QName propContent = UtilsCircabc.getPropContent(
      nodeService.getType(contentRef)
    );
  ...
  private void updateProperties(
    ...
    if (logger.isDebugEnabled()) {
      logger.debug(
        "Titled aspect setted with title: " +
        title +
        " and description: " +
        description
      );
