 ...
 */
public class DossierBusinessImpl
  extends ContainerBaseBusinessService
  implements DossierBusinessSrv {
  ...
  public NodeRef createDossier(
    ...
    return createContainerImpl(
      ...
      title,
      description,
      getConfigManager().getIcon(DossierModel.TYPE_DOSSIER_SPACE, iconName),
      null
    );
  }
