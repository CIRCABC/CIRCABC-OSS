...
public class BusinessRegistryImpl implements BusinessRegistry {
  ...
  public MailMeContentBusinessSrv getMailMeContentBusinessSrv() {
    return (MailMeContentBusinessSrv) this.circabcServiceRegistry.getService(
        MAIL_ME_BUSINESS_SERVICE
      );
  }
  ...
  public ContentBusinessSrv getContentBusinessSrv() {
    return (ContentBusinessSrv) this.circabcServiceRegistry.getService(
        CONTENT_BUSINESS_SERVICE
      );
  }
  ...
  public CociContentBusinessSrv getCociContentBusinessSrv() {
    return (CociContentBusinessSrv) this.circabcServiceRegistry.getService(
        COCI_BUSINESS_SERVICE
      );
  }
  ...
  public NavigationBusinessSrv getNavigationBusinessSrv() {
    return (NavigationBusinessSrv) this.circabcServiceRegistry.getService(
        NAVIGATION_BUSINESS_SERVICE
      );
  }
  ...
  public SpaceBusinessSrv getSpaceBusinessSrv() {
    return (SpaceBusinessSrv) this.circabcServiceRegistry.getService(
        SPACE_BUSINESS_SERVICE
      );
  }
  ...
  public PropertiesBusinessSrv getPropertiesBusinessSrv() {
    return (PropertiesBusinessSrv) this.circabcServiceRegistry.getService(
        PROPERTIES_BUSINESS_SERVICE
      );
  }
  ...
  public DossierBusinessSrv getDossierBusinessSrv() {
    return (DossierBusinessSrv) this.circabcServiceRegistry.getService(
        DOSSIER_BUSINESS_SERVICE
      );
  }
  ...
  public LinksBusinessSrv getLinksBusinessSrv() {
    return (LinksBusinessSrv) this.circabcServiceRegistry.getService(
        LINKS_BUSINESS_SERVICE
      );
  }
  ...
  public PermissionsBusinessSrv getPermissionsBusinessSrv() {
    return (PermissionsBusinessSrv) this.circabcServiceRegistry.getService(
        PERMISSIONS_BUSINESS_SERVICE
      );
  }
  ...
  public ProfileBusinessSrv getProfileBusinessSrv() {
    return (ProfileBusinessSrv) this.circabcServiceRegistry.getService(
        PROFILE_BUSINESS_SERVICE
      );
  }
  ...
  public UserDetailsBusinessSrv getUserDetailsBusinessSrv() {
    return (UserDetailsBusinessSrv) this.circabcServiceRegistry.getService(
        USER_DETAILS_BUSINESS_SERVICE
      );
  }
  ...
  public RemoteUserBusinessSrv getRemoteUserBusinessSrv() {
    return (RemoteUserBusinessSrv) this.circabcServiceRegistry.getService(
  ...
  public AttachementBusinessSrv getAttachementBusinessSrv() {
    return (AttachementBusinessSrv) this.circabcServiceRegistry.getService(
        ATTACHEMENT_BUSINESS_SERVICE
      );
  }
   ...
   */
  public final void setCircabcServiceRegistry(
