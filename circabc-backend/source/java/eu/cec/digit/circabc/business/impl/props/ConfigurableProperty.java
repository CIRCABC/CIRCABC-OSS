...
public class ConfigurableProperty implements Serializable, PropertyItem {
  ...
  public ConfigurableProperty(
    final String name,
    final Serializable originalValue
  ) {
  ...
  /*package*/ConfigurableProperty(
    ...
    this(
      ...
      item.isReadOnly(),
      item.isShownInViewMode(),
      item.isShownInEditMode(),
      item.getIgnoreIfMissing(),
      item.getConverter(),
  ...
  public ConfigurableProperty(
    ...
    String label,
    boolean readOnly,
    boolean viewInViewMode,
    boolean viewInEditMode,
    boolean ignoreIfMissing,
    String readConverter,
    String writeConverter
  ) {
    super();
    this.name = name;
