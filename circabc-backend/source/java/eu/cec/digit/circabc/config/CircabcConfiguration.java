...
public class CircabcConfiguration {
   ...
   **/
  public static final String GLOBAL_ALFRESCO_PROPERTY_FILE =
    "alfresco/alfresco-global.properties";
  /**
   * The non-server specific configuration file
   */
  public static final String GLOBAL_PROPERTY_FILE =
    "alfresco/extension/config/circabc-global-settings.properties";
   ...
   */
  public static final String CIRCABC_ROOT_NODE_DESCRIPTION_PROPERTIES =
    "root.title";
  /**
   ...
   */
  public static final String LIBRARY_NODE_DESCRIPTION_PROPERTIES =
    "library.description";
  /**
   ...
   */
  public static final String NEWSGROUP_NODE_TITLE_PROPERTIES =
    "newsgroup.title";
  /**
   * The description of a common newsgroup node
   */
  public static final String NEWSGROUP_NODE_DESCRIPTION_PROPERTIES =
   ...
   */
  public static final String SURVEY_NODE_DESCRIPTION_PROPERTIES =
    "survey.description";
  /**
   * The name of a common information node
   */
  public static final String INFORMATION_NODE_NAME_PROPERTIES =
    "information.name";
  /**
   * The title of a common information node
   */
  public static final String INFORMATION_NODE_TITLE_PROPERTIES =
    "information.title";
  /**
   * The description of a information survey node
   */
  public static final String INFORMATION_NODE_DESCRIPTION_PROPERTIES =
   ...
   */
  public static final String EVENT_NODE_DESCRIPTION_PROPERTIES =
    "event.description";
  /**
   * The name of the mandatory root category header
   */
  public static final String ROOT_HEADER_NAME_PROPERTIES =
    "category.header.root.node.name";
  /**
   * The description of the mandatory root category header
   */
  public static final String ROOT_HEADER_DESCRIPTION_PROPERTIES =
    "category.header.root.node.description";
  /**
   ...
   */
  public static final String EXPIRATION_TIME_PROPERTIES =
    "selfregistration.expiration.day";
  /**
   * The number of element that must be dispaleyed in a common rich list (list of spaces, content,
   * what's new elements, ...)
   */
  public static final String DEFAULT_LIST_ELEMENT_NUMBER_PROPERTIES =
    "wai.browse.defaultpagesize";
  /**
   * Attachment size allowed for posts
   */
  public static final String POST_ALLOWED_ATTACHMENT_SIZE_BYTES =
    "posts.allowed.attachment.size.bytes";
  /**
   * Attachment size allowed for logos (category, IG, avatar, etc.)
   */
  public static final String LOGO_ALLOWED_SIZE_BYTES =
    "logo.allowed.size.bytes";
  ...
  public static final String CONTEXT_INITIAL_CONTEXT_FACTORY =
    "context.initial_context_factory";
  public static final String CONTEXT_PROVIDER_URL = "context.provider_url";
  public static final String CONTEXT_SECURITY_AUTHENTICATION =
    "context.security_authentication";
  public static final String CONTEXT_SECURITY_PRINCIPAL =
    "context.security_principal";
  public static final String CONTEXT_SECURITY_CREDENTIALS =
    "context.security_credentials";
  public static final String CONTEXT_PROVIDER_URL_ECAS =
  ...
  public static final String IS_EMAIL_LISTENER_ACTIVE =
    "is_email_listener_active";
  public static final String IS_EMAIL_USE_TLS = "is_email_use_tls";

  public static final String IS_DISPLAY_SERVER_INFORMATION_ACTIVATE =
    "is_display_server_information_active";
  public static final String URL_OF_THE_SERVER = "url_of_the_server";

  public static final String MIGRATION_HOST = "migration_host";

  public static final String BULK_USER_IMPORT_DEPARTMENT_NUMBER_STATUS =
    "bulk.user.import.department.source";
  ...
  public static final String COMPONENT_INVITATION_NOTIFY_DIRECTORY_ADMINS =
    "component.invitation.notify.directoryAdmins";
  public static final String AUTO_UPLOAD_ENABLED = "app.autoupload.enabled";
  public static final String DOC_PREVIEW_RENDER_HOST =
    "document.preview.render.host";
  public static final String MT_ENABLED = "mt.enabled";
  public static final String ENCRYPTED_PROPERTIES_ENABLED =
    "encrypted.properties.enabled";
