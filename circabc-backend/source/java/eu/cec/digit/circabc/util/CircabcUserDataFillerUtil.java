...
public class CircabcUserDataFillerUtil {
  ...
  public static CircabcUserDataBean getCircabcUserDataBean(
    ...
    final NodeRef homeSpaceNodeRef = (NodeRef) properties.get(
    ...
    final String postalAdress = (String) properties.get(
    ...
    final String orgdepnumber = (String) properties.get(
    ...
    final Date creationDate = (Date) properties.get(
    ...
    final Date lastModificationDetailsTime = (Date) properties.get(
      UserModel.PROP_LAST_MODIFICATION_DETAILS_TIME
    );
    if (lastModificationDetailsTime != null) {
      circabcUserDataBean.setLastModificationDetailsTime(
        lastModificationDetailsTime
      );
    }

    final Date lastLoginTime = (Date) properties.get(
