 ...
 */
public interface CircabcImporterService {
    ...
    void importView(Reader viewReader, Location location, ImporterBinding binding,
    ...
    void importView(ImportPackageHandler importHandler, Location location, ImporterBinding binding,
                    ImporterProgress progress)
            throws ImporterException;
