...
/*package*/class ViewXMLExporter implements Exporter {
  ...
  ViewXMLExporter(
    ...
    VIEW_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      VIEW_LOCALNAME,
      namespaceService
    );
    VALUE_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      VALUE_LOCALNAME,
      namespaceService
    );
    VALUES_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      VALUES_LOCALNAME,
      namespaceService
    );
    CHILDNAME_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      CHILDNAME_LOCALNAME,
      namespaceService
    );
    ASPECTS_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      ASPECTS_LOCALNAME,
      namespaceService
    );
    PROPERTIES_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      PROPERTIES_LOCALNAME,
      namespaceService
    );
    ASSOCIATIONS_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      ASSOCIATIONS_LOCALNAME,
      namespaceService
    );
    DATATYPE_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      DATATYPE_LOCALNAME,
      namespaceService
    );
    ISNULL_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      ISNULL_LOCALNAME,
      namespaceService
    );
    METADATA_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      METADATA_LOCALNAME,
      namespaceService
    );
    EXPORTEDBY_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      EXPORTEDBY_LOCALNAME,
      namespaceService
    );
    EXPORTEDDATE_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      EXPORTEDDATE_LOCALNAME,
      namespaceService
    );
    EXPORTERVERSION_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      EXPORTERVERSION_LOCALNAME,
      namespaceService
    );
    EXPORTOF_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      EXPORTOF_LOCALNAME,
      namespaceService
    );
    ACL_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      ACL_LOCALNAME,
      namespaceService
    );
    ACE_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      ACE_LOCALNAME,
      namespaceService
    );
    ACCESS_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      ACCESS_LOCALNAME,
      namespaceService
    );
    AUTHORITY_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      AUTHORITY_LOCALNAME,
      namespaceService
    );
    PERMISSION_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      PERMISSION_LOCALNAME,
      namespaceService
    );
    INHERITPERMISSIONS_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      INHERITPERMISSIONS_LOCALNAME,
      namespaceService
    );
    REFERENCE_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      REFERENCE_LOCALNAME,
      namespaceService
    );
    PATHREF_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      PATHREF_LOCALNAME,
      namespaceService
    );
    NODEREF_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      NODEREF_LOCALNAME,
      namespaceService
    );
    LOCALE_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      LOCALE_LOCALNAME,
      namespaceService
    );
    MLVALUE_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      MLVALUE_LOCALNAME,
      namespaceService
    );
    ...
    // Added for versions and ML
    VERSIONS_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      VERSIONS_LOCALNAME,
      namespaceService
    );
    MLTRANSLATIONS_QNAME = QName.createQName(
      NamespaceService.REPOSITORY_VIEW_PREFIX,
      MLTRANSLATIONS_LOCALNAME,
      namespaceService
    );
  }
    ...
    try {
      ...
      if (path.size() > 1) {
        ...
        Path.ChildAssocElement pathElement =
          (Path.ChildAssocElement) path.last();
  ...
  public void value(NodeRef nodeRef, QName property, Object value, int index) {
    try {
      ...
      if (
        ...
        if (nodeRef.getStoreRef().equals(valueNodeRef.getStoreRef())) {
          ...
          if (property.equals(ContentModel.PROP_CATEGORIES)) {
            ...
            nodeRefPath = createPath(
              context.getExportParent(),
              nodeRef,
              valueNodeRef
            );
          }
          value = (nodeRefPath == null)
            ? null
      ...
      if (
        valueStarted && (value == null || valueDataType != null || index != -1)
      ) {
        contentHandler.endElement(
          NamespaceService.REPOSITORY_VIEW_PREFIX,
          VALUE_LOCALNAME,
  ...
  public void startVersions(NodeRef nodeRef) {
    try {
      contentHandler.startElement(
        VERSIONS_QNAME.getNamespaceURI(),
        VERSIONS_LOCALNAME,
  ...
  public void startMLTranslations(NodeRef nodeRef) {
    try {
      contentHandler.startElement(
        MLTRANSLATIONS_QNAME.getNamespaceURI(),
        MLTRANSLATIONS_LOCALNAME,
    ...
    try {
      ...
      if (referenceFormat.equals(ReferenceType.PATHREF)) {
        ...
        if (
          path
            .toPrefixString(namespaceService)
            .startsWith("/cm:multilingualRoot/") ||
    ...
    try {
      ...
      for (int i = 0; i < toPath.size(); i++) {
        ...
        if (
          ...
          Path.ChildAssocElement childPath =
            (Path.ChildAssocElement) pathElement;
