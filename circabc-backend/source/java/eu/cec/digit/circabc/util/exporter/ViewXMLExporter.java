...
/*package*/ class ViewXMLExporter
    ...
    // Added for versions and ML
    private static final String VERSIONS_LOCALNAME = "versions";
    private static final String MLTRANSLATIONS_LOCALNAME = "mlTranslations";
    ...
    private static QName MLTRANSLATIONS_QNAME;
    ...
    ViewXMLExporter(NamespaceService namespaceService, NodeService nodeService,
        ...
        VIEW_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, VIEW_LOCALNAME, namespaceService);
        VALUE_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, VALUE_LOCALNAME, namespaceService);
        VALUES_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, VALUES_LOCALNAME, namespaceService);
        CHILDNAME_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, CHILDNAME_LOCALNAME,
                        namespaceService);
        ASPECTS_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, ASPECTS_LOCALNAME, namespaceService);
        PROPERTIES_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, PROPERTIES_LOCALNAME,
                        namespaceService);
        ASSOCIATIONS_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, ASSOCIATIONS_LOCALNAME,
                        namespaceService);
        DATATYPE_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, DATATYPE_LOCALNAME, namespaceService);
        ISNULL_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, ISNULL_LOCALNAME, namespaceService);
        METADATA_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, METADATA_LOCALNAME, namespaceService);
        EXPORTEDBY_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTEDBY_LOCALNAME,
                        namespaceService);
        EXPORTEDDATE_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTEDDATE_LOCALNAME,
                        namespaceService);
        EXPORTERVERSION_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTERVERSION_LOCALNAME,
                        namespaceService);
        EXPORTOF_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTOF_LOCALNAME, namespaceService);
        ACL_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, ACL_LOCALNAME, namespaceService);
        ACE_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, ACE_LOCALNAME, namespaceService);
        ACCESS_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, ACCESS_LOCALNAME, namespaceService);
        AUTHORITY_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, AUTHORITY_LOCALNAME,
                        namespaceService);
        PERMISSION_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, PERMISSION_LOCALNAME,
                        namespaceService);
        INHERITPERMISSIONS_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, INHERITPERMISSIONS_LOCALNAME,
                        namespaceService);
        REFERENCE_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, REFERENCE_LOCALNAME,
                        namespaceService);
        PATHREF_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, PATHREF_LOCALNAME, namespaceService);
        NODEREF_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, NODEREF_LOCALNAME, namespaceService);
        LOCALE_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, LOCALE_LOCALNAME, namespaceService);
        MLVALUE_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, MLVALUE_LOCALNAME, namespaceService);

        // Added for versions and ML
        VERSIONS_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, VERSIONS_LOCALNAME, namespaceService);
        MLTRANSLATIONS_QNAME = QName
                .createQName(NamespaceService.REPOSITORY_VIEW_PREFIX, MLTRANSLATIONS_LOCALNAME,
                        namespaceService);
    }
    ...
    public void start(ExporterContext context) {
        try {
            ...
            contentHandler.startPrefixMapping(NamespaceService.REPOSITORY_VIEW_PREFIX,
                    NamespaceService.REPOSITORY_VIEW_1_0_URI);
            contentHandler.startElement(NamespaceService.REPOSITORY_VIEW_PREFIX, VIEW_LOCALNAME,
                    VIEW_QNAME.toPrefixString(), EMPTY_ATTRIBUTES);

            //
            // output metadata
            //
            contentHandler.startElement(NamespaceService.REPOSITORY_VIEW_PREFIX, METADATA_LOCALNAME,
                    METADATA_QNAME.toPrefixString(), EMPTY_ATTRIBUTES);

            // exported by
            contentHandler.startElement(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTEDBY_LOCALNAME,
                    EXPORTEDBY_QNAME.toPrefixString(), EMPTY_ATTRIBUTES);
            contentHandler
                    .characters(context.getExportedBy().toCharArray(), 0, context.getExportedBy().length());
            contentHandler.endElement(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTEDBY_LOCALNAME,
                    EXPORTEDBY_QNAME.toPrefixString());

            // exported date
            contentHandler.startElement(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTEDDATE_LOCALNAME,
            ...
            contentHandler.endElement(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTEDDATE_LOCALNAME,
                    EXPORTEDDATE_QNAME.toPrefixString());

            // exporter version
            contentHandler
                    .startElement(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTERVERSION_LOCALNAME,
                            EXPORTERVERSION_QNAME.toPrefixString(), EMPTY_ATTRIBUTES);
            contentHandler.characters(context.getExporterVersion().toCharArray(), 0,
                    context.getExporterVersion().length());
            contentHandler.endElement(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTERVERSION_LOCALNAME,
                    EXPORTERVERSION_QNAME.toPrefixString());

            // export of
            contentHandler.startElement(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTOF_LOCALNAME,
                    EXPORTOF_QNAME.toPrefixString(), EMPTY_ATTRIBUTES);
            ...
            for (int i = 0; i < exportList.length; i++) {
                ...
                contentHandler.characters(ArrayUtils.addAll(path.toCharArray(), ",".toCharArray()), 0,
                        path.length() + comma);
            }
            contentHandler.endElement(NamespaceService.REPOSITORY_VIEW_PREFIX, EXPORTOF_LOCALNAME,
                    EXPORTOF_QNAME.toPrefixString());

            contentHandler.endElement(NamespaceService.REPOSITORY_VIEW_PREFIX, METADATA_LOCALNAME,
    ...
    public void startNamespace(String prefix, String uri) {
        try {
            ...
            throw new ExporterException(
                    "Failed to process start namespace event - prefix " + prefix + " uri " + uri, e);
        }
    }
    ...
    public void startNode(NodeRef nodeRef) {
        try {
            ...
            contentHandler
                    .startElement(type.getNamespaceURI(), type.getLocalName(), toPrefixString(type), attrs);
        } catch (SAXException e) {
            throw new ExporterException(
    ...
    public void startAspects(NodeRef nodeRef) {
        try {
            contentHandler.startElement(ASPECTS_QNAME.getNamespaceURI(), ASPECTS_LOCALNAME,
                    toPrefixString(ASPECTS_QNAME), EMPTY_ATTRIBUTES);
        } catch (SAXException e) {
    ...
    public void endAspects(NodeRef nodeRef) {
        try {
            contentHandler.endElement(ASPECTS_QNAME.getNamespaceURI(), ASPECTS_LOCALNAME,
    ...
    public void startAspect(NodeRef nodeRef, QName aspect) {
        try {
            contentHandler
                    .startElement(aspect.getNamespaceURI(), aspect.getLocalName(), toPrefixString(aspect),
                            EMPTY_ATTRIBUTES);
        } catch (SAXException e) {
            throw new ExporterException(
                    "Failed to process start aspect event - node ref " + nodeRef.toString() + "; aspect "
                            + toPrefixString(aspect), e);
        }
    }
    ...
    public void endAspect(NodeRef nodeRef, QName aspect) {
        try {
            contentHandler
                    .endElement(aspect.getNamespaceURI(), aspect.getLocalName(), toPrefixString(aspect));
        } catch (SAXException e) {
            throw new ExporterException(
                    "Failed to process end aspect event - node ref " + nodeRef.toString() + "; aspect "
                            + toPrefixString(aspect), e);
        }
    }
    ...
    public void permission(NodeRef nodeRef, AccessPermission permission) {
        try {
            ...
            // output permission
            contentHandler
                    .startElement(PERMISSION_QNAME.getNamespaceURI(), PERMISSION_QNAME.getLocalName(),
            ...
            throw new ExporterException(
                    "Failed to process permission event - node ref " + nodeRef.toString() + "; permission "
                            + permission);
        }
    }
    ...
    public void endACL(NodeRef nodeRef) {
        try {
            contentHandler.endElement(ACL_QNAME.getNamespaceURI(), ACL_QNAME.getLocalName(),
    ...
    public void startProperties(NodeRef nodeRef) {
        try {
            contentHandler.startElement(PROPERTIES_QNAME.getNamespaceURI(), PROPERTIES_LOCALNAME,
                    toPrefixString(PROPERTIES_QNAME), EMPTY_ATTRIBUTES);
        } catch (SAXException e) {
    ...
    public void endProperties(NodeRef nodeRef) {
        try {
            contentHandler.endElement(PROPERTIES_QNAME.getNamespaceURI(), PROPERTIES_LOCALNAME,
    ...
    public void startProperty(NodeRef nodeRef, QName property) {
        try {
            QName encodedProperty = QName
                    .createQName(property.getNamespaceURI(), ISO9075.encode(property.getLocalName()));
            contentHandler.startElement(encodedProperty.getNamespaceURI(), encodedProperty.getLocalName(),
                    toPrefixString(encodedProperty), EMPTY_ATTRIBUTES);
        } catch (SAXException e) {
            throw new ExporterException(
                    "Failed to process start property event - nodeRef " + nodeRef + "; property "
                            + toPrefixString(property), e);
        }
    }
    ...
    public void endProperty(NodeRef nodeRef, QName property) {
        try {
            QName encodedProperty = QName
                    .createQName(property.getNamespaceURI(), ISO9075.encode(property.getLocalName()));
            contentHandler.endElement(encodedProperty.getNamespaceURI(), encodedProperty.getLocalName(),
                    toPrefixString(encodedProperty));
        } catch (SAXException e) {
            throw new ExporterException(
                    "Failed to process end property event - nodeRef " + nodeRef + "; property "
                            + toPrefixString(property), e);
        }
    }
    ...
    public void startValueCollection(NodeRef nodeRef, QName property) {
        try {
            // start collection
            contentHandler.startElement(NamespaceService.REPOSITORY_VIEW_PREFIX, VALUES_LOCALNAME,
                    toPrefixString(VALUES_QNAME), EMPTY_ATTRIBUTES);
        } catch (SAXException e) {
            throw new ExporterException(
                    "Failed to process start collection event - nodeRef " + nodeRef + "; property "
                            + toPrefixString(property), e);
        }
    }
    ...
    public void endValueCollection(NodeRef nodeRef, QName property) {
        try {
            // end collection
            contentHandler.endElement(NamespaceService.REPOSITORY_VIEW_PREFIX, VALUES_LOCALNAME,
                    toPrefixString(VALUES_QNAME));
        } catch (SAXException e) {
            throw new ExporterException(
                    "Failed to process end collection event - nodeRef " + nodeRef + "; property "
                            + toPrefixString(property), e);
        }
    }
    ...
    public void value(NodeRef nodeRef, QName property, Object value, int index) {
        try {
            // Add this type (CIRCABC specific)
            if (CircabcModel.PROP_APPLICANTS.equals(property)) {

                // output serialized hash map
                String strValue = null;

                try {
                    strValue = CommonUtils.toBase64String((Serializable) value);
                } catch (IOException e) {
                    throw new ExporterException("Error serializing property: " +
                            property + ", NodeRef: " + nodeRef.toString(), e);
                }
            ...
            if (value == null || valueDataType != null || index != -1) {
                ...
                String qName = attrs.getQName(0);
                String qNameValue = attrs.getValue(0);

                if (!("view:isNull".equals(qName) && "true".equals(qNameValue))) {
            ...
            if (valueStarted && (value == null || valueDataType != null || index != -1)) {
                contentHandler.endElement(NamespaceService.REPOSITORY_VIEW_PREFIX, VALUE_LOCALNAME,
                        toPrefixString(VALUE_QNAME));
            }
        } catch (SAXException e) {
            throw new ExporterException(
                    "Failed to process value event - nodeRef " + nodeRef + "; property " + toPrefixString(
    ...
    public void startAssoc(NodeRef nodeRef, QName assoc) {
        try {
            contentHandler
                    .startElement(assoc.getNamespaceURI(), assoc.getLocalName(), toPrefixString(assoc),
                            EMPTY_ATTRIBUTES);
        } catch (SAXException e) {
            throw new ExporterException(
                    "Failed to process start assoc event - nodeRef " + nodeRef + "; association "
                            + toPrefixString(assoc), e);
        }
    }
    ...
    public void endAssoc(NodeRef nodeRef, QName assoc) {
        try {
            contentHandler
                    .endElement(assoc.getNamespaceURI(), assoc.getLocalName(), toPrefixString(assoc));
        } catch (SAXException e) {
            throw new ExporterException(
                    "Failed to process end assoc event - nodeRef " + nodeRef + "; association "
                            + toPrefixString(assoc), e);
        }
    }
    ...
    public void startAssocs(NodeRef nodeRef) {
        try {
            contentHandler.startElement(ASSOCIATIONS_QNAME.getNamespaceURI(), ASSOCIATIONS_LOCALNAME,
                    toPrefixString(ASSOCIATIONS_QNAME), EMPTY_ATTRIBUTES);
        } catch (SAXException e) {
    ...
    public void endAssocs(NodeRef nodeRef) {
        try {
            contentHandler.endElement(ASSOCIATIONS_QNAME.getNamespaceURI(), ASSOCIATIONS_LOCALNAME,
    ...
    public void startVersions(NodeRef nodeRef) {
        ...
        try {
            contentHandler.startElement(VERSIONS_QNAME.getNamespaceURI(), VERSIONS_LOCALNAME,
                    toPrefixString(VERSIONS_QNAME), EMPTY_ATTRIBUTES);
        } catch (SAXException e) {
            throw new ExporterException("Failed to process start versions", e);
        }
    }
    ...
    public void endVersions(NodeRef nodeRef) {
        ...
        try {
            contentHandler.endElement(VERSIONS_QNAME.getNamespaceURI(), VERSIONS_LOCALNAME,
                    toPrefixString(VERSIONS_QNAME));
        } catch (SAXException e) {
            throw new ExporterException("Failed to process end versions", e);
        }
    }
    ...
    public void startMLTranslations(NodeRef nodeRef) {
        ...
        try {
            contentHandler.startElement(MLTRANSLATIONS_QNAME.getNamespaceURI(), MLTRANSLATIONS_LOCALNAME,
                    toPrefixString(MLTRANSLATIONS_QNAME), EMPTY_ATTRIBUTES);
        } catch (SAXException e) {
            throw new ExporterException("Failed to process start mlTranslations", e);
        }
    }
    ...
    public void endMLTranslations(NodeRef nodeRef) {
        ...
        try {
            contentHandler.endElement(MLTRANSLATIONS_QNAME.getNamespaceURI(), MLTRANSLATIONS_LOCALNAME,
                    toPrefixString(MLTRANSLATIONS_QNAME));
        } catch (SAXException e) {
            throw new ExporterException("Failed to process end mlTranslations", e);
        }
    }
    ...
    public void startReference(NodeRef nodeRef, QName childName) {
        try {
            ...
            if (referenceFormat.equals(ReferenceType.PATHREF)) {
                ...
                if (path.toPrefixString(namespaceService).startsWith("/cm:multilingualRoot/")
                        || isNonVersioningPath(path.toPrefixString(namespaceService))) {
    ...
    private boolean isNonVersioningPath(String path) {
        return !path.startsWith("/ver2:");
    }
    ...
    public void endReference(NodeRef nodeRef) {
        try {
            contentHandler.endElement(REFERENCE_QNAME.getNamespaceURI(), REFERENCE_LOCALNAME,
    ...
    public void startValueMLText(NodeRef nodeRef, Locale locale) {
        AttributesImpl attrs = new AttributesImpl();
        attrs.addAttribute(NamespaceService.REPOSITORY_VIEW_PREFIX, LOCALE_LOCALNAME,
                LOCALE_QNAME.toPrefixString(), null, locale.toString());
        try {
    ...
    public void endValueMLText(NodeRef nodeRef) {
        try {
            contentHandler.endElement(NamespaceService.REPOSITORY_VIEW_PREFIX, MLVALUE_LOCALNAME,
    ...
    public void end() {
        try {
            contentHandler.endElement(NamespaceService.REPOSITORY_VIEW_PREFIX, VIEW_LOCALNAME,
        ...
        try {
            ...
            for (int i = 0; i < toPath.size(); i++) {
                ...
                if (pathElement.getPrefixedString(namespaceService).equals("cm:categoryRoot")) {
                    ...
                    relativePath.append(new Path.ChildAssocElement(
            ...
            if (relativePath == null) {
                ...
                int i = 0;
                while (i < rootPath.size() && i < fromPath.size() && rootPath.get(i)
                ...
                if (i == rootPath.size()) {
                    ...
                    for (NodeRef nodeRef : context.getExportParentList()) {
                        ...
                        while (j < tryPath.size() && j < toPath.size() && tryPath.get(j)
                                .equals(toPath.get(j))) {
                            j++;
                        }
                        if (j == tryPath.size()) {
            ...
            String msg =
                    "Failed to determine relative path: root path=" + rootPath + "; from path=" + fromPath
                            + "; to path=" + toPath;
        ...
        for (int i = path.size() - 1; i >= 0; i--) {
            ...
            if (i > 0 && pathElement instanceof Path.ChildAssocElement) {
                ...
                List<NodeRef> siblings = searchService
                        .selectNodes(nodeRef, searchPath, null, namespaceService, false);
                if (siblings.size() > 1) {
