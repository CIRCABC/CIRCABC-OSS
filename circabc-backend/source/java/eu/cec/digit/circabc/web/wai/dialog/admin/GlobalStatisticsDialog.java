...
public class GlobalStatisticsDialog extends BaseWaiDialog {
  ...
  public String fireme(ActionEvent event) {
    globalStatsServ.saveStatsToExcel(
      globalStatsServ.getReportSaveFolder(),
      globalStatsServ.makeGlobalStats()
    );
  ...
  public String generateDetailedIgList(ActionEvent event) {
    Runnable r = new DetailedIgListRunnable(
  ...
  public String searchLastLogin(ActionEvent event) {
    ...
    if (date == null) {
      ...
      result =
        gcLogin.get(Calendar.DAY_OF_MONTH) +
        "-" +
        (gcLogin.get(Calendar.MONTH) + 1) +
        "-" +
      ...
      AuthenticationUtil.runAs(
        new AuthenticationUtil.RunAsWork<String>() {
          public String doWork() {
            globalStatsServ.saveDetailedIgStatsToExcel(
              globalStatsServ.getReportSaveFolder(),
