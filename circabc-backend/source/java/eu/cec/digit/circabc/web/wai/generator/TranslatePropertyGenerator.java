...
public class TranslatePropertyGenerator extends BaseDialogLauncherGenerator {
  ...
  private static final String MSG_PICK_VALUE =
    "translate_property_action_value";
  private static final String MSG_PICK_TOOLTIP =
    "translate_property_action_tooltip";
  ...
  @Override
  protected UICommand buildActionCommand(
    final FacesContext context,
    final String id
  ) {
    //add it a launch dialog button
    UIActionLink picker = (UIActionLink) context
      .getApplication()
  ...
  @SuppressWarnings("unchecked")
  @Override
  protected UIComponent buildTextField(
    final FacesContext context,
    final String id,
    final String propAsString
  ) {
    // add it a text read only text field
    UIInput textField = (UIInput) context
      .getApplication()
