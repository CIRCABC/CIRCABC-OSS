...
public class CategoryGroupStatisticsBean extends BaseWaiDialog {
  ...
  public void init(Map<String, String> parameters) {
    ...
    currentCategoryName = this.getNodeService()
      .getProperty(currentCategoryRef, ContentModel.PROP_NAME)
      .toString();
  ...
  public void loadContents(String categoryName) {
    ...
    this.contents = globalStatsServ.getCategoryGroupStatsFiles(
      categoryName,
      this.currentCategoryRef
    );
  ...
  public String generateCategoryIgList(ActionEvent event) {
    if (
      !circabcLockService.isLocked("categStatJob-" + currentCategoryRef.getId())
    ) {
      circabcLockService.lock("categStatJob-" + currentCategoryRef.getId());

      Runnable r = new CategoryIgListRunnable(
          ...
          public String doWork() {
            try {
              globalStatsServ.saveCategoryGroupStatistics(
                globalStatsServ.computeCategoryGroupStatistics(categoryRef),
                currentCategoryName
              );
            } finally {
