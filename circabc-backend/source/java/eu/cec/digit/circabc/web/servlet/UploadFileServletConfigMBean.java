...
public class UploadFileServletConfigMBean extends MBeanSupport {
  ...
  public void setUploadFileServletConfig(
    UploadFileServletConfig uploadFileServletConfig
  ) {
    this.uploadFileServletConfig = uploadFileServletConfig;
  }

  @ManagedAttribute(
    description = "Get the max file upload size in megabatyes , -1 means unlimited "
  )
  ...
  @ManagedAttribute(
    description = "Set the max file upload size in megabatyes , -1 means unlimited "
  )
