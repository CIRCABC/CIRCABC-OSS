...
public class UpdateAvatarDialog extends BaseWaiDialog {
  ...
  private static final String MSG_ERROR_UNEXPECTED =
    "update_doc_unexpected_error";
  private static final String MSG_WRONG_FORMAT =
    "edit_user_details_avatar_wrong_format";
  private static final String CLOSE_AND_EDIT_USER =
  ...
  protected String finishImpl(FacesContext context, String outcome)
    ...
    try {
      ...
      final NodeRef avatarRef = getBusinessRegistry()
      ...
      final EditUserDetailsDialog userDetailsDialog =
        (EditUserDetailsDialog) Beans.getBean(EditUserDetailsDialog.BEAN_NAME);
  ...
  public boolean isHasPermission() {
    ...
    if (
      currentAlfrescoUserName != null &&
      !currentAlfrescoUserName.equalsIgnoreCase("guest")
    ) {
      if (getActionNode() == null) {
        if (logger.isErrorEnabled()) {
          logger.error(
