 ...
 */
public class MLContentDetailsBean
  extends ContentDetailsBean
  implements WaiNavigator {

  public static final String BEAN_NAME = "LibMLContentDetailsBean";
  public static final String JSP_NAME = "ml-content-details.jsp";
  public static final String MSG_PAGE_TITLE =
    "manage_multilingual_details_title";
  public static final String MSG_PAGE_DESCRIPTION =
    "manage_multilingual_details_title_desc";
  public static final String MSG_PAGE_ICON_ALT =
    "manage_multilingual_details_icon_tooltip";
  public static final String MSG_BROWSER_TITLE =
    "title_manage_multilingual_details";
  protected static final String MSG_SUCCESS_OWNERSHIP_ML_CONTAINER =
    "success_ownership";
  /**
   *
   */
  ...
  public void takeOwnershipMLContainer(final ActionEvent event) {
    ...
    if (
      ...
      getCurrentNode().hasAspect(ContentModel.ASPECT_MULTILINGUAL_DOCUMENT)
    ) {
      mlContainer = getMultilingualContentService()
        .getTranslationContainer(getCurrentNode().getNodeRef());
    } else {
      throw new IllegalArgumentException(
        "This method must be called with a multilingual document"
      );
    }
        ...
        new RetryingTransactionCallback<Object>() {
          public Object execute() throws Throwable {
            ...
            Utils.addStatusMessage(
              ...
              Application.getBundle(fc).getString(
                MSG_SUCCESS_OWNERSHIP_ML_CONTAINER
              )
            );
  ...
  protected EditionService getEditionService() {
    if (this.editionService == null) {
      this.editionService = Services.getAlfrescoServiceRegistry(
        FacesContext.getCurrentInstance()
      ).getEditionService();
    }
