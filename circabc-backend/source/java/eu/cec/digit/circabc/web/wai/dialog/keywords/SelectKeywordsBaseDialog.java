...
public abstract class SelectKeywordsBaseDialog extends ManageKeywordsDialog {
  ...
  private static final Log logger = LogFactory.getLog(
    SelectKeywordsBaseDialog.class
  );
  ...
  public void addSelection(ActionEvent event) {
    UISelectMany picker = (UISelectMany) event
      .getComponent()
  ...
  public SelectItem[] getInterestGroupKeywords() {
    ...
    final Locale filteredLanguage = (getSelectedLanguage() == null ||
        getSelectedLanguage().equals(NULL_VALUE))
      ? null
    ...
    if (filteredLanguage == null) {
      ...
      for (final Map.Entry<
        NodeRef,
        Keyword
      > entry : interestGroupKeywords.entrySet()) {
  ...
  protected void initKeywords() {
    ...
    if (getActionNode() != null) {
      if (logger.isDebugEnabled()) {
        logger.debug(
          "Trying to retreive the keyword list for the current document : " +
      ...
      if (logger.isDebugEnabled()) {
        logger.debug(
          "Keyword successfully retreived for the document : " +
          getActionNode().getName() +
          "(" +
          getActionNode().getNodeRef() +
          ")" +
