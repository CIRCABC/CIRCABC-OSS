...
public class InformationBean extends LibraryBean {
  ...
  public static final String MSG_PAGE_DESCRIPTION =
    "information_home_title_desc";
  public static final String MSG_PAGE_ICON_ALT =
    "information_home_icon_tooltip";
  private static final String FILE_SEPARATOR = "/";
  /**
   *
   */
  private static final long serialVersionUID = -1167164595469111193L;
  private static final String BROWSE_REPO =
    "information_ation_browse_repository_title";
  private static final String BROWSE_REPO_TOOLTIP =
    "information_ation_browse_repository_tooltip";
  ...
  public void init(Map<String, String> parameters) {
    ...
    // stop browsing when click on the information root.
      ...
      NavigableNodeType.INFORMATION.equals(getNavigator().getCurrentNodeType())
    ) {
  ...
  public String getWebdavUrl(boolean relative) {
    ...
    if (currentNode.hasAspect(CircabcModel.ASPECT_INFORMATION_ROOT)) {
      String indexPage = (String) currentNode
        .getProperties()
      ...
      if (indexFileFound(currentNode.getNodeRef(), indexPage)) {
        ...
        return (
          url +
          (indexPage.startsWith(FILE_SEPARATOR) == false
              ? FILE_SEPARATOR
              : "") +
          indexPage
        );
  ...
  public boolean isIndexFileFound() {
    final Node currentNode = getCurrentNode();
    final String indexPage = (String) currentNode
      .getProperties()
      .get(CircabcModel.PROP_INF_INDEX_PAGE.toString());
  ...
  private boolean indexFileFound(final NodeRef parent, final String indexPage) {
    if (indexPage == null || indexPage.trim().length() < 1) {
      ...
      while (tokens.hasMoreTokens()) {
        ref = getNodeService()
          .getChildByName(ref, ContentModel.ASSOC_CONTAINS, tokens.nextToken());
        found = ref != null;
      }
  ...
  public NavigationPreference getContainerNavigationPreference() {
    return getNavigationPreferencesService()
      .getServicePreference(
        ...
        NavigationPreferencesService.INFORMATION_SERVICE,
  ...
  public List<ActionWrapper> getActions() {
    ...
    if (
      type.equals(NavigableNodeType.INFORMATION) ||
