 ...
 */
public class TranslateLongTextPropertyGeneratorNoRichText
  extends TranslatePropertyGenerator {
  ...
  protected UIComponent buildTextField(
    ...
    final UIComponent component = super.buildTextField(
      context,
      id,
      propAsString
    );
  ...
  protected List<UIParameter> getActionParameters(
    ...
    UIParameter parmeterTextArea = (UIParameter) context
      .getApplication()
