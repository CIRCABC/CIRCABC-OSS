...
public class ManageNavigationPreference extends BaseWaiDialog {
  ...
  public List<NavigationPrefWrapper> getPreferences() {
    ...
    final Collection<ServiceConfig> globalPreferences =
      getNavigationConfigService().getAllServiceConfig();
    final List<NavigationPrefWrapper> wrappers = new ArrayList<>(
      globalPreferences.size()
    );
    ...
    for (final ServiceConfig service : globalPreferences) {
      if (serviceFilter == null || serviceFilter.equals(service.getName())) {
        preferences = getNavigationPreferencesService()
  ...
  public String getContainerTitle() {
    return translate(
      "manage_navigation_dialog_title",
