...
public class ImportDialogWai extends AddContentBean implements WaiDialog {
  ...
  private static final String MSG_IMPORT_UPLOAD_SUCCESS =
    "import_upload_success";
  private static final String MSG_IMPORT_STARTED = "import_started";
  private static final String MSG_IMPORT_MAX_FILE_SIZE_IN_MEGA_BYTES =
    "import_max_file_size_in_mega_bytes";
  private static final String MSG_ERR_INVALID_FILE_EXTENSION =
    "import_invalid_file_extension";
  private static final String MSG_ERR_FILE_IS_TOO_LARGE =
    "import_file_is_too_large";
  private static final String MSG_ERR_IMPORT_UNEXPECTED_ERROR =
    "import_unexpected_error";
  private static final String IMPORT_ONLY_ONE_FILE = "import_only_one_file";
  private static final String MSG_ERR_FIRST_LOCATE_FILE_TO_UPLAD =
    "import_first_locate_file";
  ...
  public void init(final Map<String, String> parameters) {
    ...
    maxFileSizeMessage = translate(
      MSG_IMPORT_MAX_FILE_SIZE_IN_MEGA_BYTES,
  ...
  protected String finishImpl(final FacesContext context, String outcome)
    ...
    if (getUploadedFileCount() == 1) {
      ...
      if (getCreatedNodeRefs().size() == 1) {
        final NodeRef acpNodeRef = getCreatedNodeRefs()
          .keySet()
          .iterator()
          .next();
        try {
          ...
          RetryingTransactionCallback<Object> callback =
            new RetryingTransactionCallback<Object>() {
              public Object execute() throws Throwable {
                ...
                params.put(
                  ImporterActionExecuter.PARAM_ENCODING,
                  selectedEncoding
                );
                params.put(
                  CircabcImporterActionExecuter.PARAM_DELETE_FILE,
                ...
                if (logger.isDebugEnabled()) {
                  logger.debug(
                    "Executed import action with action params of " + params
                  );
                }
          ...
          Utils.addErrorMessage(
            translate(MSG_ERR_IMPORT_UNEXPECTED_ERROR, e.getMessage())
          );
  ...
  @Override
  public String doPostCommitProcessing(
