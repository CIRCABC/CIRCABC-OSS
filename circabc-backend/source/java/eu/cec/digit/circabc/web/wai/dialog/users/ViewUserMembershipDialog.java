...
public final class ViewUserMembershipDialog extends BaseWaiDialog {
  ...
  public List<UserIGMembershipRecord> getIgRoles() {
    if (this.isMyProfile()) {
      ...
      List<UserCategoryMembershipRecord> catRolesOfCurrentUser =
        getUserService().getCategories(this.currentUserName);
      ...
      return getUserService()
        .getInterestGroups(this.profileUserName, filterCategories);
    }
  }
  ...
  private boolean isUserMemberOfCategory(String userName, String catNodeId) {
    List<UserCategoryMembershipRecord> catRoles = getUserService()
  ...
  private boolean isUserMemberOfInterestGroup(
    String userName,
    String igNodeId
  ) {
    List<UserIGMembershipRecord> igRolesOfUser = getUserService()
