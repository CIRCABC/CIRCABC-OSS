 ...
 */
public class AuditSearchPagedDialog
  extends BaseWaiPageableDialog<LogSearchResultDAO> {
  ...
  public void init(Map<String, String> parameters) {
    ...
    if (resetFields) {
      ...
      initUsers();
      this.totalRows = getLogService()
        .searchCount(igID, user, service, activity, fromDate, toDate);
  ...
  private void initUsers() {
    ...
    final Set<String> invitedUsers =
      igRootProfileManagerService.getInvitedUsers(currentInterestGroup);
  ...
  public SelectItem[] getActivities() {
    ...
    List<SelectItem> activitiesAsItemList = new ArrayList<>(
      activitiesAsList.size()
    );
    for (String method : activitiesAsList) {
      activitiesAsItemList.add(new SelectItem(method, method));
    }

    return activitiesAsItemList.toArray(
      new SelectItem[activitiesAsItemList.size()]
    );
  }
  ...
  @Override
  protected List<LogSearchResultDAO> getList(
    int firstRow,
    int rowsPerPage,
    String sortField,
