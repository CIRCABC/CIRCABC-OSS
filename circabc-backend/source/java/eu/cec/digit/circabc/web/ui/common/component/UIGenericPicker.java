...
public class UIGenericPicker extends UICommand {
  ...
  public void decode(FacesContext context) {
    ...
    // queue an event
    PickerEvent event = new PickerEvent(
      this,
      action,
      filterIndex,
      contains,
        ...
        case ACTION_SEARCH:
          ...
          if (callback != null) {
            ...
            Object result = callback.invoke(
              getFacesContext(),
              new Object[] { this.filterIndex, this.contains.trim() }
            );
  ...
  public void encodeBegin(FacesContext context) throws IOException {
    ...
    if (this.currentResults != null && getShowContains() == true) {
      ...
      if (getShowFilter() == false) {
        resultsMsg = MessageFormat.format(
          bundle.getString(MSG_RESULTS1),
          Utils.encode(this.contains)
        );
      } else {
        String filterMsg = this.filters[this.filterIndex].getLabel();
        resultsMsg = MessageFormat.format(
          bundle.getString(MSG_RESULTS2),
          Utils.encode(this.contains),
          filterMsg
        );
      }
      ...
      out.write(
        MessageFormat.format(
          bundle.getString(MSG_RESULTS_TITLE),
          new Object[] {}
        )
      );
      out.write("</td></tr>");
    ...
    out.write(
      (currentResults != null && currentResults.length != 0)
        ? "min-width:"
        : "width:"
    );
  ...
  private String generateFormSubmit(FacesContext context, int action) {
    return Utils.generateFormSubmit(
      context,
      this,
      getHiddenFieldName(),
