  ...
  public boolean evaluate() {
    ...
    try {
      ...
      if (obj instanceof Node) {
        ...
        PermissionService service = Repository.getServiceRegistry(
          getFacesContext()
          ...
          for (String anAllow : allow) {
            result =
              ...
              (AccessStatus.ALLOWED ==
                service.hasPermission(((NodeRef) obj), anAllow));
          }
        }
      }
    } catch (Exception err) {
      ...
      s_logger.debug(
        "Error during PermissionEvaluator evaluation: " + err.getMessage()
      );
    }
