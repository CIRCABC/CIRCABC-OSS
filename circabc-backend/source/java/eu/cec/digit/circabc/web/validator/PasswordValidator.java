  ...
  private String getMessage(String key, Object[] params) {
    if (params == null) {
      ...
      return MessageFormat.format(
        Application.getMessage(FacesContext.getCurrentInstance(), key),
        params
      );
    }
  }
  ...
  public char[] generate() throws NoSuchAlgorithmException {
    ...
    do {
      ...
      for (int x = 0; x < GENERATED_PASSWORD_LENGTH; x++) {
        password[x] = (char) characterRange
          .get(rand.nextInt(characterRangeLength))
          .intValue();
      }
      try {
