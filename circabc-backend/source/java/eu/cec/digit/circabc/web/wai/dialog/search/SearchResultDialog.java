...
public class SearchResultDialog extends BaseWaiDialog {
  ...
  private static final String MISSING_OBJECT_RETURNED_FROM_SEARCH_INDEXES_ID =
    "Missing object returned from search indexes: id = ";
  ...
  public List<NavigableNode> getContainers() {
    ...
    return containers != null
      ? containers
      : Collections.<NavigableNode>emptyList();
  }
  ...
  public String getInformationMessage() {
    final String text = (getSearchContext() != null)
      ? getSearchContext().getText()
      : "";
    final int size =
      getContainers().size() + getContents().size() + getPosts().size();
  ...
  private void fillBrowseNodes(final SearchContext searchContext) {
    ...
    final int minimumSearchLength = Application.getClientConfig(
      context
    ).getSearchMinimum();
    ...
    String pathFrom = WebClientHelper.getPathFromSpaceRef(
      ...
      new RetryingTransactionCallback<Object>() {
        public Object execute() throws Throwable {
          ...
          try {
            ...
            int searchLimit = Application.getClientConfig(
              ...
              for (final ResultSetRow row : results) {
                try {
                  ...
                  if (getNodeService().exists(nodeRef)) {
                    ...
                    if (typeDef != null) {
                      if (ContentModel.TYPE_CONTENT.equals(type)) {
                        ...
                        final NavigableNode node =
                          ResolverHelper.createPostRepresentation(
                            fileInfo,
                            getNodeService(),
                            getBrowseBean()
                          );
                        ...
                        final NavigableNode node =
                          ResolverHelper.createTopicRepresentation(
                            fileInfo,
                            getNodeService(),
                            getBrowseBean()
                          );
                        ...
                        final NavigableNode node =
                          ResolverHelper.createForumRepresentation(
                            fileInfo,
                            getNodeService(),
                            getBrowseBean()
                          );
                    ...
                    if (logger.isWarnEnabled()) {
                      logger.warn(
                        MISSING_OBJECT_RETURNED_FROM_SEARCH_INDEXES_ID +
                        nodeRef +
                        SEARCH_QUERY +
                        query
                      );
                  ...
                  Utils.addErrorMessage(
                    translate(Repository.ERROR_NODEREF, refErr)
                  );
                }
              }
            }
