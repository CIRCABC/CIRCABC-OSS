...
public class CircabcReassignTaskDialog
  extends ReassignTaskDialog
  implements WaiDialog {

  private static final String PLEASE_SELECT_USER = "please_select_user";

  private static final String PLEASE_CLICK_OK_TO_REASSIGN_USER =
    "please_click_ok_to_reassign_user";
  private static final Log logger = LogFactory.getLog(
    CircabcCancelWorkflowDialog.class
  );
  /**
   *
   */
  ...
  public void init(Map<String, String> parameters) {
    ...
    if (task != null) {
      ...
      NodeRef workflowPackage = (NodeRef) task.properties.get(
      ...
      if (
        ...
        igNodeRef = (NodeRef) getNodeService()
          .getProperty(
            workflowPackage,
  ...
  public SelectItem[] pickerCallback(int filterIndex, String contains) {
    ...
    try {
      ...
      Set<String> invitedUsers = igRootProfileManagerService
      ...
      ArrayList<SelectItem> itemList = new ArrayList<>(invitedUsers.size());
      for (String user : invitedUsers) {
        ...
        if (safeContains != null) {
          if (fullNameAndUserId.toLowerCase().contains(safeContains)) {
            ...
            SelectItem item = new SortableSelectItem(
              user,
              name + " [" + user + "]",
  ...
  protected String finishImpl(FacesContext context, String outcome)
    throws Exception {
    if (userName != null) {
      Map<QName, Serializable> params = new HashMap<>(1);
