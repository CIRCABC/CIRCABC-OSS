...
public abstract class BaseWaiDialog
  ...
  public void init(final Map<String, String> parameters) {
    ...
    if (parameters != null && parameters.get(NODE_ID_PARAMETER) != null) {
      ...
      try {
        ...
        actionNodeDatabaseID = (Long) actionNode
          .getProperties()
        ...
        if (typeDef != null) {
          ...
          if (
            ...
            actionNode.addPropertyResolver(
              "icon",
              getBrowseBean().resolverSpaceIcon
            );
  ...
  public void updateLogDocument(
    ...
    if (igNodeRef != null) {
      ...
      if (categoryNodeRef != null) {
        ...
        logRecord.setIgID(
          (Long) getNodeService()
            .getProperty(circabcNodeRef, ContentModel.PROP_NODE_DBID)
        );
        logRecord.setIgName(
          (String) getNodeService()
            .getProperty(circabcNodeRef, ContentModel.PROP_NAME)
        );
      }
    }
    ...
    if (
      ...
      final NodeRef tempNodeRef = getMultilingualContentService()
        .getPivotTranslation(nodeRef);
  ...
  protected String getBestTitle(final Node node) {
    ...
    final String title = (String) getActionNode()
      .getProperties()
  ...
  protected String getBestTitle(final NodeRef nodeRef) {
    ...
    final String title = (String) getNodeService()
  ...
  protected final FileFolderService getFileFolderService() {
    if (fileFolderService == null) {
      fileFolderService = Services.getAlfrescoServiceRegistry(
        FacesContext.getCurrentInstance()
   ...
   */
  public final void setFileFolderService(
  ...
  protected final NamespaceService getNamespaceService() {
    if (namespaceService == null) {
      namespaceService = Services.getAlfrescoServiceRegistry(
        FacesContext.getCurrentInstance()
      ).getNamespaceService();
    }
  ...
  protected final NodeService getNodeService() {
    if (nodeService == null) {
      nodeService = Services.getAlfrescoServiceRegistry(
        FacesContext.getCurrentInstance()
      ).getNodeService();
    }
    return nodeService;
  ...
  protected final SearchService getSearchService() {
    if (searchService == null) {
      searchService = Services.getAlfrescoServiceRegistry(
        FacesContext.getCurrentInstance()
      ).getSearchService();
    }
  ...
  protected final UserService getUserService() {
    if (userService == null) {
      userService = Services.getCircabcServiceRegistry(
        FacesContext.getCurrentInstance()
      ).getUserService();
    }
    return userService;
  ...
  public final void setUserPreferencesBean(
    final CircabcUserPreferencesBean userPreferencesBean
  ) {
  ...
  protected final PermissionService getPermissionService() {
    if (permissionService == null) {
      permissionService = Services.getAlfrescoServiceRegistry(
        FacesContext.getCurrentInstance()
  ...
  protected final MailService getMailService() {
    if (mailService == null) {
      mailService = Services.getCircabcServiceRegistry(
        FacesContext.getCurrentInstance()
      ).getMailService();
    }
    return mailService;
  ...
  protected final MailToMembersService getMailToMembersService() {
    if (MailToMembersService == null) {
      MailToMembersService = Services.getCircabcServiceRegistry(
        FacesContext.getCurrentInstance()
   ...
   */
  public final void setMailToMembersService(
    final MailToMembersService mailToMembersService
  ) {
  ...
  protected final MailPreferencesService getMailPreferencesService() {
    if (mailPreferencesService == null) {
      mailPreferencesService = Services.getCircabcServiceRegistry(
        FacesContext.getCurrentInstance()
  ...
  protected final LogService getLogService() {
    if (logService == null) {
      logService = Services.getCircabcServiceRegistry(
        FacesContext.getCurrentInstance()
      ).getLogService();
    }
    return logService;
   ...
   */
  public final void setBusinessRegistry(
    final BusinessRegistry businessRegistry
  ) {
  ...
  protected final SecurityService getSecurityService() {
    if (securityService == null) {
      securityService = Services.getCircabcServiceRegistry(
        FacesContext.getCurrentInstance()
      ).getSecurityService();
    }
  ...
  protected ThreadPoolExecutor getAsyncThreadPoolExecutor() {
    if (asyncThreadPoolExecutor == null) {
      asyncThreadPoolExecutor = Services.getCircabcServiceRegistry(
        FacesContext.getCurrentInstance()
