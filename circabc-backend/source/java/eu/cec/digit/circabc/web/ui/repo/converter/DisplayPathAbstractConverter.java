 ...
 */
public abstract class DisplayPathAbstractConverter
  extends DisplayPathConverter {
  ...
  private SimplePath getSimplePath(
    final FacesContext context,
    final Object value
  ) {
    ...
    if (value != null && value instanceof NodeRef) {
      final ManagementService managementService =
        Services.getCircabcServiceRegistry(context).getManagementService();
      try {
   ...
   */
  private ExtendedURLMode getBestBrowseMode(
