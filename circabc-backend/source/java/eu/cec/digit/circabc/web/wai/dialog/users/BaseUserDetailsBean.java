...
public abstract class BaseUserDetailsBean extends BaseWaiDialog {
   ...
   */
  protected static final String MSG_GLOBAL_NOTIFICATION_ACTIVE =
    "edit_user_details_global_notification_active";
  /**
   * The message for the I18N view_user_details_global_notification_nonactive
   */
  protected static final String MSG_GLOBAL_NOTIFICATION_NONACTIVE =
    "edit_user_details_global_notification_nonactive";
  /**
   * The message for the I18N view_user_details_active
   */
  protected static final String MSG_VISIBILITY_ACTIVE =
    "edit_user_details_visibility_active";
  /**
   * The message for the I18N view_user_details_nonactive
   */
  protected static final String MSG_VISIBILITY_NONACTIVE =
    "edit_user_details_visibility_nonactive";
    ...
    if (parameters != null) {
      ...
      try {
        ...
        if (getNodeService().exists(personRef)) {
          userDetails = getBusinessRegistry()
            .getUserDetailsBusinessSrv()
            .getUserDetails(personRef);
        } else {
  ...
  public SelectItem[] getNotificationOptions() {
    return new SelectItem[] {
      ...
      new SelectItem(
        Boolean.FALSE,
        translate(MSG_GLOBAL_NOTIFICATION_NONACTIVE)
      ),
    };
  }
