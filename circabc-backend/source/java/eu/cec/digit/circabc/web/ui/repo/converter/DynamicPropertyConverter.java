...
public class DynamicPropertyConverter implements Converter {
  ...
  public static final String CONVERTER_ID =
    "eu.cec.digit.circabc.faces.DynamicPropertyConverter";
  ...
  public String getAsString(
    ...
    if (isDate) {
      return getDateConverter(context).getAsString(
        context,
        component,
        value.toString()
      );
      ...
      if (escape != null && escape) {
        ...
        return value == null
          ? ""
          : ESAPI.encoder().encodeForHTML(value.toString());
      }
    }
  }
  ...
  protected Converter getDateConverter(FacesContext context) {
    XMLDateConverter converter = (XMLDateConverter) context
      .getApplication()
      .createConverter(RepoConstants.ALFRESCO_FACES_XMLDATE_CONVERTER);
    converter.setType("date");
    converter.setPattern(
      Application.getMessage(context, WebClientHelper.MSG_DATE_PATTERN)
    );
    return converter;
  }
}
