...
public class ChangeOwnPasswordDialog extends BaseWaiDialog {
  ...
  private static final Log logger = LogFactory.getLog(
    ChangeOwnPasswordDialog.class
  );

  /**
   * The I18N message string for old password error
   */
  protected String err_old_password_incorrect =
    "change_own_password_error_old_password_incorrect";

  /**
   * The I18N message string for password rules error
   */
  protected String err_new_password_incorrect =
    "change_own_password_error_rule_password_incorrect";

  /**
   * The I18N message string for match error between twice password
   */
  protected String err_confirm_password_incorrect =
    "change_own_password_error_confirm_password_incorrect";

  /**
   * The I18N message string for successfull password change
   */
  protected String msg_successfull_password_change =
    "change_own_password_successfull_password_change";
  ...
  protected String finishImpl(FacesContext context, String outcome)
    ...
    if (
      ...
      if (logger.isErrorEnabled()) {
        logger.error(
          "finishImpl : Piracy warning from |" +
          getUserName() +
          "| a value is null"
        );
      }
  ...
  protected String doPostCommitProcessing(
    ...
    Utils.addStatusMessage(
      ...
      translate(msg_successfull_password_change)
    );
