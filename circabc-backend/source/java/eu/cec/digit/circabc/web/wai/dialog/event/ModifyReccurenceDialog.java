...
public class ModifyReccurenceDialog extends AppointmentDialogBase {
  ...
  private static final String MSG_DIALOG_TITLE_MEETING =
    "event_edit_recurrent_meeting_dialog_title";
  private static final String MSG_DIALOG_TITLE_EVENT =
    "event_edit_recurrent_event_dialog_title";
  ...
  private static final String MSG_DIALOG_DESC_EVENT =
    "event_edit_recurrent_event_dialog_description";
  private static final String MSG_DIALOG_BROWSER_TITLE =
    "event_edit_recurrent_meeting_dialog_browser_title";
  private static final String MSG_DIALOG_ICON_TOOLTIP =
    "event_edit_recurrent_meeting_dialog_icon_tooltip";
  ...
  public String getContainerDescription() {
    return isMeeting()
      ? translate(MSG_DIALOG_DESC_MEETING)
      : translate(MSG_DIALOG_DESC_EVENT);
  }
}
