...
public class SelfResendDialog extends CreateCircabcUserWizard {
  ...
  public static final String CONGRATULATION_DIALOG =
    "wai:dialog:resendOwnPasswordSuccessWai";
  public static final String RESET_PSW_DIALOG =
    "wai:dialog:resendOwnPasswordWai";
  public static final String CAPTCHA_FIELD = "Captcha";
  public static final String SESSION_KEY_NAME =
    "SelfResendDialogCaptchaKeyName";
  private static final long serialVersionUID = -5338520906207919943L;
  private static final Log logger = LogFactory.getLog(SelfResendDialog.class);
          ...
          public String execute() throws Throwable {
            ...
            try {
              ...
              logger.error(
                "The user " +
                getUserName() +
                " can't resent password due to an error: " +
                e.getMessage()
              );
