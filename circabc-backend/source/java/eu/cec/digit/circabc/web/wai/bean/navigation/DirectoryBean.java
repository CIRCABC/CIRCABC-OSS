...
public class DirectoryBean extends InterestGroupBean {
  ...
  public static final String MSG_NUMBER_OF_MEMBERS =
    "directory_number_of_members_search";
  private static final String EMPTY_STRING = "";
  private static final String MEMBERS = "members";
  private static final String IMAGES_ICONS_USERS_LARGE_GIF =
    "/images/icons/users_large.gif";
  /**
   *
   */
   ...
   */
  private static final String ERROR_CIRCABC_MIN_SEARCH_CHARS =
    "error_circabc_min_search_chars";
  /**
  ...
  protected SelectItem[] pageSizes = new SelectItem[] {
    new SelectItem(10),
    new SelectItem(20),
    new SelectItem(50),
    new SelectItem(100),
  ...
  public void init(final Map<String, String> parameters) {
    ...
    // set the permissions
    this.hasAdvancedOption = currentIg.hasPermission(
    ...
    this.profileMap = getProfileManagerServiceFactory()
    ...
    for (String s : profileMap.keySet()) {
      ...
      if (
        element.equals(CircabcConstant.GUEST_AUTHORITY) ||
        element.equals(
  ...
  public void export() {
    ...
    if (this.member.equals("allcircabcuser")) {
      ...
      for (Node node : users) {
        ...
        String currentProfile = props.get("profile") == null
          ? ""
          : props.get("profile").toString();
  ...
  private String searchMembers() {
    ...
    Map<String, Profile> invitedUsersProfiles =
      igRootProfileManagerService.getInvitedUsersProfiles(this.igRootNodeRef);
      ...
      if (logger.isErrorEnabled()) {
        logger.error(
          ...
          ((NavigationBean) FacesHelper.getManagedBean(
            ...
            .getUserName() +
          "| Get a profile value null with members search"
        );
      }
      return OUTCOME;
    }
    if (!this.profile.equals(EMPTY_STRING)) {
      ...
      if (
        authorityService.authorityExists(
          emptyProfile.getPrefixedAlfrescoGroupName()
        )
      ) {
        authorities = getAuthorityService()
    ...
    if ((search.equals(EMPTY_STRING))) {
      ...
      for (final MapNode node : usersDomain) {
        final String firstName = node.get(
          ...
          : node
            ...
            .toString()
            .toUpperCase();
        final String lastName = node.get(
          ...
          : node
            ...
            .toString()
            .toUpperCase();
        final String userName = node.get(
          ...
          : node
            ...
            .toString()
            .toUpperCase();
        final String email = node.get(ContentModel.PROP_EMAIL.toString()) ==
          null
          ? ""
          : node
            .get(ContentModel.PROP_EMAIL.toString())
            .toString()
            .toUpperCase();
        ...
        if (this.domain.equalsIgnoreCase(PermissionUtils.ALLUSERS)) {
          ...
          final String currentDomain = node
            .get(UserModel.PROP_DOMAIN.toString())
            .toString();
          if (this.domain.equalsIgnoreCase(currentDomain)) {
            if (
              (firstName.contains(search)) ||
  ...
  public UserService getUserService() {
    if (userService == null) {
      userService = (UserService) Services.getCircabcServiceRegistry(
        FacesContext.getCurrentInstance()
      ).getUserService();
    }
    return userService;
  ...
  public Boolean getUserAllowedToExport() {
    ...
    if (
      getPermissionService()
          .hasPermission(
            this.getCurrentInterstGroup().getNodeRef(),
            DirectoryPermissions.DIRMANAGEMEMBERS.toString()
          ) ==
