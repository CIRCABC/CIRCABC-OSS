...
public class EditPostDialog extends CreateContentBaseDialog {
  ...
  protected String finishImpl(FacesContext context, String outcome)
    ...
    if (!isCleanHTML(content, true)) {
      Utils.addErrorMessage(
        translate(MSG_ERR_INVALID_VALUE_FOR, translate("message"))
      );
      return null;
    }
    ...
    final String name = (String) getActionNode()
      .getProperties()
  ...
  public String getRejectMessage() {
    final String message = (String) getActionNode()
      .getProperties()
  ...
  public String getRejectModerator() {
    final String moderator = (String) getActionNode()
      .getProperties()
  ...
  public List<SelectItem> getOlderVersions() {
    if (olderVersions == null) {
      ...
      final VersionHistory history = getVersionService()
        .getVersionHistory(postRef);
