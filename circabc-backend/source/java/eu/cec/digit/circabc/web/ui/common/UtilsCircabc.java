...
public final class UtilsCircabc {
   ...
   */
  public static String buildImageTag(
   ...
   */
  public static String generateHrefPart(
    FacesContext context,
    ...
    hrefBuf.append("&amp;");
    hrefBuf.append(
      RendererUtils.findNestingForm(component, context).getFormName()
    );
   ...
   */
  public static String getFirstLines(
    final String text,
