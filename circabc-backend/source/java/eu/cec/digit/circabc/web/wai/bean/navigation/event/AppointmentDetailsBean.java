...
public class AppointmentDetailsBean extends InterestGroupBean {
  ...
  private static final String MSG_MEETING_PAGE_TITLE =
    "event_view_meetings_details_dialog_title";
  private static final String MSG_MEETING_PAGE_DESCRIPTION =
    "event_view_meetings_details_dialog_description";
  private static final String MSG_MEETING_PAGE_ICON_ALT =
    "event_view_meetings_details_dialog_icon_tooltip";
  private static final String MSG_MEETING_BROWSER_TITLE =
    "event_view_meetings_details_dialog_browser_title";

  private static final String MSG_EVENT_PAGE_TITLE =
    "event_view_event_details_dialog_title";
  private static final String MSG_EVENT_PAGE_DESCRIPTION =
    "event_view_event_details_dialog_description";
  private static final String MSG_EVENT_PAGE_ICON_ALT =
    "event_view_event_details_dialog_icon_tooltip";
  private static final String MSG_EVENT_BROWSER_TITLE =
    "event_view_event_details_dialog_browser_title";
  ...
  public String getPageDescription() {
    return translate(
      (isMeeting() ? MSG_MEETING_PAGE_DESCRIPTION : MSG_EVENT_PAGE_DESCRIPTION)
    );
  }

  public String getPageTitle() {
    return translate(
      (isMeeting() ? MSG_MEETING_PAGE_TITLE : MSG_EVENT_PAGE_TITLE),
  ...
  public String getPageIconAltText() {
    return translate(
      (isMeeting() ? MSG_MEETING_PAGE_ICON_ALT : MSG_EVENT_PAGE_ICON_ALT)
    );
  }
  ...
  public String getBrowserTitle() {
    return translate(
      (isMeeting() ? MSG_MEETING_BROWSER_TITLE : MSG_EVENT_BROWSER_TITLE)
    );
  }
  ...
  public String getDisplayEventType() {
    return AppointmentWebUtils.translate(
      ((Event) getAppointment()).getEventType()
    );
  }
  ...
  public String getDisplayMeetingAvailability() {
    return AppointmentWebUtils.translate(
      ((Meeting) getAppointment()).getAvailability()
    );
  }

  public String getDisplayEventPriority() {
    return AppointmentWebUtils.translate(
      ((Event) getAppointment()).getPriority()
    );
  }
  ...
  public String getDisplayTimesOccurence() {
    return AppointmentWebUtils.translate(
      getAppointment().getOccurenceRate().getTimesOccurence()
    );
  }

  public String getDisplayEveryTimesOccurence() {
    return AppointmentWebUtils.translate(
      getAppointment().getOccurenceRate().getEveryTimesOccurence()
    );
  }
  ...
  public String getDisplayLanguage() {
    return getContentFilterLanguagesService()
      .getLabelByCode(getAppointment().getLanguage());
  }
  ...
  public void init(Map<String, String> parameters) {
    ...
    if (closeOutcome == null) {
      this.closeOutcome =
        CircabcBrowseBean.PREFIXED_WAI_CLOSE_NAVIGATION_OUTCOME;
    } else {
      this.closeOutcome =
    ...
    if (TYPE_EVENT.isMatch(getCurrentNode().getType())) {
      ...
      final Boolean isRecurrent = !MainOccurence.OnlyOnce.equals(
  ...
  public String getSpaceDisplayPath() {
    ...
    if (ref != null) {
      final String parentPath = (String) getBrowseBean()
        .resolverSimpleDisplayPath.get(new Node(ref));
      final String leafName = (String) getNodeService()
  ...
  public List<AudienceUser> getAudienceDetail() {
    final HashMap<String, MeetingRequestStatus> statuses = getAppointment()
      .getAudience();
    ...
    for (Map.Entry<String, MeetingRequestStatus> entry : statuses.entrySet()) {
      ...
      status = (MeetingRequestStatus.NotApplicable.equals(entry.getValue())
          ? ""
          : translate(
            AppointmentWebUtils.MSG_PREFIX_REQUEST_STATUS +
  ...
  protected final PersonService getPersonService() {
    if (this.personService == null) {
      this.personService = Services.getAlfrescoServiceRegistry(
        FacesContext.getCurrentInstance()
      ).getPersonService();
    }
  ...
  protected final ContentFilterLanguagesService getContentFilterLanguagesService() {
    if (this.contentFilterLanguagesService == null) {
      this.contentFilterLanguagesService = Services.getAlfrescoServiceRegistry(
        FacesContext.getCurrentInstance()
