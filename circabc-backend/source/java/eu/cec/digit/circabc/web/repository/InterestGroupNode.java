...
public class InterestGroupNode extends NavigableNode {
  ...
  public static final String MSG_NO_CONTACT_INFO =
    "igroot_home_no_contact_information";
   ...
   */
  public static final QName NEWSGROUP_ASPECT =
   ...
   */
  public static final QName DIRECTORY_TYPE =
    CircabcModel.TYPE_DIRECTORY_SERVICE;
  /**
   * The information aspect root
   */
  public static final QName INFORMATION_ASPECT =
  ...
  private NodePropertyResolver resolverInformation =
  ...
  private NodePropertyResolver resolverContactInfo =
    new NodePropertyResolver() {
      private static final long serialVersionUID = 9088056683022871229L;

      public Object get(Node node) {
        Object contactInfo = node
          .getProperties()
  ...
  private NodePropertyResolver resolverSafeDescription =
    new NodePropertyResolver() {
      private static final long serialVersionUID = -4936070094338967058L;

      public Object get(Node node) {
        final Object desc = node
          .getProperties()
  ...
  private NodePropertyResolver resolverNoHtmlDescription =
    new NodePropertyResolver() {
      private static final long serialVersionUID = -5141066212483817911L;

      public Object get(Node node) {
        final Object lDesc = node
          .getProperties()
          .get(CircabcModel.PROP_LIGHT_DESCRIPTION.toString());
  ...
  private NodePropertyResolver resolverNeedModeDetails =
    new NodePropertyResolver() {
      ...
      public Object get(Node node) {
        ...
        if (
          lDesc == null || lDesc.toString().length() < CHARACTER_NUMBER_LIMIT
        ) {
          return false;
        } else {
          return true;
  ...
  public InterestGroupNode(
    ...
    if (!NavigableNodeType.IG_ROOT.equals(getNavigableNodeType())) {
      if (logger.isErrorEnabled()) {
        logger.error(
          "Wrong navigable nodeType for nodeRef: " + nodeRef.toString()
        );
        logger.error(
          "Expected nodeType: " + NavigableNodeType.IG_ROOT.toString()
        );
        logger.error(
          "Actual nodeType: " + getNavigableNodeType() != null
            ? getNavigableNodeType().toString()
            : null
        );
      }
      throw new IllegalArgumentException(
        "NodeRef must be a Circabc Interest Group and have the " +
  ...
  public NavigableNode getNavigableParent() {
    if (categoryNode == null) {
      NodeRef parent = services
        .getNodeService()
        .getPrimaryParent(this.nodeRef)
        .getParentRef();
