...
public class CircabcSessionSynchronizedFilter implements Filter {
  ...
  public void doFilter(
    ...
    if (session != null) {
      final ReentrantLock lock = (ReentrantLock) session.getAttribute(
      ...
      try {
        if (lock.tryLock(5, TimeUnit.SECONDS)) {
          ...
          writer.append("</ul></div>");
          writer.append(
            "</div><div id=\"maincontentGlobal\" class=\"errorMainContent\">"
          );
          writer.append(
          ...
          writer.append(
            "<span class=\"contentHeaderSubTitle\"><br><br></span>"
          );
          writer.append(
            "</div><div id=\"contentMainErrorPageGlobal\" class=\"contentMain\">"
          );
          writer.append(
