...
public class UISurveyLangs extends SelfRenderingComponent {
  ...
  private static final String COMPONENT_ACTIONLINK =
    "org.alfresco.faces.ActionLink";
  private static final String RENDERER_ACTIONLINK =
    "org.alfresco.faces.ActionLinkRenderer";
  private static final String COMPONENT_ACTIONLINK_WAI =
    "eu.cec.digit.circabc.faces.ActionLink";
  private static final String RENDERER_ACTIONLINK_WAI =
    "eu.cec.digit.circabc.faces.ActionLinkRenderer";
  ...
  private static final String COMPONENT_LISTEVAL =
    "eu.cec.digit.circabc.faces.ListContainsEvaluator";
  ...
  private void buildLinks(FacesContext context) {
    ...
    String ipmBaseUrl = CircabcConfiguration.getProperties()
      .getProperty("ipm.baseurl");
    ...
    for (String code : Language.codesList(CommonUtils.getLanguages())) {
      ...
      evaluator = (ListContainsEvaluator) facesApp.createComponent(
        COMPONENT_LISTEVAL
      );
      evaluator.setValueBinding(
        ListContainsEvaluatorTag.ATTR_LIST,
      ...
      control = (HtmlOutputLink) facesApp.createComponent(
        HtmlOutputLink.COMPONENT_TYPE
      );
      control.setValueBinding(
        "value",
        facesApp.createValueBinding(
          ipmBaseUrl + "?form=#{" + SURVEY_CONTEXT + ".name}&lang=" + code
        )
      );
      control.setTarget("blank");
      //control.setValue(ipmBaseUrl + "dispatch?form=" + "&nbsp;lang="+ code);
      control2 = (HtmlOutputText) facesApp.createComponent(
        HtmlOutputText.COMPONENT_TYPE
      );
      control2.setValue(code);
      control.getChildren().add(control2);
      evaluator.getChildren().add(control);
      HtmlOutputText control3 = (HtmlOutputText) facesApp.createComponent(
        HtmlOutputText.COMPONENT_TYPE
      );
      control3.setValue(" ");
