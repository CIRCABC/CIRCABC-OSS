...
public abstract class IEDownloadContentServlet
  extends IEBaseDownloadContentServlet {
  ...
  protected transient ThreadLocal<Boolean> authenticationError =
  ...
  protected void doHead(
    ...
    if (logger.isDebugEnabled()) {
      ...
      logger.debug(
        "Authenticating (HEAD) request to URL: " +
        req.getRequestURI() +
