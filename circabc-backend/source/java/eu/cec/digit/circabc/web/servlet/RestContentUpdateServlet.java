...
public class RestContentUpdateServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            try {
                String generateNewFileNameString = req.getParameter("generateNewFileName");
                if (generateNewFileNameString != null) {
                    generateNewFileName = Boolean.parseBoolean(generateNewFileNameString);
                }
            } catch (Exception e) {
                throw new IllegalArgumentException("The 'generateNewFileName' parameter must be a boolean.");
            }
            ...
            if (!item.isFormField()) {
                ...
                if (filename != null && filename.length() != 0) {
                    Map<String, String> res = handleUpdate(bean, item, targetRef, generateNewFileName);
