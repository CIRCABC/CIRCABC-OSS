...
public class MultiListRenderer extends BaseRenderer {
    ...
    if (component.isRendered() == true) {
      ...
      if (columnList.size() != multiList.getNumColumn()) {
        throw new IllegalStateException(
          "The number of columns specified is incorrect"
        );
      }
      ...
      if (multiList.isDataAvailable() == true) {
        ...
        out.write("<tr><td");
        String rowStyleClass = (String) multiList
          .getAttributes()
          .get("rowStyleClass");
  ...
  public void renderListBefore(
    ...
    out.write("<tr>");
    String headerClass = (String) multiList
      .getAttributes()
  ...
  public void renderListRow(
    ...
    String altStyle = (String) multiList
      .getAttributes()
