 ...
 */
public class PropertySheetItemRenderer
  extends org.alfresco.web.ui.repo.renderer.property.PropertySheetItemRenderer {

  public static final String MANDATORY_MARKER =
    "/images/icons/required_field.gif";
  ...
  public void encodeChildren(FacesContext context, UIComponent component)
    ...
    if (count == 2 || count == 3) {
      ...
      String labelStylceClass = (String) component
        .getParent()
        .getAttributes()
        .get("labelStyleClass");
      out.write("<th ");
