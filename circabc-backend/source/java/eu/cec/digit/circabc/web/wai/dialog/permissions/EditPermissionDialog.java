  ...
  protected String finishImpl(FacesContext context, String outcome)
    ...
    try {
      ...
      if (
        ...
        !guestsPermissions.contains(permission)
      ) {
      ...
      getPermissionService()
        .setPermission(nodeRef, this.authority, permission, true);
      ...
      logger.error(
        "Impossible to update the permission " +
        permission +
        " to authority " +
        authority,
        err
