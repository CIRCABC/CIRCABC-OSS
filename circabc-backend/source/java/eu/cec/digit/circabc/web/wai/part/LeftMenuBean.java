...
public class LeftMenuBean implements Serializable {
  ...
  private static final String MSG_EDIT_PROPERTIES_SPACE =
    "edit_space_action_title";
  private static final String MSG_EDIT_PROPERTIES_FORUM =
    "edit_discussion_action_title";
  private static final String MSG_EDIT_PROPERTIES_CIRCABC =
    "edit_circabc_action_title";
  private static final String MSG_EDIT_PROPERTIES_CATEGORY =
    "edit_category_action_title";
  private static final String MSG_EDIT_PROPERTIES_IGROOT =
    "edit_igroot_action_title";
  private static final String MSG_EDIT_PROPERTIES_LIBRARY =
    "edit_library_action_title";
  private static final String MSG_EDIT_PROPERTIES_NEWSGROUP =
    "edit_newsgroup_action_title";
  private static final String MSG_EDIT_PROPERTIES_SURVEY =
    "edit_survey_action_title";
  private static final String MSG_EDIT_PROPERTIES_INFORMATION =
    "edit_information_action_title";
  private static final String MSG_EDIT_PROPERTIES_EVENT =
    "edit_event_action_title";
  private static final String MSG_EDIT_PROPERTIES_HEADER =
    "edit_header_action_title";
  ...
  private static Boolean isDisplayServerInformationActive = Boolean.valueOf(
    CircabcConfiguration.getProperty(
      CircabcConfiguration.IS_DISPLAY_SERVER_INFORMATION_ACTIVATE
    )
  );
    ...
    try {
      result =
        ...
        serverConfigurationService
          .getConfigurationFileResume(
            serverConfigurationService.getCircabcVersionProps()
          )
  ...
  public boolean isNewsgroupActivated() {
    ...
    final boolean result =
      service != null && service.hasAspect(CircabcModel.ASPECT_NEWSGROUP);
    if (result) {
      //get sure that NewsGroupBean is ready because left-menu.jsp uses NewsGroupBean.actions
      FacesHelper.getManagedBean(
  ...
  public boolean isDirectoryActivated() {
    ...
    return (
      service != null &&
      !service.hasAspect(CircabcModel.ASPECT_SURVEY) &&
      !service.hasAspect(CircabcModel.ASPECT_LIBRARY) &&
      !service.hasAspect(CircabcModel.ASPECT_NEWSGROUP) &&
      !service.hasAspect(CircabcModel.ASPECT_INFORMATION) &&
      !service.hasAspect(CircabcModel.ASPECT_EVENT)
    );
  ...
  public boolean isInformationActivated() {
    final NavigableNode service = getNavigator().getCurrentIGService();
    return (
      service != null && service.hasAspect(CircabcModel.ASPECT_INFORMATION)
    );
  ...
  public void searchAutonomy(final ActionEvent event) {
    ...
    if (search.getSearchContext() != null) {
      ((AutonomySearchResultDialog) Beans.getBean(
          AutonomySearchResultDialog.BEAN_NAME
        )).reset();

      fc
        .getApplication()
        .getNavigationHandler()
        .handleNavigation(fc, null, AutonomySearchResultDialog.WAI_DIALOG_CALL);
    }
      ...
      new AuthenticationUtil.RunAsWork<Object>() {
        public Object doWork() {
          if (applicationCustomisationService.geteLearningLink() != null) {
            LeftMenuBean.eLearningLink =
              applicationCustomisationService.geteLearningLink();
          }
    ...
    AuthenticationUtil.runAs(
      new AuthenticationUtil.RunAsWork<Boolean>() {
        public Boolean doWork() {
          if (
            applicationCustomisationService.getDisplayeLearningLink() != null
          ) {
            LeftMenuBean.eLearningEnabled =
              applicationCustomisationService.getDisplayeLearningLink();
          } else {
  ...
  public String geteLearningLinkTitle() {
    return WebClientHelper.translate(
      "welcome_page_elearning",
