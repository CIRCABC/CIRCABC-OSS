...
public class UINodeSelector extends AbstractItemSelector {
  ...
  private static final String EU_CEC_DIGIT_CIRCABC_FACES_SPACE_SELECTOR =
    "eu.cec.digit.circabc.faces.NodeSelector";
  ...
  public String getParentNodeId(final FacesContext context) {
    ...
    if (
      ...
      this.navigationId.equals(getRootNode()) == false
    ) {
      try {
        final ChildAssociationRef parentRef = getFastNodeService(
          context
        ).getPrimaryParent(
  ...
  public Collection<NodeRef> getChildrenForNode(final FacesContext context) {
    ...
    final List<ChildAssociationRef> allKids = getNodeService(
      context
    ).getChildAssocs(
      nodeRef,
  ...
  public Collection<NodeRef> getRootChildren(FacesContext context) {
    ...
    PermissionService ps = Repository.getServiceRegistry(
      context
    ).getPermissionService();
    if (
      ps.hasPermission(rootRef, PermissionService.READ) != AccessStatus.ALLOWED
    ) {
  ...
  public void decode(FacesContext context) {
    ...
    if (submitedNoScriptValue != null) {
      if (submitedNoScriptValue.trim().equalsIgnoreCase("")) {
        ...
        final NodeRef nodeRefFromPath = getNodeRefFromPath(
          context,
          submitedNoScriptValue
        );
  ...
  private NodeRef getNodeRefFromPath(FacesContext context, String pathString) {
    ...
    if (tokens.hasMoreTokens()) { //root node
      ...
      final String rootName = nodeService
        .getProperty(iterNodeRef, ContentModel.PROP_NAME)
        .toString();
  ...
  public void encodeBegin(FacesContext context) throws IOException {
    ...
    context
      .getResponseWriter()
      .write("<div id=\"script\" style=\"visibility:hidden\" >");
  ...
  public String getItemIcon(FacesContext context, NodeRef ref) {
    ...
    String icon = (String) fastNodeService.getProperty(
      ref,
    ...
    if (icon != null) {
      ...
      final String contentName = (String) fastNodeService.getProperty(
        ref,
