...
public class AcceptMeetingRequestDialog extends AppointmentDialogBase {
  ...
  public static final String DIALOG_OUTCOME =
    "wai:dialog:acceptMeetingRequestWai";
  /**
   *
   */
  private static final long serialVersionUID = 1100813930081721315L;
  private static final String MSG_DIALOG_TITLE =
    "event_accept_recurrent_meeting_dialog_title";
  private static final String MSG_DIALOG_DESC =
    "event_accept_recurrent_meeting_dialog_description";
  private static final String MSG_DIALOG_BROWSER_TITLE =
    "event_accept_recurrent_meeting_dialog_browser_title";
  private static final String MSG_DIALOG_ICON_TOOLTIP =
    "event_accept_recurrent_meeting_dialog_icon_tooltip";
  private static final String MSG_ACCEPT_CURRENT_STATUS =
    "event_accept_meeting_message_current";
  private static final String MSG_ACCEPT_SPECIFIC_STATUS =
    "event_accept_meeting_message_specific";
  private static final String MSG_ACCEPT_CURRENT_SERIES_STATUS =
    "event_accept_meeting_message_specific";
  private static final String MSG_ACCEPT_SPECIFIC_SERIES_STATUS =
    "event_accept_meeting_series_message_specific";
  ...
  private void acceptSingleMeeting() {
    ...
    if (isCurrentNode(getActionNode())) {
      Utils.addStatusMessage(
        ...
        translate(MSG_ACCEPT_CURRENT_STATUS)
      );
    } else {
      Utils.addStatusMessage(
        FacesMessage.SEVERITY_INFO,
  ...
  private void acceptMultipleMeeting() {
    ...
    if (isCurrentNode(getActionNode())) {
      ...
      Utils.addStatusMessage(
        FacesMessage.SEVERITY_INFO,
        translate(
          MSG_ACCEPT_SPECIFIC_SERIES_STATUS,
