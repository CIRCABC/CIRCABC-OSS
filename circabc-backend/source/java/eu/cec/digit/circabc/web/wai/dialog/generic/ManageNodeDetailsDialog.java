...
public class ManageNodeDetailsDialog extends BaseWaiDialog {
  ...
  public void init(Map<String, String> parameters) {
    ...
    if (parameters != null) {
      ...
      if (actionNodeType == null) {
        ...
        ManagedNodes.CONTENT.equals(actionNodeType) ||
  ...
  public boolean isEventsNotifiables() {
    return (
      !ManagedNodes.DOSSIER.equals(actionNodeType) &&
      !ManagedNodes.LINK.equals(actionNodeType)
    );
  }
  ...
  public void applyVersionable(final ActionEvent event) {
    ...
    try {
      ...
      logRecord.setInfo(
        "took ownership of  " +
        getNodeService().getProperty(ref, ContentModel.PROP_NAME)
      );
  ...
  private void setActivityOk(
    final Map<String, String> params,
    final NodeRef ref
  ) {
    ParameterCheck.mandatoryString(
      "activity parameter",
      params.get(ACTIVITY_PARAMETER)
    );
    ParameterCheck.mandatoryString(
      "service parameter",
      params.get(SERVICE_PARAMETER)
    );
  ...
  public String getPanelTooltip() {
    return translate(
      "manage_" + actionNodeType.toString() + "_details_dialog_panel_tooltip"
    );
  }
  ...
  public String getNodeIconAltText() {
    return translate(
      "manage_" +
      actionNodeType.toString() +
      "_details_dialog_node_icon_tooltip",
  ...
  public String getBrowserTitle() {
    return translate(
      "manage_" + actionNodeType.toString() + "_details_dialog_browser_title"
    );
  }

  public String getPageIconAltText() {
    return translate(
      "manage_" + actionNodeType.toString() + "_details_dialog_icon_tooltip"
    );
  }
  ...
  public String getContainerTitle() {
    return translate(
      "manage_" + actionNodeType.toString() + "_details_dialog_title",
      getActionNode().getName()
    );
  }
  ...
  public String getContainerDescription() {
    return translate(
      "manage_" + actionNodeType.toString() + "_details_dialog_description"
    );
  }

  protected final OwnableService getOwnableService() {
    if (ownableService == null) {
      ownableService = Services.getAlfrescoServiceRegistry(
        FacesContext.getCurrentInstance()
      ).getOwnableService();
    }
