 ...
 */
public abstract class BaseDialogLauncherGenerator
  extends BaseComponentGenerator {

  public static final String PARAM_PROPERTY_KEY = "propertyKey";
  protected static final String ACTION_LISTENER =
  ...
  protected List<UIParameter> getActionParameters(
    final FacesContext context,
    final String id
  ) {
    //	add the parameter id to the dialog
    UIParameter parmeterNodeId = (UIParameter) context
      .getApplication()
    ...
    //add the parameter id to the dialog
    UIParameter parmeterPropId = (UIParameter) context
      .getApplication()
      .createComponent(UIParameter.COMPONENT_TYPE);
  ...
  protected UICommand buildActionCommand(
    ...
    HtmlCommandButton picker = (HtmlCommandButton) context
      .getApplication()
  ...
  protected UIComponent buildTextField(
    ...
    UIOutput textField = (UIOutput) context
      .getApplication()
