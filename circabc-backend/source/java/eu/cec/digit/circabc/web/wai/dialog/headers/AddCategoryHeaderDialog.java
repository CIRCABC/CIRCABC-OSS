...
public class AddCategoryHeaderDialog extends BaseWaiDialog {
  ...
  private static final String MSG_EMPTY_NAME =
    "create_cat_header_dialog_error_empty_name";
  private static final String MSG_INVALLID_NAME =
    "create_cat_header_dialog_error_invalid_name";
  private static final String MSG_NO_ROOT =
    "create_cat_header_dialog_error_no_root";
  ...
  protected String finishImpl(FacesContext context, String outcome)
    ...
    headerNodeRef = getCategoryService()
      .createCategory(rootHeader, name.trim());

    Map<QName, Serializable> titledProps = new HashMap<>(1, 1.0f);
    // apply the titled aspect - for description
    titledProps.put(ContentModel.PROP_DESCRIPTION, description);
    getNodeService()
      .addAspect(headerNodeRef, ContentModel.ASPECT_TITLED, titledProps);
  ...
  protected CategoryService getCategoryService() {
    if (categoryService == null) {
      categoryService = Services.getAlfrescoServiceRegistry(
