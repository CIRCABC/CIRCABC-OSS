...
public class SwitchForumModerationDialog extends BaseWaiDialog {
  ...
  private static final String SWITCH_MODERATION_ACTION_REFUSE_MESSAGE =
  ...
  public void init(Map<String, String> parameters) {
    ...
    if (
      ...
      statusBoolean = Boolean.parseBoolean(
        this.getNodeService()
          .getProperty(
            this.getActionNode().getNodeRef(),
            ModerationModel.PROP_IS_MODERATED
    ...
    moderationAction =
      SwitchForumModerationDialog.SWITCH_MODERATION_ACTION_REFUSE;
  ...
  protected String finishImpl(FacesContext context, String outcome)
    ...
    if (
      statusBoolean &&
      moderationStatus.equals(SWITCH_MODERATION_STATUS_DISABLED)
    ) {
      ...
      !statusBoolean &&
      moderationStatus.equals(SWITCH_MODERATION_STATUS_ENABLED)
    ) {
      moderationService.applyModeration(
        this.getActionNode().getNodeRef(),
        false
      );
      //updateChildren();
