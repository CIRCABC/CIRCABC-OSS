...
public class IGServicesNode extends NavigableNode {
      ...
      public Object get(final Node node) {
        ...
        while (true) {
          ...
          if (igRoot == null) {
            ...
            nonSecuredNodeService.hasAspect(igRoot, CircabcModel.ASPECT_IGROOT)
          ) {
  ...
  private NodePropertyResolver resolverIsLibrary = new NodePropertyResolver() {
    ...
    public Object get(final Node node) {
      ...
      return cNode
        .getNavigableNodeType()
        .isEqualsOrUnder(NavigableNodeType.LIBRARY);
    }
  };
  private NodePropertyResolver resolverIsNewsgroup =
    new NodePropertyResolver() {
      ...
      public Object get(final Node node) {
        ...
        return cNode
          .getNavigableNodeType()
          .isEqualsOrUnder(NavigableNodeType.NEWSGROUP);
      }
    };
  private NodePropertyResolver resolverIsSurvey = new NodePropertyResolver() {
    ...
    public Object get(final Node node) {
      ...
      return cNode
        .getNavigableNodeType()
        .isEqualsOrUnder(NavigableNodeType.SURVEY);
    }
  };
  private NodePropertyResolver resolverIsDirectory =
    new NodePropertyResolver() {
      ...
      public Object get(final Node node) {
        ...
        return cNode
          .getNavigableNodeType()
          .isEqualsOrUnder(NavigableNodeType.DIRECTORY);
      }
    };
  private NodePropertyResolver resolverIsInformation =
    new NodePropertyResolver() {
      ...
      public Object get(final Node node) {
        ...
        return cNode
          .getNavigableNodeType()
          .isEqualsOrUnder(NavigableNodeType.INFORMATION);
      }
    };
  private NodePropertyResolver resolverIsEvent = new NodePropertyResolver() {
    ...
    public Object get(final Node node) {
      ...
      return cNode
        .getNavigableNodeType()
        .isEqualsOrUnder(NavigableNodeType.EVENT);
    }
  };

  /*package*/IGServicesNode(
    final NodeRef nodeRef,
    final InterestGroupNode igNode,
  ...
  private void validate(final InterestGroupNode igNode) {
    if (getNavigableNodeType().equals(NavigableNodeType.IG_ROOT)) {
      ...
      !getNavigableNodeType().isEqualsOrUnder(NavigableNodeType.IG_ROOT)
    ) {
      throw new IllegalArgumentException(
        "NodeRef must be a Circabc Interest Group child aspect applied"
      ); //$NON-NLS-1$
    }
  ...
  public String getDynAttr1() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_1.toString());
  }

  public String getDynAttr2() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_2.toString());
  }

  public String getDynAttr3() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_3.toString());
  }

  public String getDynAttr4() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_4.toString());
  }

  public String getDynAttr5() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_5.toString());
  }

  public String getDynAttr6() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_6.toString());
  }

  public String getDynAttr7() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_7.toString());
  }

  public String getDynAttr8() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_8.toString());
  }

  public String getDynAttr9() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_9.toString());
  }

  public String getDynAttr10() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_10.toString());
  }

  public String getDynAttr11() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_11.toString());
  }

  public String getDynAttr12() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_12.toString());
  }

  public String getDynAttr13() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_13.toString());
  }

  public String getDynAttr14() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_14.toString());
  }

  public String getDynAttr15() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_15.toString());
  }

  public String getDynAttr16() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_16.toString());
  }

  public String getDynAttr17() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_17.toString());
  }

  public String getDynAttr18() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_18.toString());
  }

  public String getDynAttr19() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_19.toString());
  }

  public String getDynAttr20() {
    return (String) getProperties()
      .get(DocumentModel.PROP_DYN_ATTR_20.toString());
  }
  ...
  public NavigableNode getNavigableParent() {
    if (igNode == null) {
      final NodeRef ref = getManagementService()
        .getCurrentInterestGroup(this.nodeRef);
