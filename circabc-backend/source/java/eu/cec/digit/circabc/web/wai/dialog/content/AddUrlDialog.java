...
public class AddUrlDialog extends BaseWaiDialog {
  ...
  protected static final String MSG_ERROR_NAME_EMPTY =
    "library_add_url_name_empty";
  protected static final String MSG_ERROR_URL_INVALID =
    "library_add_url_url_invalid";
  protected static final String MSG_ERROR_NAME_EXISTS =
    "library_add_content_error_duplicate_name";
  private static final String LIBRARY_ADD_URL_TITLE = "library_add_url_title";
  private static final String LIBRARY_ADD_URL_ICON_TOOLTIP =
    "library_add_url_icon_tooltip";
  ...
  private static final String AN_URL_CAN_ONLY_BE_CREATED_WITHIN_A_SPACE =
    "An URL can only be created within a space";
  ...
  private String doPostCommitProcessingIntern(
  ...
  protected String finishImpl(final FacesContext context, final String outcome)
    ...
    name = WebClientHelper.generateUniqueName(
      getNodeService(),
      parentRef,
      name
    );
    ...
    if (isParentSpace(actionNode)) {
      ...
      getNodeService()
        .addAspect(createdNode, ContentModel.ASPECT_GEN_CLASSIFIABLE, null);
      ...
      this.getNodeService()
        .setProperty(createdNode, ContentModel.PROP_CATEGORIES, categories);
    } else {
      throw new IllegalArgumentException(
        AN_URL_CAN_ONLY_BE_CREATED_WITHIN_A_SPACE
      );
    }
    ...
    this.getNodeService()
      .addAspect(createdNode, ContentModel.ASPECT_TITLED, titledProps);

    // 4. adds the url aspect and properties
    this.getNodeService()
      .addAspect(createdNode, DocumentModel.ASPECT_URLABLE, null);
    this.getNodeService()
      .setProperty(createdNode, DocumentModel.PROP_URL, getUrl());
