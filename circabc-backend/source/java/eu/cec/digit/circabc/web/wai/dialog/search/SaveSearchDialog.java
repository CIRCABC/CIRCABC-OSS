...
public class SaveSearchDialog
  extends org.alfresco.web.bean.search.SaveSearchDialog
  ...
  protected String finishImpl(FacesContext context, String outcome)
    ...
    if (
      properties.getSearchName() == null ||
      properties.getSearchName().trim().length() < 1
    ) {
      // Found forbidden character
      Utils.addErrorMessage(
        Application.getMessage(context, "save_search_dialog_name_mandatory")
      );
      return null;
    }
      ...
      try {
          ...
          new RetryingTransactionCallback<Object>() {
            public Object execute() throws Throwable {
              ...
              props.put(
                ...
                properties.getSearchDescription()
              );
              ChildAssociationRef childRef = getNodeService()
                .createNode(
                  ...
                  QName.createQName(
                    ...
                    QName.createValidLocalName(properties.getSearchName())
                  ),
                  ContentModel.TYPE_CONTENT,
                  props
                );

              ContentService contentService = Repository.getServiceRegistry(
                context
              ).getContentService();
              ...
              NodeRef igNodeRef = getManagementService()
                .getCurrentInterestGroup(location);
        ...
        Utils.addErrorMessage(
          MessageFormat.format(
            Application.getMessage(newContext, MSG_ERROR_SAVE_SEARCH),
            e.getMessage()
          ),
          e
        );
