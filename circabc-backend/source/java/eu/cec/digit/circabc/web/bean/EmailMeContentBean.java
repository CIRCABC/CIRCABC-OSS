...
public class EmailMeContentBean implements Serializable {
   ...
   */
  private static final Log LOGGER = LogFactory.getLog(EmailMeContentBean.class);
  ...
  public void mailMe(ActionEvent event) {
    ...
    final RetryingTransactionCallback<Object> callback =
      new RetryingTransactionCallback<Object>() {
        public Object execute() throws Throwable {
          ...
          final boolean success = getBusinessRegistry()
            .getMailMeContentBusinessSrv()
            .send(ref, true);

          if (success) {
            final String successMsg = Application.getMessage(
              context,
              MSG_SUCCESS
            );
            ...
            Utils.addStatusMessage(
              ...
              MessageFormat.format(successMsg, name)
            );
          } else {
    ...
    try {
      ...
      final String errorMessage = Application.getMessage(
        context,
