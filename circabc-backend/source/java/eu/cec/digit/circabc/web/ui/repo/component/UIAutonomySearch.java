 ...
 * @author Guillaume
 */
public class UIAutonomySearch extends UICommand {
  ...
  private static final Log logger = LogFactory.getLog(UIAutonomySearch.class);
  /**
  ...
  public String getFamily() {
    return "eu.cec.digit.circabc.faces.AutonomySearch";
  }
  ...
  public void decode(FacesContext context) {
    ...
    if (value != null) {
      ...
      // {
      String searchText = (String) requestMap.get(
        getClientId(context) + "Text"
      );
  ...
  public void broadcast(FacesEvent event) throws AbortProcessingException {
    ...
    if (event instanceof SearchEvent) {
      ...
      context.setForceAndTerms(
        Application.getClientConfig(fc).getForceAndTerms()
      );
      context.setSimpleSearchAdditionalAttributes(
        Application.getClientConfig(fc).getSimpleSearchAdditionalAttributes()
      );
      this.search = context;
  ...
  public void encodeBegin(FacesContext context) throws IOException {
    ...
    out.write(
      UtilsCircabc.buildImageTag(
        context,
        WebResourcesCircabc.IMAGE_SEARCH_LABEL,
        getLabelAltText(),
        getLabel(),
        styleClass
      )
    ...
    out.write("\"");
    out.write(" onkeypress=\"handleKeyPress(this, event)\"");
    if (styleClass != null) {
      out.write(" class=\"");
    ...
    /*
		...
		final UIActionLink advSearchActionLink = (UIActionLink) facesApp.createComponent(ACTION_LINK_COMPONENT);
		...
		advSearchActionLink.setActionListener(context.getApplication().createMethodBinding(ACTION_LISTENER, ACTION_CLASS_ARGS));
		advSearchActionLink.setTooltip(Application.getMessage(context, "advanced_search_action_tooltip"));
        ...
        if(Beans.getSearchResultDialog().hasSearchAvailableInCache())
		{
    		...
    		final UIActionLink backToSearchActionLink = (UIActionLink) facesApp.createComponent(ACTION_LINK_COMPONENT);

    		backToSearchActionLink.setAction(new ConstantMethodBinding(SearchResultDialog.WAI_DIALOG_CALL));
    		backToSearchActionLink.setValue(Application.getMessage(context, "advanced_search_back_to_search"));
    		backToSearchActionLink.setActionListener(context.getApplication().createMethodBinding(ACTION_LISTENER, ACTION_CLASS_ARGS));
    		backToSearchActionLink.setTooltip(Application.getMessage(context, "advanced_search_back_to_search_tooltip"));
