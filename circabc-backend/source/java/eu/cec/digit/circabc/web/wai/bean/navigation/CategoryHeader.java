...
public class CategoryHeader
  implements Comparable<CategoryHeader>, Serializable {
  ...
  public List<CategoryItem> getCategories() {
    if (categories == null) {
      if (this.categoryHeader == null) {
        this.categoryHeader = new CategoryHeaderNode(
          categoryHeaderItem.getNodeRef()
        );
      }
      final List<NavigableNode> navigableChilds =
        this.categoryHeader.getNavigableChilds();
  ...
  public List<CategoryItem> getExternalLinks() {
    if (links == null) {
      ...
      final List<NavigableNode> externalLinks =
        this.categoryHeader.getExternalLinks();
