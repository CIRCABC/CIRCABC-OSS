...
public class DatePickerGeneratorRenderer extends DatePickerRenderer {
  ...
  public void decode(FacesContext context, UIComponent component) {
    try {
      ...
      if (
        ...
        ((String) params.get(clientId + FIELD_CMD_SET)) != null &&
        ...
        if (yearStr != null) {
          ...
          parts[0] = Integer.parseInt(
            (String) params.get(clientId + FIELD_YEAR)
          );
          parts[1] = Integer.parseInt(
            (String) params.get(clientId + FIELD_MONTH)
          );
          parts[2] = Integer.parseInt(
            (String) params.get(clientId + FIELD_DAY)
          );
          parts[3] = Integer.parseInt(
            (String) params.get(clientId + FIELD_HOUR)
          );
          parts[4] = Integer.parseInt(
            (String) params.get(clientId + FIELD_MINUTE)
          );
  ...
  public void encodeBegin(FacesContext context, UIComponent component)
    ...
    if (component.isRendered()) {
      ...
      Boolean initIfNull = (Boolean) component
        .getAttributes()
        .get("initialiseIfNull");

      // this is part of the spec:
      // first you attempt to build the date from the submitted value
      int[] submittedValue =
        (int[]) ((EditableValueHolder) component).getSubmittedValue();
      ...
      if (date != null) {
        ...
        int nStartYear = getDateFromAttributes(
          context,
          "startYear",
        ...
        int nYearCount = getDateFromAttributes(
          context,
          "yearCount",
          component.getAttributes(),
          DEFAULT_YEAR_COUNT
        ...
        renderMenu(
          out,
          component,
          getYears(nStartYear, nYearCount),
  ...
  private int getDateFromAttributes(
   ...
   */
  private void renderTimeElement(
    ResponseWriter out,
    UIComponent component,
    int currentValue,
    String clientId,
