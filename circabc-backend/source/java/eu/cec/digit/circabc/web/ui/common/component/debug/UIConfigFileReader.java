  ...
  public Map getDebugData() {
    ...
    for (final File file : PROPERTY_FILES_TO_READ) {
      ...
      try {
        ...
        properties.put(
          displayPath,
          "<b><font color=\"blue\">Successfully read</font></b>"
        );

        putAllKeyAsc(
          properties,
          getServerConfigurationService().getConfigurationFileResume(file)
        );
      } catch (FileNotFoundException ex) {
        properties.put(
          displayPath,
          "<b><font color=\"green\">Not exists</font></b>"
        );
      } catch (IOException | DocumentException ex) {
        properties.put(
          displayPath,
          "<b><font color=\"red\">Can't be opened due to: " +
          ex.getMessage() +
          "</font></b>"
        );
      }
