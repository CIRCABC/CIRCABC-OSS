...
public class DeleteCategoryDialogBean extends BaseWaiDialog {
  ...
  private static final Log logger = LogFactory.getLog(
    DeleteCategoryDialogBean.class
  );
  ...
  private final String MSG_DELETE_NO_PERMISSION_ADMIN =
    "delete_no_permission_admin";
    ...
    if (isDeleteCategoryNode()) {
      ...
      if (checkCircabcAdminAccess()) {
        ...
        logger.debug(
          "The category " +
          catName +
          " has been deleted successfully by " +
          userName
        );
      }
      ...
      getBrowseBean()
        .clickWai(getNavigator().getCircabcHomeNode().getNodeRef());
      return (
