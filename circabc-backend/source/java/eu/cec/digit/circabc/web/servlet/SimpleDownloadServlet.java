...
public class SimpleDownloadServlet extends BaseServlet {
  ...
  protected static String generateUrl(
    ...
    return MessageFormat.format(pattern, ref.getId(), URLEncoder.encode(name));
  }
    ...
    if (type.equals(ApplicationModel.TYPE_FILELINK)) {
      ...
      if (nodeRef == null) {
        res.sendError(
          ...
          "The link " + "destination is invalid."
        );
        return;
      }
          ...
          public Object doWork() {
            if (currentInterestGroup != null) {
              ...
              if (service != null) {
                ...
                final String circabcPath = PathUtils.getCircabcPath(
                  nodePath,
                  true
                );
                ...
                final Long documentID = (Long) nodeService.getProperty(
                  nodeRef,
                  ContentModel.PROP_NODE_DBID
                );
