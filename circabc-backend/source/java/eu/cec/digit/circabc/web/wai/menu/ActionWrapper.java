...
public class ActionWrapper implements Serializable {
  ...
  public ActionWrapper(
    ...
    super();
    this.permissionEvaluatorWrapper = new PermissionEvaluatorWrapper(
      allowPermission
    );
    this.actionLinkWrapper = new ActionLinkWrapper(
      linkValue,
      action,
      actionListener,
      tooltip,
  ...
  public static class ActionLinkWrapper implements Serializable {
    ...
    public ActionLinkWrapper(
      ...
      this.id =
        "id-" + this.id.replace('.', '_').replace(':', '_') + GUID.generate();
    }
