...
public abstract class ResolverHelper {
  ...
  public static final String NUMBER_WAITING_FOR_APPROVAL =
    "numberWaitingApproval";
  ...
  public static NavigableNode createContentRepresentation(
  ...
  public static NavigableNode createFileLinkRepresentation(
    final FileInfo fileInfo,
    final NodeService nodeService,
    final CircabcBrowseBean browseBean
  ) {
    //only display the user has the permissions to navigate to the target of the link
    final NodeRef destRef = (NodeRef) fileInfo
      .getProperties()
  ...
  public static NavigableNode createFolderLinkRepresentation(
    final FileInfo fileInfo,
    final NodeService nodeService,
    final CircabcBrowseBean browseBean
  ) {
  ...
  public static NavigableNode createFolderRepresentation(
    final FileInfo fileInfo,
    final NodeService nodeService,
    final CircabcBrowseBean browseBean
  ) {
  ...
  public static NavigableNode createForumRepresentation(
    final FileInfo fileInfo,
    final NodeService nodeService,
    final CircabcBrowseBean browseBean
  ) {
  ...
  public static NavigableNode createTopicRepresentation(
    final FileInfo fileInfo,
    final NodeService nodeService,
    final CircabcBrowseBean browseBean
  ) {
  ...
  public static NavigableNode createPostRepresentation(
    final FileInfo fileInfo,
    final NodeService nodeService,
    final CircabcBrowseBean browseBean
  ) {
  ...
  private static void addFolderRepresentation(
    ...
    node.addPropertyResolver(
      DISPLAY_PATH,
      browseBean.resolverSimpleDisplayPath
    );
    node.addPropertyResolver(
      DISPLAY_LIGTH_PATH,
      browseBean.resolverSimpleDisplayPathLight
    );
  ...
  private static void addContentRepresentation(
    final NavigableNode node,
    final CircabcBrowseBean browseBean,
  ...
  private static void addForumRepresentation(
    final NavigableNode node,
    final CircabcBrowseBean browseBean
  ) {
    node.addPropertyResolver(
    ...
    node.addPropertyResolver(
      NUMBER_WAITING_FOR_APPROVAL,
      browseBean.resolverNumberWaitingPost
    );
    node.addPropertyResolver(
      NUMBER_APPOVED,
      browseBean.resolverNumberApprovedPost
    );
    node.addPropertyResolver(
      NUMBER_REJECTED,
      browseBean.resolverNumberRejectedPost
    );
    node.addPropertyResolver(
      NAME_TRUNKED,
      browseBean.resolverTrunckedFourHundredName
    );
  ...
  private static void addTopicRepresentation(
    final NavigableNode node,
    final CircabcBrowseBean browseBean
  ) {
    node.addPropertyResolver(
  ...
  private static void addPostRepresentation(
    final NavigableNode node,
    final CircabcBrowseBean browseBean
  ) {
    addContentRepresentation(node, browseBean, false);
    ...
    node.addPropertyResolver(
      NAME_TRUNKED,
      browseBean.resolverContentFourHundred
    );
    ...
    node.addPropertyResolver(
      CREATOR_PROFILE,
      browseBean.resolverCreatorProfile
    );
    node.addPropertyResolver(
      CREATOR_USER_NAME,
      browseBean.resolverCreatorUserName
    );

    node.addPropertyResolver(
      NavigableNode.BEST_TITLE_RESOLVER_NAME,
      browseBean.resolverPost
    );

    node.addPropertyResolver(IS_MODERATED, browseBean.resolverIsModerated);
    node.addPropertyResolver(
      IS_WAITING_FOR_APPROVAL,
      browseBean.resolverWaitingForApproval
    );
    ...
    node.addPropertyResolver(
      REJECT_DISPLAY_MESSAGE,
      browseBean.resolverRejectMessages
    );
    node.addPropertyResolver(
      ABUSE_DISPLAY_MESSAGE,
      browseBean.resolverAbuseMessages
    );

    node.addPropertyResolver(
      HAS_ATTACHEMENT,
      browseBean.resolverHasAttachement
    );

    node.addPropertyResolver(CREATOR_AVATAR, browseBean.resolverCreatorAvatar);
    node.addPropertyResolver(
      CREATOR_SIGNATURE,
      browseBean.resolverCreatorSignature
    );
  }

  private static IGServicesNode buildNode(
    final FileInfo fileInfo,
    final NodeService nodeService
  ) {
    return new IGServicesNode(
      fileInfo.getNodeRef(),
      nodeService,
