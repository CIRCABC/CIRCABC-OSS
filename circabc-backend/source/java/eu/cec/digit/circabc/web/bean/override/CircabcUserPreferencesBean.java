...
public class CircabcUserPreferencesBean extends UserPreferencesBean {
  ...
  private static final String PREF_USER_INTERFACE_LANGUAGE =
    UserPreferencesBean.PREF_INTERFACELANGUAGE;
  private static final Log logger = LogFactory.getLog(
    CircabcUserPreferencesBean.class
  );
  private final Map<String, Integer> userRichListPreference = new HashMap<>(10);
    ...
    try {
      ...
      if (currentUser != null) {
        ...
        if (!currentUser.equalsIgnoreCase(guestUser)) {
          ...
          if (preferences != null) {
            final Serializable userInterfaceLanguage =
