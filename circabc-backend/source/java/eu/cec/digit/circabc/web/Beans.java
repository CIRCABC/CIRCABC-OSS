...
public class Beans {
  ...
  private static final String VERSIONED_DOCUMENT_DETAILS_DIALOG =
    "VersionedDocumentDetailsDialog";
  private static final String DOCUMENT_DETAILS_DIALOG = "DocumentDetailsDialog";
  private static final String MULTILINGUAL_MANAGE_DIALOG =
  ...
  private static final String CC_UNDO_CHECKOUT_FILE_DIALOG =
  ...
  public static Object getBean(final String beanName) {
    return FacesHelper.getManagedBean(
  ...
  public static CircabcUserPreferencesBean getUserPreferencesBean() {
    return (CircabcUserPreferencesBean) getBean(
      CircabcUserPreferencesBean.BEAN_NAME
    );
  }
  ...
  public static EditNodePropertiesDialog getEditNodePropertiesDialog() {
    return (EditNodePropertiesDialog) getBean(
      EditNodePropertiesDialog.BEAN_NAME
    );
  }

  public static EditOnlineDocumentDialog getEditOnlineDocumentDialog() {
    return (EditOnlineDocumentDialog) getBean(
      EditOnlineDocumentDialog.BEAN_NAME
    );
  }
  ...
  public static VersionedDocumentDetailsDialog getVersionedDocumentDetailsDialog() {
    return (VersionedDocumentDetailsDialog) getBean(
      VERSIONED_DOCUMENT_DETAILS_DIALOG
    );
  }
  ...
  public static MachineTranslationContentDialog getMachineTranslationContentBean() {
    return (MachineTranslationContentDialog) getBean(
      MachineTranslationContentDialog.BEAN_NAME
    );
  }

  public static MachineTranslationPropertyDialog getMachineTranslationPropertyBean() {
    return (MachineTranslationPropertyDialog) getBean(
      MachineTranslationPropertyDialog.BEAN_NAME
    );
  }
