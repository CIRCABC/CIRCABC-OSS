...
public class Services {
  ...
  public static CircabcServiceRegistry getCircabcServiceRegistry(
    ...
    if (serviceRegistry == null) {
      serviceRegistry =
        (CircabcServiceRegistry) FacesContextUtils.getRequiredWebApplicationContext(
          context
  ...
  public static CircabcServiceRegistry getCircabcServiceRegistry(
    ...
    if (serviceRegistry == null) {
      serviceRegistry =
        (CircabcServiceRegistry) WebApplicationContextUtils.getRequiredWebApplicationContext(
          context
        ).getBean(CircabcServiceRegistry.CIRCABC_SERVICE_REGISTRY);
    }
    return serviceRegistry;
  ...
  public static ServiceRegistry getAlfrescoServiceRegistry(
    ...
    if (alfrescoServiceRegistry == null) {
      alfrescoServiceRegistry =
        (ServiceRegistry) FacesContextUtils.getRequiredWebApplicationContext(
          context
  ...
  public static ServiceRegistry getAlfrescoServiceRegistry(
    ...
    if (alfrescoServiceRegistry == null) {
      alfrescoServiceRegistry =
        (ServiceRegistry) WebApplicationContextUtils.getRequiredWebApplicationContext(
          context
        ).getBean(ServiceRegistry.SERVICE_REGISTRY);
    }
    return alfrescoServiceRegistry;
  ...
  public static BusinessRegistry getBusinessRegistry(FacesContext context) {
    if (businessRegistry == null) {
      businessRegistry =
        (BusinessRegistry) FacesContextUtils.getRequiredWebApplicationContext(
          context
        ).getBean(BusinessRegistry.BUSINESS_REGISTRY);
    }
  ...
  public static BusinessRegistry getBusinessRegistry(ServletContext context) {
    if (businessRegistry == null) {
      businessRegistry =
        (BusinessRegistry) WebApplicationContextUtils.getRequiredWebApplicationContext(
          context
        ).getBean(BusinessRegistry.BUSINESS_REGISTRY);
    }
    return businessRegistry;
