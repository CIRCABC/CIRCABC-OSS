...
public class AppointmentWebUtils {
  ...
  public static final String MSG_PREFIX_MEETING_TYPE =
    "event_create_meetings_wizard_step1_type_";
  public static final String MSG_PREFIX_AVAILABILITY =
    "event_create_meetings_wizard_step1_availability_";
  public static final String MSG_PREFIX_AUDIENCE_STATUS =
    "event_create_meetings_wizard_step1_audience_status_";
  public static final String MSG_PREFIX_TIMES_OCCURENCE =
    "event_create_meetings_wizard_step1_occurs_";
  public static final String MSG_PREFIX_EVERY_TIMES_OCCURENCE =
    MSG_PREFIX_TIMES_OCCURENCE;
  public static final String MSG_PREFIX_REQUEST_STATUS =
    "event_view_meetings_details_dialog_";

  public static final String MSG_PREFIX_EVENT_TYPE =
    "event_create_event_wizard_step1_type_";
  public static final String MSG_PREFIX_PRIORITY =
    "event_create_event_wizard_step1_priority_";
  ...
  public static String translate(
    final MeetingAvailability meetingAvailability
  ) {
  ...
  public static String translate(
    final EveryTimesOccurence everyTimesOccurence
  ) {
  ...
  private static String translate(final Enum enumItem, String messagePrefix) {
    ...
    return WebClientHelper.translate(
      messagePrefix + enumItem.name().toLowerCase()
    );
  }
}
