...
public class UISimpleSearch extends UICommand {
  ...
  public void encodeBegin(FacesContext context) throws IOException {
    ...
    out.write(
      UtilsCircabc.buildImageTag(context, "/images/icons/search_icon.gif", ".")
    );
    ...
    final UIActionLink advSearchActionLink =
      (UIActionLink) facesApp.createComponent(ACTION_LINK_COMPONENT);

    advSearchActionLink.setAction(
      new ConstantMethodBinding(AdvancedSearchDialog.WAI_DIALOG_CALL)
    );
    advSearchActionLink.setValue(
      Application.getMessage(context, "advanced_search_action")
    );
    advSearchActionLink.setActionListener(
      context
        .getApplication()
        .createMethodBinding(ACTION_LISTENER, ACTION_CLASS_ARGS)
    );
    advSearchActionLink.setTooltip(
      Application.getMessage(context, "advanced_search_action_tooltip")
    );
    advSearchActionLink.setParent(this);
    advSearchActionLink.setId("advSearch" + System.currentTimeMillis());

    final UIParameter advSearchParam = (UIParameter) facesApp.createComponent(
    ...
    if (Beans.getSearchResultDialog().hasSearchAvailableInCache()) {
      ...
      out.write(
        UtilsCircabc.buildImageTag(context, "/images/icons/filter.gif", ".")
      );

      out.write("&nbsp;&nbsp;");

      final UIActionLink backToSearchActionLink =
        (UIActionLink) facesApp.createComponent(ACTION_LINK_COMPONENT);

      backToSearchActionLink.setAction(
        new ConstantMethodBinding(SearchResultDialog.WAI_DIALOG_CALL)
      );
      backToSearchActionLink.setValue(
        Application.getMessage(context, "advanced_search_back_to_search")
      );
      ...
      backToSearchActionLink.setTooltip(
        Application.getMessage(
          context,
          "advanced_search_back_to_search_tooltip"
        )
      );
