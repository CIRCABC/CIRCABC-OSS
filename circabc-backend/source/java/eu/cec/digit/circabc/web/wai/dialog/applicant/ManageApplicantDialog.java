...
public class ManageApplicantDialog extends BaseWaiDialog {
  ...
  public static final String MANAGE_APPLICANT_DIALOG_INFORMATION_MESSAGE =
    "ManageApplicantDialog. informationMessage";
  // the used confirmation/error message
  public static final String MESSAGE_APPLY_MEMBERSHIP_SUCCESS =
    "apply_membership_process_success";
  public static final String MESSAGE_APPLY_MEMBERSHIP_FAILED =
    "apply_membership_process_failed";
  public static final String MESSAGE_REFUSE_APPLICATION_SUCCESS =
    "refuse_applicant_process_success";
  public static final String MESSAGE_REFUSE_APPLICATION_FAILED =
    "refuse_applicant_process_failed";
  ...
  private static final String MESSAGE_ID_DESCRIPTION =
    "manage_applicants_page_description";
  ...
  public String getInformationMessage() {
    ...
    Map<Object, Object> session = FacesContext.getCurrentInstance()
      .getExternalContext()
      .getSessionMap();
    String toReturn = (String) session.get(
      MANAGE_APPLICANT_DIALOG_INFORMATION_MESSAGE
    );
  ...
  public boolean getHasInformationMessage() {
    Map<Object, Object> session = FacesContext.getCurrentInstance()
      .getExternalContext()
      .getSessionMap();
    String informationMessage = (String) session.get(
      MANAGE_APPLICANT_DIALOG_INFORMATION_MESSAGE
    );
  ...
  public List<Applicant> getApplicants() {
    ...
    //	get the applicants
    Map<String, Applicant> applicantsMap = profManagerService.getApplicantUsers(
      space
    );
