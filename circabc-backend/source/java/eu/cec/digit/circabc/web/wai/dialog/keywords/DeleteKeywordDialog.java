...
public class DeleteKeywordDialog extends BaseWaiDialog {
  ...
  private static final Log logger = LogFactory.getLog(
    DeleteKeywordDialog.class
  );

  private static final String MSG_ERROR_NODE_LOCKED =
    "delete_keyword_dialog_error_node_locked";
  ...
  public void init(Map<String, String> parameters) {
    ...
    if (parameters != null) {
      final String keyAsString = parameters.get(
  ...
  protected String finishImpl(FacesContext context, String outcome)
    ...
    if (logger.isDebugEnabled()) {
      ...
      logger.debug(
        "Trying to delete the keyword " + keywordToDelete.toString() + " ..."
      );
    }
    ...
    try {
      ...
      if (logger.isDebugEnabled()) {
        logger.debug(
          "Impossible to delete a keyword since documents are locked"
        );
      }
    ...
    if (logger.isDebugEnabled()) {
      ...
      logger.debug(
        "Time to delete the keyword and to remove from it related documents: " +
        (endTime - startTime) +
        "ms"
      );
    }
