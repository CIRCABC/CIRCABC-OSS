...
public class DeleteAppointmentDialog extends AppointmentDialogBase {
  ...
  private static final String MSG_DIALOG_TITLE_MEETING =
    "event_delete_meeting_dialog_title";
  private static final String MSG_DIALOG_TITLE_EVENT =
    "event_delete_event_dialog_title";

  private static final String MSG_DIALOG_DESC =
    "event_delete_meeting_dialog_description";
  private static final String MSG_DIALOG_BROWSER_TITLE =
    "event_delete_meeting_dialog_browser_title";
  private static final String MSG_DIALOG_ICON_TOOLTIP =
    "event_delete_meeting_dialog_icon_tooltip";

  private static final String MSG_DIALOG_MEETING_CONFIRMATION =
    "event_delete_meeting_dialog_confirmation_single";
  private static final String MSG_DIALOG_RECURRENT_MEETING_CONFIRMATION =
    "event_delete_meeting_dialog_confirmation_recurrent";
  private static final String MSG_DIALOG_EVENT_CONFIRMATION =
    "event_delete_event_dialog_confirmation_single";
  private static final String MSG_DIALOG_RECURRENT_EVENT_CONFIRMATION =
    "event_delete_event_dialog_confirmation_recurrent";

  private static final String MSG_MAIL_INFO_MEETING =
    "event_delete_meeting_dialog_confirmation_mail";
  private static final String MSG_MAIL_INFO_EVENT =
    "event_delete_event_dialog_confirmation_mail";

  private static final String MSG_DELETE_ERROR =
    "event_delete_meeting_dialog_error";
  ...
  public String getMailInformation() {
    if (isRecurrent() && !isAudienceOpen()) {
      return isMeeting()
        ? translate(MSG_MAIL_INFO_MEETING)
        : translate(MSG_MAIL_INFO_EVENT);
    } else {
  ...
  public String getConfirmation() {
    if (isMeeting()) {
      if (isRecurrent()) {
        ...
        return translate(
          MSG_DIALOG_MEETING_CONFIRMATION,
