...
public class RemovePermissionDialog extends BaseWaiDialog {
  ...
  protected static final String MSG_REMOVE_PAGE_TITLE_USER =
    "remove_space_permission_page_title_user";
  protected static final String MSG_REMOVE_PAGE_TITLE_PROF =
    "remove_space_permission_page_title_access_profile";
  protected static final String MSG_REMOVE_PAGE_SUBTITLE_USER =
    "remove_space_permission_page_subtitle_user";
  protected static final String MSG_REMOVE_PAGE_SUBTITLE_PROF =
    "remove_space_permission_page_subtitle_access_profile";
  protected static final String MSG_REMOVE_PAGE_CONTENT_USER =
    "remove_space_permission_page_content_user";
  protected static final String MSG_REMOVE_PAGE_CONTENT_PROF =
    "remove_space_permission_page_content_access_profile";
  private static final long serialVersionUID = 777770868117140631L;
  private static final Log logger = LogFactory.getLog(
    RemovePermissionDialog.class
  );
    ...
    try {
      if (authority != null) {
        ...
        this.getPermissionService()
          .clearPermission(getActionNode().getNodeRef(), authority);
      }
      ...
      if (logger.isDebugEnabled()) {
        logger.debug(
          "Permissions successfully removed to " +
          displayName +
          " in the space " +
