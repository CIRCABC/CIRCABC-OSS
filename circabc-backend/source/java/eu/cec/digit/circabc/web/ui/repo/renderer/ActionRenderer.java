...
public class ActionRenderer extends BaseRenderer {
   ...
   */
  private static void addParameterToHref(
    String name,
    Object value,
  ...
  private static UIComponent getVerticalContainer(UIActionLink link) {
    ...
    while (parent != null) {
      if (
        parent instanceof UIMenu ||
        (parent instanceof UIActions && ((UIActions) parent).isVerticalAlign())
      ) {
        break;
      }
  ...
  public void decode(FacesContext context, UIComponent component) {
    ...
    String reqValue = (String) context
      .getExternalContext()
   ...
   */
  protected void selectMode(FacesContext context, UIComponent component)
    throws IOException {
  ...
  protected void renderCommandLinkStart(
    ...
    String tittle = attrs.get("tooltip") != null
      ? attrs.get("tooltip").toString()
      : (String) link.getValue();
    writer.writeAttribute(HTML.TITLE_ATTR, tittle, null);

    if (link.getImage() != null) {
      final String imageName = UtilsCircabc.buildImageNameFromHref(
      ...
      writer.write(
        UtilsCircabc.buildImageTag(context, image, alt, alt, null, imageName)
      );
      if (link.getShowLink()) {
   ...
   * @param clientId     The clientId of the component
   */
  protected String renderNonJavaScriptAnchorStart(
    ...
    if (attrs.get("href") != null) {
      ...
      String hiddenFieldName = HtmlRendererUtils.getHiddenCommandLinkFieldName(
        RendererUtils.findNestingForm(component, facesContext)
      );
      ...
      StateManager stateManager = facesContext
        .getApplication()
        .getStateManager();
      ...
      if (stateManager.isSavingStateInClient(facesContext)) {
        hrefBuf.append("&amp;");
        logger.info(
          "isSavingStateInClient |" + WebResourcesCircabc.URL_STATE_MARKER + "|"
        );
   ...
   * @param charEncoding  Character encoding
   */
  private void addChildParametersToHref(
  ...
  public void encodeEnd(FacesContext context, UIComponent component)
    ...
    HtmlFormRendererBase.renderScrollHiddenInputIfNecessary(
      RendererUtils.findNestingForm(component, context).getForm(),
      context,
