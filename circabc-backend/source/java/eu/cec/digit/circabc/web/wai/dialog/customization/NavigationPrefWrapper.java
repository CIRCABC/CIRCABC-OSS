...
public class NavigationPrefWrapper implements Serializable {
  ...
  /*package*/static final String MSG_CURRENT_NODE =
    "manage_navigation_dialog_currentNode";
  /*package*/static final String MSG_UNDEFINED =
    "manage_navigation_dialog_undefined";
  private static final String MSG_PREFIX_SERVICE =
    "manage_navigation_dialog_service_";
  private static final String MSG_PREFIX_TYPE =
    "manage_navigation_dialog_type_";
  /**
   *
   */
