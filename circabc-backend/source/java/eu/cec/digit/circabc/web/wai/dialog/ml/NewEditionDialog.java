 ...
 * @author Guillaume
 */
public class NewEditionDialog
  extends org.alfresco.web.bean.ml.NewEditionWizard
  ...
  public SelectItem[] getTranslatedDocuments() {
    ...
    ArrayList<TranslationWrapper> list = (ArrayList<
        TranslationWrapper
  ...
  protected String doPostCommitProcessing(
    ...
    logRecord.setInfo(
      "Created a new version based on " +
      this.browseBean.getDocument().getName()
    );
  ...
  public String getPageIconAltText() {
    return Application.getMessage(
      FacesContext.getCurrentInstance(),
      "title_new_edition_icon_tooltip"
    );
  }
