...
public class DeclineMeetingRequestDialog extends AppointmentDialogBase {
    ...
    private void rejectSingleMeeting() {
        ...
        getEventService()
                .setMeetingRequestStatus(appointementNodeRef, userName, MeetingRequestStatus.Rejected,
                        UpdateMode.Single);
    ...
    private void rejectMultipleMeeting() {
        ...
        if (isCurrentNode(getActionNode())) {
            ...
            Utils.addStatusMessage(FacesMessage.SEVERITY_INFO,
                    translate(MSG_DECLINE_SPECIFIC_SERIES_STATUS, getAppointment().getTitle()));
        }
    }
