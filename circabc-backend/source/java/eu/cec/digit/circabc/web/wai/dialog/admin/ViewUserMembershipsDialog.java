...
public class ViewUserMembershipsDialog extends BaseWaiDialog {
   ...
   */
  private transient PersonService personService = null;
  /**
  ...
  public String search() {
    ...
    if (this.domain == null || this.name == null) {
      if (logger.isErrorEnabled()) {
        logger.error(
          "search: Parameters are null for user |" +
  ...
  private List<SearchResultRecord> filterCategoryMembers() {
    ...
    Set<String> users = profileManagerService.getInvitedUsers(
      getActionNode().getNodeRef()
    );
    users.addAll(
      profileManagerService.getAllSubUsers(getActionNode().getNodeRef())
    );
