...
public class InterestGroupBean extends BaseWaiNavigator {
  ...
  protected static final String ADD_CONTENT_TOOLTIP =
    "library_add_content_tooltip";
  protected static final String ADD_CONTENT_BEAN_START =
    "CircabcAddContentBean.start";
  protected static final String ADD_CONTENT = "library_add_content";
  protected static final String CREATE_SPACE_ACTION =
    "library_create_space_action";
  protected static final String CREATE_SPACE_TOOLTIP =
    "library_create_space_tooltip";
  protected static final String DIALOG_MANAGER_SETUP_PARAMETERS =
    "WaiDialogManager.setupParameters";
  protected static final String WAI_DIALOG_CREATE_SPACE_WAI =
    "wai:dialog:createSpaceWai";
  ...
  private static final String SEARCH_RESULTS_RETURNED =
    "Search results returned: ";
  private static final String TYPE = ", type = ";
  private static final String FOUND_INVALID_OBJECT_IN_DATABASE_ID =
  ...
  private static final String TIME_TO_QUERY_AND_BUILD_MAP_NODES =
    "Time to query and build map nodes: ";
  private static final String CREATE_FILE_LINK_REPRESENTATION_NOT_OPTIMIZED_FOR_TYPE =
    "createFileLinkRepresentation not optimized for type:";
  private static final String CREATE_FOLDER_LINK_REPRESENTATION_NOT_OPTIMIZED_FOR_TYPE =
    "createFolderLinkRepresentation not optimized for type:";
  private static final String CREATE_FOLDER_REPRESENTATION_NOT_OPTIMIZED_FOR_TYPE =
    "createFolderRepresentation not optimized for type:";
  private static final String CREATE_NODE_CONTENT_REPRESENTATION_NOT_OPTIMIZED_FOR_TYPE =
    "createNodeContentRepresentation not optimized for type:";
  ...
  private static final String PROP_CREATED_ESCAPED =
    ContentModel.PROP_CREATED.toString()
      ...
      .replaceAll("\\{", "\\\\{")
      .replaceAll("\\}", "\\\\}");
  private static final String TYPE_FILE_ESCAPED =
    ContentModel.TYPE_CONTENT.toString()
      .replaceAll(":", ESCAPE4)
      .replaceAll("\\{", "\\\\{")
      .replaceAll("\\}", "\\\\}");
  private static final String TYPE_FOLDER_ESCAPED =
  ...
  public boolean isJoinAllowed() {
    ...
    if (
      ...
      Boolean canJoin = PermissionUtils.isUserCanJoinNode(
  ...
  public List<WhatsNewResult> getWhatsNewNodes() {
    ...
    final String query = buildWhatNewQuery(
    ...
    final RetryingTransactionCallback<List<WhatsNewResult>> callback =
      new RetryingTransactionCallback<List<WhatsNewResult>>() {
            ...
            if (results.length() != 0) {
              ...
              for (final ResultSetRow row : results) {
                try {
                        ...
                        if (whatsNewResult != null) {
                          ...
                          if (typeDef != null) {
                            ...
                            if (ContentModel.TYPE_CONTENT.equals(type)) {
                              node = ResolverHelper.createContentRepresentation(
                                fileInfo,
                                nodeService,
                                browseBean
                              );
                            } else if (ContentModel.TYPE_FOLDER.equals(type)) {
                              node = ResolverHelper.createFolderRepresentation(
                                fileInfo,
                                nodeService,
                                browseBean
                              );
                              ...
                              node =
                                ResolverHelper.createFolderLinkRepresentation(
                                  fileInfo,
                                  nodeService,
                                  browseBean
                                );
                              ...
                              node =
                                ResolverHelper.createFileLinkRepresentation(
                                  fileInfo,
                                  nodeService,
                                  browseBean
                                );
                            } else if (ForumModel.TYPE_POST.equals(type)) {
                              node = ResolverHelper.createPostRepresentation(
                                fileInfo,
                                nodeService,
                                browseBean
                              );
                              ...
                              if (logger.isWarnEnabled()) {
                                logger.debug(
                                  CREATE_NODE_CONTENT_REPRESENTATION_NOT_OPTIMIZED_FOR_TYPE +
                                  type
                                );
                              }
                              node = ResolverHelper.createContentRepresentation(
                              ...
                              if (logger.isWarnEnabled()) {
                                logger.debug(
                                  CREATE_FOLDER_REPRESENTATION_NOT_OPTIMIZED_FOR_TYPE +
                                  type
                                );
                              }
                              node = ResolverHelper.createFolderRepresentation(
                              ...
                              if (logger.isWarnEnabled()) {
                                logger.debug(
                                  CREATE_FOLDER_LINK_REPRESENTATION_NOT_OPTIMIZED_FOR_TYPE +
                                  type
                                );
                              }
                              node =
                              ...
                              if (logger.isWarnEnabled()) {
                                logger.debug(
                                  CREATE_FILE_LINK_REPRESENTATION_NOT_OPTIMIZED_FOR_TYPE +
                                  type
                                );
                              }
                              node =
                            ...
                            if (logger.isWarnEnabled()) {
                              logger.warn(
                                FOUND_INVALID_OBJECT_IN_DATABASE_ID +
                                nodeRef +
                                TYPE +
                                type
                              );
                  ...
                  errorMessages.add(
                    translate(Repository.ERROR_NODEREF, refErr.getNodeRef())
                  );
                  ...
                  errorMessages.add(
                    translate(Repository.ERROR_SEARCH, err.getMessage())
                  );
                }
              }
            } else {
              if (logger.isInfoEnabled()) {
                logger.info(
                  "Nothing new to display in the what's new page of this IG."
                );
              }
    ...
    final List<WhatsNewResult> resultNodes = txnHelper.doInTransaction(
      callback,
      true
    );
    ...
    if (logger.isDebugEnabled()) {
      ...
      logger.debug(
        TIME_TO_QUERY_AND_BUILD_MAP_NODES + (endTime - startTime) + MS
      );
    }
  ...
  public List<NavigableNode> getVisibleDocuments() {
    ...
    final RetryingTransactionHelper txnHelper =
      Repository.getRetryingTransactionHelper(context);
    final RetryingTransactionCallback<List<NavigableNode>> callback =
      new RetryingTransactionCallback<List<NavigableNode>>() {
    ...
    final List<NavigableNode> resultNodes = txnHelper.doInTransaction(
      callback,
      true
    );
  ...
  private String buildvisibleDocumentQuery() {
    String query =
      "( PATH:\"" +
      getPathFromSpaceRef(
        getNavigator().getCurrentIGRoot().getNodeRef(),
        true
      ) +
      "\"" +
      " )";
   ...
   */
  protected String buildWhatNewQuery(
   ...
   */
  protected ResultSet getWhatsNewNodes(
  ...
  protected final SearchService getInternalSearchService() {
    if (this.internalSearchService == null) {
      this.internalSearchService = Services.getCircabcServiceRegistry(
   ...
   */
  public final void setInternalSearchService(
    final SearchService internalSearchService
  ) {
    this.internalSearchService = internalSearchService;
  }

  public void setWhatsNewNodesCache(
    final SimpleCache<NodeRef, WhatsNewResult> whatsNewNodesCache
  ) {
