...
public class RejectPostDialog extends ModerationDialog {
  ...
  private static final String MSG_REJECTED_SUCCESS =
    "post_moderation_reject_success";
  private static final String MSG_REJECTED_FAILURE =
    "post_moderation_reject_failure";
  ...
  protected String finishImpl(FacesContext context, String outcome)
    ...
    try {
      ...
      Utils.addStatusMessage(
        ...
        translate(MSG_REJECTED_SUCCESS)
      );
