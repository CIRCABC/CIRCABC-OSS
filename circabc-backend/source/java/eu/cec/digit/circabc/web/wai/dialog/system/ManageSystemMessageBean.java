...
public class ManageSystemMessageBean extends BaseWaiDialog {
  ...
  static final Log logger = LogFactory.getLog(ManageSystemMessageBean.class);
  ...
  public void init(final Map<String, String> parameters) {
    ...
    if (
      ...
      this.helpLink = this.getNodeService()
  ...
  private SystemMessageBean getSystemMessageBean() {
    if (systemMessageBean == null) {
      ...
      Map application = FacesContext.getCurrentInstance()
        .getExternalContext()
        .getApplicationMap();
      systemMessageBean = (SystemMessageBean) application.get(
        "SystemMessageBean"
      );
    }
