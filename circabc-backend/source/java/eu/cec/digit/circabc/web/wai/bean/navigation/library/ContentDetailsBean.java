...
public class ContentDetailsBean extends InterestGroupBean {
  ...
  public static final String MSG_PAGE_ICON_ALT =
    "library_content_details_icon_tooltip";
  ...
  public String getPageTitle() {
    return (
      translate(MSG_PAGE_TITLE) + " \'" + getCurrentNode().getName() + '\''
    );
  }
  ...
  public boolean isPublishedInExternalRepository() {
    return externalRepositoriesManagementService.wasPublishedTo(
      null,
  ...
  public Map<String, Map<String, String>> getRepositoriesInfo() {
    Map<String, Map<String, String>> data =
      externalRepositoriesManagementService.getRepositoryDataForDocument(
        getCurrentNode().getNodeRef().toString()
      );
  ...
  public Node getDocumentMlContainer() {
    ...
    if (
      ContentModel.TYPE_MULTILINGUAL_CONTAINER.equals(currentNode.getType())
    ) {
      return currentNode;
    } else {
      ...
      return new Node(
        getMultilingualContentService().getTranslationContainer(nodeRef)
      );
    }
  }
   ...
   */
  public final void setDocumentDetailsDialog(
  ...
  protected final MultilingualContentService getMultilingualContentService() {
    if (this.multilingualContentService == null) {
      this.multilingualContentService = Services.getAlfrescoServiceRegistry(
  ...
  public final void setMultilingualManageDialog(
    MultilingualManageDialog multilingualManageDialog
  ) {
