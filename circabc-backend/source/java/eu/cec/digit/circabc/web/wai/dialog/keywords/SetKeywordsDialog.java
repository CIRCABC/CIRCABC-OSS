...
public class SetKeywordsDialog
  extends SelectKeywordsBaseDialog
  ...
  protected String finishImpl(FacesContext context, String outcome)
    throws Exception {
    final List<Keyword> docKeywordsAsList = new ArrayList<>(
      settedKeywords.size()
    );
    docKeywordsAsList.addAll(settedKeywords.values());
    String info =
      "Trying to set the keywords to the current document : " +
      "\n   Document: " +
    ...
    getKeywordsService()
      .setKeywordsToNode(getActionNode().getNodeRef(), docKeywordsAsList);
    ...
    Beans.getEditNodePropertiesDialog()
      .setPropetyDefinedOutside(DocumentModel.PROP_KEYWORD);
