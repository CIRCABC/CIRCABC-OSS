...
public class LibraryBean extends InterestGroupBean {
  ...
  public static final String TARGET_GROUP_LINK_TO_SHARED =
    "targetGroupLinkToShared";

  public static final String FROM_LINK_TO_SHARED = "fromLinkToShared";

  public static final String LIBRARY_BULK_OPERATION_DIALOG_ICON_TOOLTIP =
    "library_bulk_operation_dialog_icon_tooltip";
  ...
  public static final String MSG_SEARCH_PAGE_ICON_ALT =
    "search_results_icon_tooltip";
  public static final String MSG_SEARCH_PAGE_DESCRIPTION =
    "search_results_text";
  public static final String MSG_SEARCH_PAGE_SUB_DESCRIPTION =
    "search_results_title_desc";
  public static final String MSG_LIBRARY_NUMBER_ELEMENTS =
    "library_number_of_elements";
  public static final String BULK_OPERATION_TOOLTIP =
    "library_bulk_operation_dialog_browser_title";
  ...
  protected static final String LIBRARY_ADD_URL_TOOLTIP =
    "library_add_url_tooltip";
  protected static final String WAI_DIALOG_ADD_URL_WAI = "wai:dialog:addUrlWai";
  protected static final String LIBRARY_ADD_URL_ACTION =
    "library_add_url_action";
  private static final String WAI_DIALOG_LIBRARY_BULK_OPERATION_DIALOG =
    "wai:dialog:libraryBulkOperationDialog";
  ...
  private static final String IMAGES_ICONS_SEARCH_RESULTS_LARGE_GIF =
    "/images/icons/search_results_large.gif";
  private static final String IMAGES_ICONS_SPACE_ICON_DOC_GIF =
    "/images/icons/space-icon-doc.gif";
  ...
  public String getPageDescription() {
    if (getSearchContext() == null) {
      ...
      return (
        translate(MSG_SEARCH_PAGE_DESCRIPTION, getSearchContext().getText()) +
        "<br />" +
    ...
    if (fc != null) {
      ...
      if (session != null && session.containsKey(FROM_LINK_TO_SHARED)) {
        this.sessionIgRef = getNodeService()
          .getPrimaryParent((NodeRef) session.get(FROM_LINK_TO_SHARED))
          .getParentRef();

        // to know is we are leaving the shared space -> clean the session values

        NodeRef tmpRef = getManagementService()
          .getCurrentInterestGroup(
            (NodeRef) fc
              .getExternalContext()
              .getSessionMap()
              .get(TARGET_GROUP_LINK_TO_SHARED)
          );
        if (tmpRef != null && this.getCurrentInterstGroup() != null) {
          if (!tmpRef.equals(this.getCurrentInterstGroup().getNodeRef())) {
            ...
            fc
              .getExternalContext()
              .getSessionMap()
              .remove(TARGET_GROUP_LINK_TO_SHARED);
  ...
  public String getGenerateBackLinkText() {
    return translate(
      "share_space_helper_from_text",
      WebClientHelper.getGeneratedWaiRelativeUrl(
        new Node(sessionIgRef),
  ...
  public List<ActionWrapper> getActions() {
    ...
    if (
      type.equals(NavigableNodeType.LIBRARY) ||
      ...
      type.equals(NavigableNodeType.LIBRARY_FORUM) ||
      ...
      type.equals(NavigableNodeType.LIBRARY_TOPIC) ||
  ...
  public NavigationPreference getContentNavigationPreference() {
    NavigationPreference contentPreference = getNavigationPreferencesService()
      .getServicePreference(
        getCurrentNode().getNodeRef(),
        NavigationPreferencesService.LIBRARY_SERVICE,
    ...
    for (ColumnConfig columnConfig : columns) {
      if (columnConfig.isDynamicProperty()) {
        if (dynamicProperties == null) {
          DynamicPropertyService dynamicPropertieService =
            Services.getCircabcServiceRegistry(
              FacesContext.getCurrentInstance()
            ).getDynamicPropertieService();
          dynamicProperties = dynamicPropertieService.getDynamicProperties(
            getCurrentInterstGroup().getNodeRef()
          );
        }
        int index = Integer.valueOf(
          columnConfig.getName().replace("dynAttr", "")
        );
        String dynamicPropertylabel = getDynamicPropertylabelByIndex(
          dynamicProperties,
          index
        );
        ...
        public Object execute() throws Throwable {
          try {
            ...
            if (canNotReadChildren) {
              children = getCircabcFileFolderService()
                .list(currentNode.getNodeRef());
            } else {
              ...
              for (final FileInfo fileInfo : children) {
                ...
                if (fileInfo.isLink()) {
                  ...
                  if (ForumModel.TYPE_FORUM.equals(type) == false) {
                    final NavigableNode node =
                      ResolverHelper.createFolderRepresentation(
                        fileInfo,
                        getNodeService(),
                        getBrowseBean()
                      );
                  ...
                  final NavigableNode node =
                    ResolverHelper.createContentRepresentation(
                      fileInfo,
                      getNodeService(),
                      getBrowseBean()
                    );
