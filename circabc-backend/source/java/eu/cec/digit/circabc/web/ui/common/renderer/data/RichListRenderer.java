...
public class RichListRenderer extends BaseRenderer {
  ...
  public void encodeChildren(FacesContext context, UIComponent component)
    ...
    if (component.isRendered() == true) {
      ...
      IRichListRenderer renderer =
        (IRichListRenderer) richList.getViewRenderer();
      if (renderer == null) {
        throw new IllegalStateException(
          "IRichListRenderer must be available in UIRichList!"
        );
      }
      ...
      if (richList.isDataAvailable() == true) {
        ...
        out.write("<tr><td");
        String rowStyleClass = (String) richList
          .getAttributes()
          .get("rowStyleClass");
  ...
  public static class CircaViewRenderer implements IRichListRenderer {
    ...
    public void renderListBefore(
      ...
      out.write("<tr>");
      String headerClass = (String) richList
        .getAttributes()
      ...
      for (UIColumn column : columns) {
        if (column.isRendered() == true || column.getPrimary()) {
          ...
          out.write("<th");
          String columnClass = (String) column
            .getAttributes()
            .get("styleClass");
          outputAttribute(
            out,
            columnClass != null ? columnClass : headerClass,
            "class"
          );
    ...
    public void renderListRow(
      ...
      String altStyle = (String) richList
        .getAttributes()
        .get("altRowStyleClass");
    ...
    public void renderListAfter(
      ...
      if (!childToRender.isEmpty()) {
        ...
        String nsColumn = numColumnRender > 1
          ? "colspan=\"" + numColumnRender + "\""
          : "";
    ...
    public void renderListAfter(
      ...
      org.alfresco.web.ui.common.component.data.UIColumn[] columns
    ) throws IOException {
      throw new IllegalStateException(
        "Original Alfresco JSF client not managed"
      );
    }
