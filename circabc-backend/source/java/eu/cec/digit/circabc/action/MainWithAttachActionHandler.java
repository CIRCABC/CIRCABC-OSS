...
public class MainWithAttachActionHandler extends BaseActionHandler {
  ...
  public static final String JSP_PATH =
    "/jsp/extension/action/mailwithattach.jsp";
  ...
  public void prepareForSave(
    ...
    repoProps.put(
      MailActionExecuterWithAttach.PARAM_TO,
      actionProps.get(MailActionExecuterWithAttach.PARAM_TO)
    );
    repoProps.put(
      MailActionExecuterWithAttach.PARAM_TO_MANY,
      actionProps.get(MailActionExecuterWithAttach.PARAM_TO_MANY)
    );
    repoProps.put(
      MailActionExecuterWithAttach.PARAM_SUBJECT,
      actionProps.get(MailActionExecuterWithAttach.PARAM_SUBJECT)
    );
    repoProps.put(
      MailActionExecuterWithAttach.PARAM_TEXT,
      actionProps.get(MailActionExecuterWithAttach.PARAM_TEXT)
    );
    repoProps.put(
      MailActionExecuterWithAttach.PARAM_FROM,
      actionProps.get(MailActionExecuterWithAttach.PARAM_FROM)
    );
    repoProps.put(
      MailActionExecuterWithAttach.PARAM_TEMPLATE,
      actionProps.get(MailActionExecuterWithAttach.PARAM_TEMPLATE)
    );
    repoProps.put(
      MailActionExecuterWithAttach.PARAM_SENDDOCUMENT,
      actionProps.get(MailActionExecuterWithAttach.PARAM_SENDDOCUMENT)
    );
  }
  ...
  private String getFormattedMessage(
    ...
    final String subject = String.valueOf(
      actionProps.get(MailActionExecuterWithAttach.PARAM_SUBJECT)
    );

    // The message to indicate if the file is attached or not
    final Boolean isFileAttached = (Boolean) actionProps.get(
      MailActionExecuterWithAttach.PARAM_SENDDOCUMENT
    );
    ...
    return MessageFormat.format(
      Application.getMessage(context, msg_id),
      subject
    );
  }
}
