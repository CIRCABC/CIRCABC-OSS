...
public interface EventModel extends BaseCircabcModel {
   ...
   */
  String CIRCABC_EVENT_MODEL_1_0_URI = CIRCABC_NAMESPACE + "/model/events/1.0";
  ...
  QName ASSOC_BASE_EVANT_DATE_CONTAINER_CONTAINER = QName.createQName(
    CIRCABC_EVENT_MODEL_1_0_URI,
    "baseEvantDateContainer"
  );
  ...
  QName TYPE_EVENT = QName.createQName(CIRCABC_EVENT_MODEL_1_0_URI, "event");
  ...
  QName PROP_EVENT_URL = QName.createQName(CIRCABC_EVENT_MODEL_1_0_URI, "url");
   ...
   */
  List<String> EVENT_TIME_ZONE_CONSTRAINT_VALUES = Collections.unmodifiableList(
    Arrays.asList(
      "GMT-12",
      "GMT-11",
      "GMT-10",
  ...
  String[] EVENT_AVAILABILITY_CONSTRAINT_VALUES = { "Private", "Public" };

  String[] EVENT_AUDIENCE_CONSTRAINT_VALUES = { "Open", "Close" };

  String[] EVENT_PRIORITY_CONSTRAINT_VALUES = {
    "Low",
    "Medium",
    "High",
    "Urgent",
  ...
  String[] EVENT_TYPE_CONSTRAINT_VALUES = { "Appointment", "Task", "Other" };
  ...
  List<String> WEEK_START_DAY_CONSTRAINT_VALUES = Collections.unmodifiableList(
    Arrays.asList(
      "sunday",
      "monday",
      "tuesday",
