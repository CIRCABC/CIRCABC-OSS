...
public interface UserModel extends BaseCircabcModel {
   ...
   */
  String CIRCABC_USER_MODEL_1_0_URI = CIRCABC_NAMESPACE + "/model/user/1.0";

  /**
   * QName for extra properties [title] that belong to Circabc Users
   */
  QName PROP_TITLE = QName.createQName(CIRCABC_USER_MODEL_1_0_URI, "title");

  /**
   * QName for extra properties [phone] that belong to Circabc Users
   */
  QName PROP_PHONE = QName.createQName(CIRCABC_USER_MODEL_1_0_URI, "phone");

  /**
   * QName for extra properties [fax] that belong to Circabc Users
   */
  QName PROP_FAX = QName.createQName(CIRCABC_USER_MODEL_1_0_URI, "fax");

  /**
   * QName for extra properties [url] that belong to Circabc Users
   */
  QName PROP_URL = QName.createQName(CIRCABC_USER_MODEL_1_0_URI, "url");
   ...
   */
  QName PROP_DOMAIN = QName.createQName(CIRCABC_USER_MODEL_1_0_URI, "domain");
