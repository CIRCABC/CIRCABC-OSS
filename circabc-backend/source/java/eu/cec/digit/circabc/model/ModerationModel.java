...
public interface ModerationModel extends BaseCircabcModel {
   ...
   */
  String CIRCABC_MODERATION_MODEL_1_0_URI =
   ...
   */
  QName ASPECT_MODERATED = QName.createQName(
   ...
   */
  QName PROP_IS_MODERATED = QName.createQName(
    CIRCABC_MODERATION_MODEL_1_0_URI,
    "ismoderated"
  );
   ...
   */
  QName ASPECT_WAITING_APPROVAL = QName.createQName(
    CIRCABC_MODERATION_MODEL_1_0_URI,
    "waittingApproval"
  );
   ...
   */
  QName ASPECT_APPROVED = QName.createQName(
    CIRCABC_MODERATION_MODEL_1_0_URI,
    "approved"
  );
   ...
   */
  QName PROP_APPROVED_BY = QName.createQName(
    CIRCABC_MODERATION_MODEL_1_0_URI,
    "approvedBy"
  );
   ...
   */
  QName PROP_APPROVED_ON = QName.createQName(
    CIRCABC_MODERATION_MODEL_1_0_URI,
    "approvedOn"
  );
   ...
   */
  QName ASPECT_REJECTED = QName.createQName(
    CIRCABC_MODERATION_MODEL_1_0_URI,
    "rejected"
  );
   ...
   */
  QName PROP_REJECT_BY = QName.createQName(
    CIRCABC_MODERATION_MODEL_1_0_URI,
    "rejectedBy"
  );
   ...
   */
  QName PROP_REJECT_ON = QName.createQName(
    CIRCABC_MODERATION_MODEL_1_0_URI,
    "rejectedOn"
  );
   ...
   */
  QName PROP_REJECT_MESSAGE = QName.createQName(
    CIRCABC_MODERATION_MODEL_1_0_URI,
    "rejectMessage"
  );
   ...
   */
  QName ASPECT_ABUSE_SIGNALED = QName.createQName(
    CIRCABC_MODERATION_MODEL_1_0_URI,
    "abuseSignaled"
  );
   ...
   */
  QName PROP_ABUSE_MESSAGES = QName.createQName(
    CIRCABC_MODERATION_MODEL_1_0_URI,
    "messages"
  );
}
