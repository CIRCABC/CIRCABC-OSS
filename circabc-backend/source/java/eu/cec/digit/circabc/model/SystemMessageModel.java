...
public interface SystemMessageModel extends BaseCircabcModel {
  String CIRCABC_SYSTEMMESSAGE_MODEL_1_0_URI =
    CIRCABC_NAMESPACE + "/model/systemmessage/1.0";
  String CIRCABC_SYSTEMMESSAGE_MODEL_PREFIX = "sm";

  QName TYPE_SYSTEMMESSAGE = QName.createQName(
    CIRCABC_SYSTEMMESSAGE_MODEL_1_0_URI,
    "systemMessage"
  );

  QName PROP_IS_SYSTEMMESSAGE_ENABLED = QName.createQName(
    CIRCABC_SYSTEMMESSAGE_MODEL_1_0_URI,
    "isSytemMessageEnabled"
  );
  QName PROP_SYSTEMMESSAGE_TEXT = QName.createQName(
    CIRCABC_SYSTEMMESSAGE_MODEL_1_0_URI,
    "systemMessageText"
  );
}
