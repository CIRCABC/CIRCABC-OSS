  ...
  static {
    ...
    if (ipmService == null) {
      try {
        ...
        locator.setIpmServiceEndpointAddress(
          getEndpointAddress() + IPM_SERVICE_ADDRESS
        );
        if (logger.isDebugEnabled()) {
          logger.debug(
            "Get the IPM webservice from the end point: " +
        ...
        throw new RuntimeException(
          "Error creating authentication service: " + jre.getMessage(),
          jre
        );
      }
