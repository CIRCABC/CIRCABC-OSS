    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            if (groupIp != null) {
                ...
                GroupConfiguration body = InterestGroupJsonParser.parseGroupConfiguration(req);
                model.put("configuration", this.groupsApi.putInterestGroupConfiguration(groupIp, body));
            }
