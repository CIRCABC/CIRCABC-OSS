...
public class DocumentSearchByExpressionRequest implements java.io.Serializable {
  ...
  private static org.apache.axis.description.TypeDesc typeDesc =
    new org.apache.axis.description.TypeDesc(
      DocumentSearchByExpressionRequest.class,
      true
    );
  ...
  static {
    ...
    elemField.setXmlName(
      new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "skip")
    );
    elemField.setXmlType(
    ...
    elemField.setXmlName(
      new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "max")
    );
    elemField.setXmlType(
      new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int")
    );
   ...
   */
  public void setFulltextSearchExpression(
    java.lang.String fulltextSearchExpression
  ) {
    this.fulltextSearchExpression = fulltextSearchExpression;
  }
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    ...
    DocumentSearchByExpressionRequest other =
      (DocumentSearchByExpressionRequest) obj;
    if (obj == null) {
      return false;
    }
    if (this == obj) {
    ...
    _equals =
      ...
      ((this.fulltextSearchExpression == null &&
        ...
        (this.fulltextSearchExpression != null &&
          this.fulltextSearchExpression.equals(
              other.getFulltextSearchExpression()
            ))) &&
      ...
      ((this.additionalPartitions == null &&
          other.getAdditionalPartitions() == null) ||
        (this.additionalPartitions != null &&
          java.util.Arrays.equals(
            this.additionalPartitions,
            other.getAdditionalPartitions()
          )));
    __equalsCalc = null;
    return _equals;
  }
  ...
  public synchronized int hashCode() {
    ...
    if (getAdditionalPartitions() != null) {
      for (
        int i = 0;
        i < java.lang.reflect.Array.getLength(getAdditionalPartitions());
        i++
      ) {
