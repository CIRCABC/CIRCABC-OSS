...
public class ContentMachineTranslationPost extends CircabcDeclarativeWebScript {
     ...
     */
    static final Log logger = LogFactory.getLog(ContentMachineTranslationPost.class);
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            ...
            model.put("translationSet", this.contentApi.requestMachineTranslation(id, language, notify));
