...
public class GroupsMembersExpirationDelete extends CircabcDeclarativeWebScript {
     ...
     */
    static final Log logger = LogFactory.getLog(GroupsMembersExpirationDelete.class);
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            ...
            if (!this.currentUserPermissionCheckerService.hasAnyOfDirectoryPermission(
                ...
                throw new AccessDeniedException("Not enough rights for deleting expiration date ");
            }
