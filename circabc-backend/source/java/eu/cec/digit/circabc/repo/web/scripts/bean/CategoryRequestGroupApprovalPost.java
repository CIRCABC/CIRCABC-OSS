...
public class CategoryRequestGroupApprovalPost extends CircabcDeclarativeWebScript {

    /**
     * A logger for the class
     */
    static final Log logger = LogFactory.getLog(CategoryRequestGroupApprovalPost.class);
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            ...
            this.categoriesApi.categoriesIdGroupRequestApprovalPost(
                    categoryId, body, authenticationService.getCurrentUserName());
