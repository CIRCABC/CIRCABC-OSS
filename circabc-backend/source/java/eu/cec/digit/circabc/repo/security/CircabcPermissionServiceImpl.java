...
public class CircabcPermissionServiceImpl extends PermissionServiceImpl {
  ...
  private boolean lockedForAccess(final NodeRef nodeRef) {
    ...
    if (
      !CircabcComponent.isInitialized() ||
    ...
    if (circabcRoot == null) {
      circabcRoot = circabcServiceRegistry
    ...
    if (
      !nodeService2.hasAspect(
        circabcRoot,
        CircabcModel.ASPECT_LOCKED_FOR_ACCESS_ENABLED
      )
    ) {
      return false;
    }
   ...
   */
  public void setCircabcServiceRegistry(
