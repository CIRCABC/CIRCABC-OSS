...
public class InternalPerson implements java.io.Serializable {
  ...
  static {
    ...
    elemField.setXmlName(
      new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "room")
    );
    elemField.setXmlType(
      new javax.xml.namespace.QName(
        "http://www.w3.org/2001/XMLSchema",
   ...
   *
   * @return userName * Internal user name. This is user name is also the ECAS user name of the
   *     person
   */
   ...
   *
   * @param userName * Internal user name. This is user name is also the ECAS user name of the
   *     person
   */
