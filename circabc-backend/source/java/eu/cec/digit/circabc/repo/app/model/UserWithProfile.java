...
public class UserWithProfile extends User {
  ...
  public boolean isAdmin() {
    boolean isLibAdmin =
      this.libraryPermission.equals(LibraryPermissions.LIBADMIN.toString());
    boolean isNewsAdmin =
      this.newsgroupPermission.equals(NewsGroupPermissions.NWSADMIN.toString());
    boolean isInfAdmin =
      this.informationPermission.equals(
          InformationPermissions.INFADMIN.toString()
        );
    boolean isDirAdmin =
      this.directoryPermission.equals(DirectoryPermissions.DIRADMIN.toString());
    boolean isEventAdmin =
      this.eventPermission.equals(EventPermissions.EVEADMIN.toString());
    boolean result =
