        ...
        for (BulkImportUserData existingUser : model) {
          if (existingUser.getUser() != null) {
            if (
              tmpUserEmail != null &&
              tmpUserEmail != "" &&
              existingUser.getUser().getEmail() != null &&
              tmpUserEmail
                .toLowerCase()
  ...
  public void inviteUsers(
    ...
    for (BulkImportUserData user : model) {
      ...
      if (
        ...
        if (
          igRootProfileManagerService.getPersonProfile(
            igRef,
