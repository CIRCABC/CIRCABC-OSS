...
public class SignatoryTaskToAdd extends eu.cec.digit.circabc.repo.hrs.ws.TaskToAdd
     ...
     */
    public void setCode(eu.cec.digit.circabc.repo.hrs.ws.SignatoryTaskToAddCode code) {
        this.code = code;
    }
