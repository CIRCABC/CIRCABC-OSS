...
public class DocumentNotificationsResponse implements java.io.Serializable {
  ...
  private static org.apache.axis.description.TypeDesc typeDesc =
    new org.apache.axis.description.TypeDesc(
      DocumentNotificationsResponse.class,
      true
    );
  ...
  public void setDocumentNotification(
    int i,
    eu.cec.digit.circabc.repo.hrs.ws.DocumentNotification _value
  ) {
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    ...
    _equals =
      ...
      ((this.documentNotification == null &&
          other.getDocumentNotification() == null) ||
        (this.documentNotification != null &&
          java.util.Arrays.equals(
            this.documentNotification,
            other.getDocumentNotification()
          )));
    __equalsCalc = null;
    return _equals;
  }
  ...
  public synchronized int hashCode() {
    ...
    if (getDocumentNotification() != null) {
      for (
        int i = 0;
        i < java.lang.reflect.Array.getLength(getDocumentNotification());
        i++
      ) {
