...
public class AssignmentTask extends eu.cec.digit.circabc.repo.hrs.ws.Task
        implements java.io.Serializable {

    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
            new org.apache.axis.description.TypeDesc(AssignmentTask.class, true);
    ...
    /* The task's code */
    private eu.cec.digit.circabc.repo.hrs.ws.AssignmentTaskCode code;
    ...
    public AssignmentTask(
            ...
            eu.cec.digit.circabc.repo.hrs.ws.AssignmentTaskCode code) {
        super(
                taskId,
                workflowId,
                status,
    ...
    /**
     * Gets the code value for this AssignmentTask.
     *
     * @return code * The task's code
     */
    public eu.cec.digit.circabc.repo.hrs.ws.AssignmentTaskCode getCode() {
        return code;
    }

    /**
     * Sets the code value for this AssignmentTask.
     *
     * @param code * The task's code
     */
    public void setCode(eu.cec.digit.circabc.repo.hrs.ws.AssignmentTaskCode code) {
        this.code = code;
    }

    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AssignmentTask)) {
            return false;
        }
        AssignmentTask other = (AssignmentTask) obj;
        if (obj == null) {
            return false;
        }
        if (this == obj) {
