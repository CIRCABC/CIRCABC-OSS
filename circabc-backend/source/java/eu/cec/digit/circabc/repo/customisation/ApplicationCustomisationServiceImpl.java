...
/** @author beaurpi */
public class ApplicationCustomisationServiceImpl
  implements ApplicationCustomisationService {

  static final Log logger = LogFactory.getLog(
    ApplicationCustomisationServiceImpl.class
  );
  ...
  public NodeRef getDefaultLogoNodeRef() {
    ...
    NodeRef igLookNodeRef = nodeService.getChildByName(
      dicoRef,
      ContentModel.ASSOC_CONTAINS,
      "iglookAndFeel"
    );
    NodeRef iconNodeRef = nodeService.getChildByName(
      igLookNodeRef,
      ContentModel.ASSOC_CONTAINS,
      "icon"
    );
    NodeRef imageFolderNodeRef = nodeService.getChildByName(
      iconNodeRef,
      ContentModel.ASSOC_CONTAINS,
      "images"
    );
    NodeRef imageNodeRef = nodeService.getChildByName(
      imageFolderNodeRef,
      ContentModel.ASSOC_CONTAINS,
      "circabc_logo.gif"
    );
  ...
  public List<NodeRef> getListOfTemplates() {
    ...
    List<ChildAssociationRef> allTemplatesFolderNodeRef =
      nodeService.getChildAssocs(mailsNodeRef);

    for (ChildAssociationRef child : allTemplatesFolderNodeRef) {
      if (child.getTypeQName().equals(ContentModel.ASSOC_CONTAINS)) {
        NodeRef template = nodeService.getChildByName(
          child.getChildRef(),
          ContentModel.ASSOC_CONTAINS,
          "default.ftl"
        );
  ...
  @Override
  public void updateTemplate(File tempFile, NodeRef templateRef)
   ...
   * @param fileRef
   */
  private void updateNodeContent(File tempFile, NodeRef fileRef)
    throws CircabcRuntimeException {
    if (fileRef != null) {
      if (tempFile != null) {
  ...
  @Override
  public void updateDefaultLogoDisclaimer(File gif)
    throws CircabcRuntimeException {
  ...
  public String getContactlink() {
    NodeRef circabcRef = managementService.getCircabcNodeRef();
    return (
      nodeService.getProperty(circabcRef, CircabcModel.PROP_CONTACT_LINK) !=
        null
        ? nodeService
          .getProperty(circabcRef, CircabcModel.PROP_CONTACT_LINK)
          .toString()
        : null
    );
  }
  ...
  public NodeRef getBannerLogoRef() {
    ...
    NodeRef bannerLogoRef = nodeService.getChildByName(
      cbcRef,
      ContentModel.ASSOC_CONTAINS,
      "circabc_banner.png"
    );
  ...
  public Boolean getDisplaySearchLink() {
    ...
    if (
      nodeService.getProperty(
        cbcRef,
        CircabcModel.PROP_SEARCH_LINK_DISPLAYED
      ) !=
      null
    ) {
      result = Boolean.valueOf(
        nodeService
          .getProperty(cbcRef, CircabcModel.PROP_SEARCH_LINK_DISPLAYED)
          .toString()
      );
    }
  ...
  public Boolean getDisplayLegalLink() {
    ...
    if (
      nodeService.getProperty(cbcRef, CircabcModel.PROP_LEGAL_LINK_DISPLAYED) !=
      null
    ) {
      result = Boolean.valueOf(
        nodeService
          .getProperty(cbcRef, CircabcModel.PROP_LEGAL_LINK_DISPLAYED)
          .toString()
      );
    }
  ...
  public void setDisplayLegalLink(Boolean b) {
    ...
    if (b != null) {
      nodeService.setProperty(
        cbcRef,
        CircabcModel.PROP_LEGAL_LINK_DISPLAYED,
        b
      );
    }
  }
  ...
  public String geteLearningLink() {
    ...
    if (
      nodeService.getProperty(cbcRef, CircabcModel.PROP_ELEARNING_LINK) != null
    ) {
      result = nodeService
        .getProperty(cbcRef, CircabcModel.PROP_ELEARNING_LINK)
        .toString();
    }
  ...
  public Boolean getDisplayeLearningLink() {
    ...
    if (
      nodeService.getProperty(
        cbcRef,
        CircabcModel.PROP_ELEARNING_LINK_DISPLAYED
      ) !=
      null
    ) {
      result = Boolean.valueOf(
  ...
  public String getErrorMessageContent() {
    ...
    if (
      nodeService.getProperty(
        cbcRef,
        CircabcModel.PROP_ERROR_MESSAGE_CONTENT
      ) !=
      null
    ) {
      result = nodeService
        .getProperty(cbcRef, CircabcModel.PROP_ERROR_MESSAGE_CONTENT)
        .toString();
    }
