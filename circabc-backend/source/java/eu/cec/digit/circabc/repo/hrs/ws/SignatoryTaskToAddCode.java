...
public class SignatoryTaskToAddCode implements java.io.Serializable {
  ...
  public static final SignatoryTaskToAddCode RED = new SignatoryTaskToAddCode(
    _RED
  );
  public static final SignatoryTaskToAddCode CONTRIB =
    new SignatoryTaskToAddCode(_CONTRIB);
  public static final SignatoryTaskToAddCode VISA = new SignatoryTaskToAddCode(
    _VISA
  );
  public static final SignatoryTaskToAddCode SIGN = new SignatoryTaskToAddCode(
    _SIGN
  );
  public static final SignatoryTaskToAddCode EXP = new SignatoryTaskToAddCode(
    _EXP
  );
  ...
  public static SignatoryTaskToAddCode fromValue(java.lang.String value)
    ...
    SignatoryTaskToAddCode enumeration = (SignatoryTaskToAddCode) _table_.get(
      value
    );
    if (enumeration == null) {
