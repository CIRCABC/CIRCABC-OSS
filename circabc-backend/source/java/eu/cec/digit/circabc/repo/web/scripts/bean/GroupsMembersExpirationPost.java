...
public class GroupsMembersExpirationPost extends CircabcDeclarativeWebScript {
     ...
     */
    static final Log logger = LogFactory.getLog(GroupsMembersExpirationPost.class);
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            ...
            if (!this.currentUserPermissionCheckerService.hasAnyOfDirectoryPermission(
                ...
                throw new AccessDeniedException("Not enough rights for adding expiration date");
            }
            ...
            this.groupsApi.groupsIdMembersUserIdExpirationPost(
                    id, userId, expirationDate, profileId, alfrescoGroup);
