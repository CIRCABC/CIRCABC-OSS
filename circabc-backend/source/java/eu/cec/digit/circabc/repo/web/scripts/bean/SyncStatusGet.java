...
public class SyncStatusGet extends CircabcDeclarativeWebScript {
    ...
    try {
      if (
        ...
        throw new AccessDeniedException(
          "Only CIRCABC or Alfresco administrators can view sync status"
        );
      }

      Map<String, Object> syncStatus = syncApi.getSyncStatus();

      Map<String, Object> model = new HashMap<>(3, 1.0f);
      model.put("syncStatus", syncStatus);
      return model;
