...
public class CircabcRootProfileManagerServiceImpl
  ...
  private static final Log logger = LogFactory.getLog(
    CircabcRootProfileManagerServiceImpl.class
  );
  ...
  public Map<QName, String> getServiceRolesEnum() {
    ...
    map.put(
      PermissionModel.CIRCABC_PERMISSION,
      CircabcServices.CIRCABC.toString()
    );
  ...
  public String createAllCircaUsersGroup() {
    ...
    final String allUserGroupName = authorityService.createAuthority(
      AuthorityType.GROUP,
  ...
  public String createCircaSupportGroup() {
    ...
    final String supportGroupName = authorityService.createAuthority(
      AuthorityType.GROUP,
  ...
  public List<Profile> getProfilesRecursivly(final NodeRef nodeRef) {
    ...
    if (nodeService.hasAspect(nodeRef, CircabcModel.ASPECT_CIRCABC_ROOT)) {
      ...
      for (final ChildAssociationRef childs : nodeService.getChildAssocs(
        nodeRef
      )) {
