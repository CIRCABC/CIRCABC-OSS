 ...
 */
public abstract class ServerConfigurationServiceImpl
  implements ServerConfigurationService {

  public static final File ALFRESCO_REPO_PROPS = new File(
    "classpath:alfresco",
    "repository.properties"
  );
  public static final File ALFRESCO_CACHE_STATEGIES = new File(
    "classpath:alfresco/domain",
    "cache-strategies.properties"
  );
  public static final File ALFRESCO_TRANSACTION_PROPS = new File(
    "classpath:alfresco/domain",
    "transaction.properties"
  );
  public static final File ALFRESCO_EMAIN_CONFIGURATION = new File(
    "classpath:alfresco/emailserver",
  ...
  public static final File CIRCABC_SHARED_REPO_PROPS = new File(
    "classpath:alfresco/alfresco-global.properties"
  );
  public static final File CIRCABC_REPO_PROPS = new File(
    "classpath:alfresco/extension/config",
    "circabc-repository.properties"
  );
  ...
  public static final File CIRCABC_SETTINGS = new File(
    "classpath:",
    "alfresco-global.properties"
  );
  public static final File CIRCABC_SHARED_HIBERNATE_CONFIG = new File(
    "classpath:alfresco/extension/domain",
    "circabc-shared-hibernate-cfg.properties"
  );
  public static final File CIRCABC_QUARTZ_PROPS = new File(
    "classpath:alfresco/extension/domain",
    "quartz.properties"
  );
  public static final File CIRCABC_DB_POOL = new File(
    "classpath:alfresco/extension",
    "circabc-dbpool-context.xml"
  );
  public static final File CIRCABC_RMI = new File(
    "classpath:alfresco/extension",
    "circabc-rmi-core-services-context.xml"
  );
  public static final File CIRCABC_SHARED_PROPS = new File(
    "classpath:alfresco/extension",
    "circabc-shared.properties"
  );
  public static final File CIRCABC_FILE_SERVER_CONF = new File(
    "classpath:alfresco/extension",
    "file-servers-custom.xml"
  );
  public static final File CIRCABC_BUILD_CONF = new File(
    "classpath:alfresco/extension",
    "build-config.properties"
  );
  public static final File ECAS_PROPS = new File(
    "classpath:",
    "ecas-config.properties"
  );
  public static final File CIRCABC_VERSION_PROPS = new File(
    "classpath:alfresco/extension/messages",
    "circabc-version.properties"
  );
  ...
  public List<TriggerReport> getTriggers() throws SchedulerException {
    ...
    for (final Trigger trigger : triggers) {
      final JobDetail jobDetail = scheduler.getJobDetail(
        trigger.getJobName(),
        trigger.getJobGroup()
      );
  ...
  @SuppressWarnings("unchecked")
  private void parsePropertiesRessourceAndFill(
  ...
  @SuppressWarnings("unchecked")
  private void parseXmlRessourceAndFill(
    final Map properties,
    Resource resource
