...
public class SignatoryTaskCode implements java.io.Serializable {
  ...
  public static final SignatoryTaskCode value10 = new SignatoryTaskCode(
    _value10
  );
  public static final SignatoryTaskCode value11 = new SignatoryTaskCode(
    _value11
  );
  public static final SignatoryTaskCode value12 = new SignatoryTaskCode(
    _value12
  );
  public static final SignatoryTaskCode value13 = new SignatoryTaskCode(
    _value13
  );
  public static final SignatoryTaskCode value14 = new SignatoryTaskCode(
    _value14
  );
  public static final SignatoryTaskCode value15 = new SignatoryTaskCode(
    _value15
  );
  public static final SignatoryTaskCode value16 = new SignatoryTaskCode(
    _value16
  );
  public static final SignatoryTaskCode value17 = new SignatoryTaskCode(
    _value17
  );
  public static final SignatoryTaskCode value18 = new SignatoryTaskCode(
    _value18
  );
  public static final SignatoryTaskCode value19 = new SignatoryTaskCode(
    _value19
  );
  public static final SignatoryTaskCode value20 = new SignatoryTaskCode(
    _value20
  );
