 ...
 * ****************************************************************************
 */
package eu.cec.digit.circabc.repo.profile.event;
...
public class EventProfileManagerServiceImpl
  extends ProfileManagerServiceImpl
  implements EventProfileManagerService {

  private static final String PROFILE_PREFIX = "circabcEvent";
  ...
  private static final Log logger = LogFactory.getLog(
    EventProfileManagerServiceImpl.class
  );

  public EventProfileManagerServiceImpl() {
  ...
  public List<QName> getQNameServiceRoles() {
    ...
    list.add(PermissionModel.EVENT_PERMISSION);
    return list;
  }

  public Map<QName, String> getServiceRolesEnum() {
    final Map<QName, String> map = new HashMap<>();
    map.put(PermissionModel.EVENT_PERMISSION, CircabcServices.EVENT.toString());
    return map;
  }

  @Override
  public QName getNodeAspect() {
    return CircabcModel.ASPECT_EVENT;
  }

  @Override
  public QName getNodeRootAspect() {
    return CircabcModel.ASPECT_EVENT_ROOT;
  }
