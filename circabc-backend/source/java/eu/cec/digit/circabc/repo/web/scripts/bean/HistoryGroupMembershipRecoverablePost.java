 ...
 * @author beaurpi
 */
public class HistoryGroupMembershipRecoverablePost extends CircabcDeclarativeWebScript {
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            ...
            if (!(this.currentUserPermissionCheckerService.isAlfrescoAdmin()
                ...
                throw new AccessDeniedException("Cannot recover the membership, not enough permissions");
            }
