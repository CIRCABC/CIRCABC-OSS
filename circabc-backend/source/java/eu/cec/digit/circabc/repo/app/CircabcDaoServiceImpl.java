...
public class CircabcDaoServiceImpl {
  ...
  public void insertCategoryHeader(CategoryHeader categoryHeaderIDs) {
    sqlSessionTemplate.insert(
      "Circabc.insert_category_header",
      categoryHeaderIDs
    );
  }
  ...
  public Map<String, Long> getAllAlfrescoLocale() {
    final List<KeyValue> selectList = (List<
        KeyValue
      >) sqlSessionTemplate.selectList("Circabc.select_alf_locale");
  ...
  public eu.cec.digit.circabc.repo.app.model.Profile selectProfileByInterestGroupIDProfileName(
    ...
    return (eu.cec.digit.circabc.repo.app.model.Profile) sqlSessionTemplate.selectOne(
  ...
  public void deleteCategory(long categoryID) throws SQLException {
    @SuppressWarnings("unchecked")
    final List<Long> igIDs = (List<Long>) sqlSessionTemplate.selectList(
  ...
  public List<InterestGroupResult> selectIgByCategoryIDUserName(
    ...
    if (userName.equals("guest")) {
      result = (List<InterestGroupResult>) sqlSessionTemplate.selectList(
  ...
  public Boolean isIgToBeDeleted(long interestGroupID) {
    Map<String, Object> params = Collections.singletonMap(
      "ID",
      interestGroupID
    );

    Boolean toBeDeleted = (Boolean) sqlSessionTemplate.selectOne(
      "Circabc.select_ig_to_be_deleted",
      params
    );

    return Boolean.TRUE.equals(toBeDeleted);
  }
  ...
  public List<ExportedProfileItem> selectExpProfilesByCategoryIDInterestGroupID(
    ...
    params.put("igID", interestGroupID);
    @SuppressWarnings("unchecked")
    List<ExportedProfileItem> result = (List<
        ExportedProfileItem
  ...
  public List<String> selectImporetedAlfGroups(long interestGroupID) {
    ...
    params.put("igID", interestGroupID);
    @SuppressWarnings("unchecked")
    List<String> result = (List<String>) sqlSessionTemplate.selectList(
  ...
  public Set<String> selectAlfrescoGroupNotInIneterstGroup(
    long categoryID,
    long interestGroupID
  ) {
    HashMap<String, Object> params = new HashMap<>(2);
  ...
  public List<UserIGMembership> selectInterestGroups(String userName) {
    ...
    params.put("userName", userName);
    @SuppressWarnings("unchecked")
    List<UserIGMembership> result = (List<
        UserIGMembership
      >) sqlSessionTemplate.selectList(
  ...
  public List<String> selectAllUserNodeRef() {
    @SuppressWarnings("unchecked")
    List<String> result = (List<String>) sqlSessionTemplate.selectList(
      "Circabc.select_all_user_node_ref"
    );
    return result;
  }
  ...
  public List<HeaderCategory> selectHeadersCategories() {
    @SuppressWarnings("unchecked")
    List<HeaderCategory> result = (List<
        HeaderCategory
      >) sqlSessionTemplate.selectList("Circabc.select_headers_categories");
    return result;
  }
  ...
  public List<ProfileWithUsersCount> selectProfiles(
    ...
    @SuppressWarnings("unchecked")
    List<ProfileWithUsersCount> result = (List<
        ProfileWithUsersCount
      >) sqlSessionTemplate.selectList(
  ...
  public List<
    eu.cec.digit.circabc.repo.app.model.Profile
  > selectProfileTitleAlfGroupByIgId(
    long igID,
    long localeID,
    String searchQuery
  ) {
    ...
    params.put(
      ...
      searchQuery != null && searchQuery.isEmpty()
        ...
        : searchQuery == null
          ? null
          : "%" + sanitizeSQL(searchQuery.toLowerCase()) + "%"
    );

    @SuppressWarnings("unchecked")
    List<eu.cec.digit.circabc.repo.app.model.Profile> result = (List<
        eu.cec.digit.circabc.repo.app.model.Profile
      >) sqlSessionTemplate.selectList(
  ...
  public List<UserWithProfile> selectUsersProfilesFiltered(
    ...
    if (firstName.isEmpty()) {
      ...
      params.put("firstName", "%" + sanitizeSQL(firstName.toLowerCase()) + "%");
    }
    ...
    if (lastName.isEmpty()) {
      ...
      params.put("lastName", "%" + sanitizeSQL(words[0].toLowerCase()) + "%");
    } else {
      params.put("lastName", "%" + sanitizeSQL(lastName.toLowerCase()) + "%");
    }
  ...
  public Set<String> getUserIds(long igDBId) {
    return new HashSet(
      (List<String>) sqlSessionTemplate.selectList(
        "Circabc.users_in_ig",
        igDBId
      )
    );
  ...
  public List<Header> selectHeaders() throws SQLException {
    ...
    result = (List<Header>) sqlSessionTemplate.selectList(
      "Circabc.select_headers"
    );
  ...
  public List<Category> selectCategoriesByHeaderLocale(
    ...
    result = (List<Category>) sqlSessionTemplate.selectList(
  ...
  public List<TranslationEntry> selectProfileTitles(long profileID)
    ...
    result = (List<TranslationEntry>) sqlSessionTemplate.selectList(
  ...
  public List<ProfileUser> getUserProfileInGroup(
    ...
    return (List<ProfileUser>) sqlSessionTemplate.selectList(
      "select_user_profile_in_group",
      props
    );
  }
  ...
  public Map<String, String> getGroupTitleTranslations(long igID) {
    ...
    List<KeyValueString> titles = (List<
        KeyValueString
      >) sqlSessionTemplate.selectList("select_group_titles", props);
  ...
  public Map<String, String> getProfileTitleTranslations(long profileID) {
    ...
    List<KeyValueString> titles = (List<
        KeyValueString
      >) sqlSessionTemplate.selectList("select_profile_titles", props);
  ...
  public Map<String, String> getCategoryTitleTranslations(long categId) {
    ...
    List<KeyValueString> titles = (List<
        KeyValueString
      >) sqlSessionTemplate.selectList("select_category_titles", props);
  ...
  public List<InterestGroupResult> getAllInterestGroups() {
    return (List<InterestGroupResult>) sqlSessionTemplate.selectList(
      "select_all_groups"
    );
  }
