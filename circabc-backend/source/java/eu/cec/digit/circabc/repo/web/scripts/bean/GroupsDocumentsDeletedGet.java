    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            if (!this.currentUserPermissionCheckerService.isGroupAdmin(id)) {
                throw new AccessDeniedException("User is not Group admin to get the deleted documents");
            }
            PagedArchiveNodes result =
                    this.archiveApi.groupsIdDocumentsDeletedGet(id, limit, page, order);
