...
public class SyncAdminsPost extends CircabcDeclarativeWebScript {
    ...
    try {
      if (
        ...
        throw new AccessDeniedException(
          "Only CIRCABC or Alfresco administrators can trigger an admins sync"
        );
      }
      ...
      model.put("message", "Admins sync completed successfully");
