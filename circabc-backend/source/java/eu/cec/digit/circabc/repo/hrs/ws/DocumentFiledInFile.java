...
public class DocumentFiledInFile implements java.io.Serializable {
  ...
  static {
    ...
    elemField.setXmlName(
      new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "path")
    );
    elemField.setXmlType(
      new javax.xml.namespace.QName(
        "http://www.w3.org/2001/XMLSchema",
    ...
    _equals =
      ...
      ((this.chefDeFile == null && other.getChefDeFile() == null) ||
        (this.chefDeFile != null &&
          this.chefDeFile.equals(other.getChefDeFile()))) &&
      ...
      ((this.specificCode == null && other.getSpecificCode() == null) ||
        (this.specificCode != null &&
          this.specificCode.equals(other.getSpecificCode()))) &&
      ((this.status == null && other.getStatus() == null) ||
        (this.status != null && this.status.equals(other.getStatus()))) &&
      ((this.multilingualNames == null &&
          other.getMultilingualNames() == null) ||
        (this.multilingualNames != null &&
          java.util.Arrays.equals(
            this.multilingualNames,
            other.getMultilingualNames()
          ))) &&
  ...
  public synchronized int hashCode() {
    ...
    if (getMultilingualNames() != null) {
      for (
        int i = 0;
        i < java.lang.reflect.Array.getLength(getMultilingualNames());
        i++
      ) {
