    ...
    if (args.size() > 0) {
      ...
      if (arg0 instanceof BeanModel) {
        ...
        if (arg0BeanModel.getWrappedObject() instanceof TemplateNode) {
          final NodeRef user =
            ((TemplateNode) arg0BeanModel.getWrappedObject()).getNodeRef();
