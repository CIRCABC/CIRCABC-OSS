...
public class CurrentExternalEntityRetrievalOptions
  implements java.io.Serializable {

  // Type metadata
  private static org.apache.axis.description.TypeDesc typeDesc =
    new org.apache.axis.description.TypeDesc(
      CurrentExternalEntityRetrievalOptions.class,
      true
    );
   ...
   *     internet, phone, fax, postal code, post office code, title, VAT, language.
   */
  public void setIncludeExtendedMetadata(
    java.lang.Boolean includeExtendedMetadata
  ) {
    this.includeExtendedMetadata = includeExtendedMetadata;
  }
   ...
   *     date, last change date, creator, creator's DG, last modificator.
   */
  public void setIncludeCreateUpdateMetadata(
    java.lang.Boolean includeCreateUpdateMetadata
  ) {
    this.includeCreateUpdateMetadata = includeCreateUpdateMetadata;
  }
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    ...
    CurrentExternalEntityRetrievalOptions other =
      (CurrentExternalEntityRetrievalOptions) obj;
    if (obj == null) {
      return false;
    }
    if (this == obj) {
    ...
    _equals =
      ...
      ((this.includeExtendedMetadata == null &&
          other.getIncludeExtendedMetadata() == null) ||
        (this.includeExtendedMetadata != null &&
          this.includeExtendedMetadata.equals(
              other.getIncludeExtendedMetadata()
            ))) &&
