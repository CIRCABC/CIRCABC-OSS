 ...
 */
public class NavigationPreferenceImpl
  implements Serializable, NavigationPreference {
   ...
   */
  /*package*/
  final void setInitialSortPostsDescendingStr(
    String initialSortPostsDescending
  ) {
    if (
      initialSortPostsDescending == null ||
      initialSortPostsDescending.length() < 1
    ) {
      this.initialSortPostsDescending = DEFAULT_SORT_DESC;
    } else {
      this.initialSortPostsDescending = Boolean.parseBoolean(
  ...
  public int hashCode() {
    ...
    result =
      PRIME * result +
      ((displayActionColumn == null) ? 0 : displayActionColumn.hashCode());
    result =
      PRIME * result +
      ((initialSortColumn == null) ? 0 : initialSortColumn.hashCode());
    result =
      PRIME * result +
      ((initialSortDescending == null) ? 0 : initialSortDescending.hashCode());
    result =
      PRIME * result +
      ((initialSortPostsDescending == null)
          ? 0
          : initialSortPostsDescending.hashCode());
    result =
      PRIME * result + ((linkTarget == null) ? 0 : linkTarget.hashCode());
    result = PRIME * result + ((listSize == null) ? 0 : listSize.hashCode());
    result = PRIME * result + ((service == null) ? 0 : service.hashCode());
    result = PRIME * result + ((viewMode == null) ? 0 : viewMode.hashCode());
    result =
      PRIME * result + ((previewAction == null) ? 0 : previewAction.hashCode());
    result =
      PRIME * result +
      ((renderPropertyName == null) ? 0 : renderPropertyName.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (initialSortPostsDescending == null) {
      ...
      !initialSortPostsDescending.equals(other.initialSortPostsDescending)
    ) {
      return false;
    }
    if (linkTarget == null) {
