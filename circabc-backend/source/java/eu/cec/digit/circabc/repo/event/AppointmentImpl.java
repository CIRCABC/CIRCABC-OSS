...
public class AppointmentImpl implements Appointment {
  ...
  public void init(Map<QName, Serializable> properties) {
    ...
    this.setAudienceStatus(
        AudienceStatus.valueOf(properties.get(PROP_EVENT_AUDIENCE).toString())
      );
    ...
    this.setStartDate(
        AppointmentUtils.convertDateToDateValue(
          (Date) properties.get(PROP_EVENT_START_DATE)
        )
      );
    ...
    this.setStartTime(
        new LocalTime(properties.get(PROP_EVENT_START_TIME).toString())
      );
    this.setEndTime(
        new LocalTime(properties.get(PROP_EVENT_END_TIME).toString())
      );
    ...
    this.setInvitationMessage(
        properties.get(PROP_EVENT_INVITATION_MESSAGE).toString()
      );
    ...
    this.setOccurenceRate(
        new OccurenceRate(properties.get(PROP_EVENT_OCCURENCE_RATE).toString())
      );
    ...
    if (this.getAudienceStatus() == AudienceStatus.Closed) {
      String invitedUsersList = properties
        .get(PROP_EVENT_INVITED_USERS)
        .toString();
  ...
  public PropertyMap getProperties() {
    ...
    if (this.getStartDate() != null) {
      Date javaDate = AppointmentUtils.convertDateValueToDate(
        this.getStartDate()
      );
