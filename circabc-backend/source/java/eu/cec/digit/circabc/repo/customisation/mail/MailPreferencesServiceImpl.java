...
public class MailPreferencesServiceImpl implements MailPreferencesService {
  ...
  private static final Log logger = LogFactory.getLog(
    MailPreferencesServiceImpl.class
  );
  ...
  public List<MailWrapper> getMailTemplates(
    ...
    try {
      ...
      final Map<NodeRef, MailWrapper> mailMap = new HashMap<>(
        templatesNodes.size()
      );
      MailWrapper wrapper;
  ...
  public NodeRef getDisclamerLogo(final NodeRef ref) {
    ...
    if (logger.isDebugEnabled()) {
      logger.debug(
        "Trying to retreive the default mail disclamer logo for the node " +
        ref +
        "."
      );
    }
  ...
  public NodeRef getHeaderLogo(final NodeRef ref) {
    ...
    NodeRef headerLogoRef = nodeService.getChildByName(
      logoRef,
      ContentModel.ASSOC_CONTAINS,
      "header-mail.jpg"
    );
  ...
  public NodeRef getHeaderBackground(NodeRef circabcRootRef) {
    ...
    NodeRef headerBackgroundRef = nodeService.getChildByName(
      logoRef,
      ContentModel.ASSOC_CONTAINS,
  ...
  public NodeRef getHeaderEULogo(NodeRef circabcRootRef) {
    ...
    NodeRef headerEULogogroundRef = nodeService.getChildByName(
      logoRef,
      ContentModel.ASSOC_CONTAINS,
