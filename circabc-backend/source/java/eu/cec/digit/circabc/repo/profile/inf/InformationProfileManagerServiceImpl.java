 ...
 * ****************************************************************************
 */
package eu.cec.digit.circabc.repo.profile.inf;
...
public class InformationProfileManagerServiceImpl
  extends ProfileManagerServiceImpl
  implements InformationProfileManagerService {

  private static final String PROFILE_PREFIX = "circabcInformation";
  ...
  private static final Log logger = LogFactory.getLog(
    InformationProfileManagerServiceImpl.class
  );

  public InformationProfileManagerServiceImpl() {
  ...
  public void renameProfile(
    ...
    final ProfileManagerService profileManagerService =
      profileManagerServiceFactory.getProfileManagerService(parentNodeRef);
    profileManagerService.renameProfile(
      parentNodeRef,
      oldProfileName,
      newProfileName
    );
  ...
  public void uninvitePerson(
    ...
    final ProfileManagerService profileManagerService =
      profileManagerServiceFactory.getProfileManagerService(parentNodeRef);
    profileManagerService.uninvitePerson(
      parentNodeRef,
      userID,
      cleanPermission
    );
  ...
  public List<QName> getQNameServiceRoles() {
    ...
    list.add(PermissionModel.INFORMATION_PERMISSION);
    return list;
  }
  ...
  public Map<QName, String> getServiceRolesEnum() {
    ...
    map.put(
      PermissionModel.INFORMATION_PERMISSION,
  ...
  public QName getNodeAspect() {
    return CircabcModel.ASPECT_INFORMATION;
  }

  @Override
  public QName getNodeRootAspect() {
    return CircabcModel.ASPECT_INFORMATION_ROOT;
  }
