...
public class InformationProfileManagerServiceImpl extends ProfileManagerServiceImpl
     ...
     */
    private static final Log logger = LogFactory.getLog(InformationProfileManagerServiceImpl.class);
    ...
    public Map<QName, String> getServiceRolesEnum() {
        ...
        map.put(PermissionModel.INFORMATION_PERMISSION, CircabcServices.INFORMATION.toString());
        return map;
    }
