...
public class HelpSubcategoryArticlesPost extends CircabcDeclarativeWebScript {

  static final Log logger = LogFactory.getLog(
    HelpSubcategoryArticlesPost.class
  );
  ...
  protected Map<String, Object> executeImpl(
    ...
    try {
      ...
      model.put("article", helpApi.createSubcategoryArticle(id, body));
