...
public class LibraryProfileManagerServiceImpl extends ProfileManagerServiceImpl
     ...
     */
    private static final Log logger = LogFactory.getLog(LibraryProfileManagerServiceImpl.class);
    ...
    public Map<QName, String> getServiceRolesEnum() {
        ...
        map.put(PermissionModel.LIBRARY_PERMISSION, CircabcServices.LIBRARY.toString());
        return map;
    }
