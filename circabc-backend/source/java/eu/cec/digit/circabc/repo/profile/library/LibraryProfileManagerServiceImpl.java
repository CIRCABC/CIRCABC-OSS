 ...
 * ****************************************************************************
 */
package eu.cec.digit.circabc.repo.profile.library;
...
public class LibraryProfileManagerServiceImpl
  extends ProfileManagerServiceImpl
  implements LibraryProfileManagerService {

  private static final String PROFILE_PREFIX = "circaLibrary";
  ...
  private static final Log logger = LogFactory.getLog(
    LibraryProfileManagerServiceImpl.class
  );

  public LibraryProfileManagerServiceImpl() {
  ...
  public List<QName> getQNameServiceRoles() {
    ...
    list.add(PermissionModel.LIBRARY_PERMISSION);
    return list;
  }
  ...
  public Map<QName, String> getServiceRolesEnum() {
    ...
    map.put(
      PermissionModel.LIBRARY_PERMISSION,
  ...
  public QName getNodeAspect() {
    return CircabcModel.ASPECT_LIBRARY;
  }

  @Override
  public QName getNodeRootAspect() {
    return CircabcModel.ASPECT_LIBRARY_ROOT;
  }
