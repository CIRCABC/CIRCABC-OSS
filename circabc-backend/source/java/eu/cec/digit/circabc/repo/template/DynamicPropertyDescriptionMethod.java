...
public class DynamicPropertyDescriptionMethod
  ...
  public Object exec(List args) throws TemplateModelException {
    ...
    if (args.size() == 1) {
      ...
      if (arg0.getWrappedObject() instanceof NodeRef) {
        ...
        final TemplateNode templateNode =
          (TemplateNode) arg0.getWrappedObject();
  ...
  public void setDynamicPropertiesService(
    DynamicPropertyService dynamicPropertiesService
  ) {
