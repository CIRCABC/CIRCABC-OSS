 ...
 * @author schwerr
 */
public class CacheProviderServerConfigurationServiceImpl
  extends ServerConfigurationServiceImpl
  implements AfterReturningAdvice {

  static final Log logger = LogFactory.getLog(
    CacheProviderServerConfigurationServiceImpl.class
  );
  ...
  public List<CacheReport> getCaches() throws SchedulerException {
    ...
    for (SimpleCache<Serializable, Object> cache : caches) {
      cacheReports.add(
        new CacheReportImpl(cache, cacheProperties, hazelcastInstanceFactory)
      );
    }
