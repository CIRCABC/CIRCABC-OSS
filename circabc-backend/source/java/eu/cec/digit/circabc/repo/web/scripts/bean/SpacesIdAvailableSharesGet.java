...
public class SpacesIdAvailableSharesGet extends DeclarativeWebScript {
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            ...
            if (!this.currentUserPermissionCheckerService.hasAlfrescoReadPermission(spaceId)) {
                throw new AccessDeniedException("Cannot read the shared spaces, not enough permissions");
            }

            MLPropertyInterceptor.setMLAware(false);

            List<ShareSpaceItem> shares = this.spacesApi.getAvailableSharedSpaces(spaceId);
