...
public class SecurityClassification implements java.io.Serializable {
  ...
  public static final SecurityClassification NORMAL =
    new SecurityClassification(_NORMAL);
  public static final SecurityClassification LIMITED =
    new SecurityClassification(_LIMITED);
  ...
  public static SecurityClassification fromValue(java.lang.String value)
    ...
    SecurityClassification enumeration = (SecurityClassification) _table_.get(
      value
    );
    if (enumeration == null) {
