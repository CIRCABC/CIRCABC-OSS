 ...
 * @author beaurpi
 */
public class HelpSubcategoryPut extends CircabcDeclarativeWebScript {

  /** A logger for the class */
  static final Log logger = LogFactory.getLog(HelpSubcategoryPut.class);
    ...
    try {
      if (
        ...
        throw new AccessDeniedException(
          "Cannot update help subcategory, not enough permission"
        );
      }
      ...
      HelpSubcategory subcategory = HelpJsonParser.parseSubcategory(req);
      model.put("subcategory", helpApi.updateHelpSubcategory(id, subcategory));
