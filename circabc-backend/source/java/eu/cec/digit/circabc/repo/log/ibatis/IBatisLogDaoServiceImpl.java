...
public class IBatisLogDaoServiceImpl implements LogDaoService {
  ...
  public List<LogActivityDAO> selectLogActivities() {
    return (List<LogActivityDAO>) sqlSessionTemplate.selectList(
      "CircabcLog.select_log_activity"
    );
  }
  ...
  public List<LogSearchResultDAO> search(
    ...
    return (List<LogSearchResultDAO>) sqlSessionTemplate.selectList(
  ...
  public List<LogCountResultDAO> getNumberOfActionsYesterdayPerHour() {
    return (List<LogCountResultDAO>) sqlSessionTemplate.selectList(
  ...
  public List<ActivityCountDAO> getListOfActivityCountForInterestGroup(
    ...
    return (List<ActivityCountDAO>) sqlSessionTemplate.selectList(
  ...
  @Override
  public Date getLastUpdateDateOnInterestGroupForStatistics(long igID) {
    return (Date) sqlSessionTemplate.selectOne(
      "CircabcLog.select_last_update_date_ig_statistics",
      igID
    );
  }
  ...
  public List<UserActionLogDAO> getRecentUserDownloads(String userId, int i) {
    ...
    return (List<UserActionLogDAO>) sqlSessionTemplate.selectList(
  ...
  public List<Long> getUserDashboardActivityIds() {
    return (List<Long>) sqlSessionTemplate.selectList(
  ...
  public List<LogRestDAO> getRowsToProcess() {
    return (List<LogRestDAO>) sqlSessionTemplate.selectList(
      "CircabcLog.select_rest_log"
    );
  }
