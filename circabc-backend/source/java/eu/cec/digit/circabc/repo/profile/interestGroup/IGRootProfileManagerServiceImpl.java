...
public class IGRootProfileManagerServiceImpl
  ...
  private static final Log logger = LogFactory.getLog(
    IGRootProfileManagerServiceImpl.class
  );
  ...
  public Map<QName, String> getServiceRolesEnum() {
    ...
    map.put(
      PermissionModel.DIRECTORY_PERMISSION,
  ...
  public void updateProfileMap(
    ...
    for (final ChildAssociationRef serviceAssoc : assocs) {
      ...
      serviceProfileManager = getProfileManagerServiceFactory()
        .getProfileManagerService(serviceRef);
      if (serviceProfileManager != null) {
        // update permissions on ig service top node
        serviceProfileManager.updateProfile(
          serviceRef,
          profileName,
          servicesPermissions,
          false
  ...
  public Profile updateProfile(
    ...
    final Profile profile = super.updateProfile(
      nodeRef,
      profileName,
      servicesPermissions,
      updateProfileMap
