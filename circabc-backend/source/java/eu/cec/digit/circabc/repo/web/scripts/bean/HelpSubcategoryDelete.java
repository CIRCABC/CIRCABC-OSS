 ...
 * @author beaurpi
 */
public class HelpSubcategoryDelete extends CircabcDeclarativeWebScript {

  /** A logger for the class */
  static final Log logger = LogFactory.getLog(HelpSubcategoryDelete.class);
    ...
    try {
      if (
        ...
        throw new AccessDeniedException(
          "Cannot delete help subcategory, not enough permission"
        );
      }
      ...
      helpApi.deleteHelpSubcategory(id);
      ...
      status.setRedirect(true);
      if (logger.isErrorEnabled()) {
        logger.error("Cannot delete subcategory: " + e.getMsgId(), e);
      }
      return null;
    } catch (Exception e) {
