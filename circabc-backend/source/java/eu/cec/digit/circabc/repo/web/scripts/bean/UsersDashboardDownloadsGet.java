    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            ...
            if (!(this.authenticationService.getCurrentUserName().equals(userId)
                ...
                throw new AccessDeniedException("Cannot get user download dashboard of somebody else");
            }

            List<UserActionLog> result = this.dashboardApi.usersUserIdDashboardDownloadsGet(userId);
