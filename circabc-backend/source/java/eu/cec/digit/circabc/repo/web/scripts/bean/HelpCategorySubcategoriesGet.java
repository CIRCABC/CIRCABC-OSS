 ...
 * @author beaurpi
 */
public class HelpCategorySubcategoriesGet extends DeclarativeWebScript {

  /** A logger for the class */
  static final Log logger = LogFactory.getLog(
    HelpCategorySubcategoriesGet.class
  );
  ...
  protected Map<String, Object> executeImpl(
    ...
    try {
      ...
      model.put("subcategories", helpApi.getCategorySubcategories(id));
    } catch (Exception e) {
