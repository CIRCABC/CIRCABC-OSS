...
public class WorkflowServiceBindingStub
  ...
  public WorkflowServiceBindingStub(
  ...
  public WorkflowServiceBindingStub(javax.xml.rpc.Service service)
    ...
    qName = new javax.xml.namespace.QName(
      "http://ec.europa.eu/sg/hrs/types",
      ">AddSignatoryTasksRequest>tasks"
    );
    cachedSerQNames.add(qName);
  ...
  private static void _initOperationDesc1() {
    ...
    oper.setReturnClass(
      eu.cec.digit.circabc.repo.hrs.ws.SignatoryWorkflow.class
    );
    oper.setReturnQName(
      new javax.xml.namespace.QName(
        "http://ec.europa.eu/sg/hrs/types",
    ...
    oper.setReturnClass(
      eu.cec.digit.circabc.repo.hrs.ws.AssignmentWorkflow.class
    );
    oper.setReturnQName(
      new javax.xml.namespace.QName(
        "http://ec.europa.eu/sg/hrs/types",
    ...
    try {
      ...
      if (_resp instanceof java.rmi.RemoteException) {
        ...
        try {
          ...
          return (eu.cec.digit.circabc.repo.hrs.ws.SignatoryWorkflow) org.apache.axis.utils.JavaUtils.convert(
            _resp,
            eu.cec.digit.circabc.repo.hrs.ws.SignatoryWorkflow.class
          );
        }
    ...
    try {
      ...
      if (_resp instanceof java.rmi.RemoteException) {
        ...
        try {
          ...
          return (eu.cec.digit.circabc.repo.hrs.ws.AssignmentWorkflow) org.apache.axis.utils.JavaUtils.convert(
            _resp,
            eu.cec.digit.circabc.repo.hrs.ws.AssignmentWorkflow.class
          );
        }
