...
public class DocumentUpdateRequestUpdateItems implements java.io.Serializable {
  ...
  private static org.apache.axis.description.TypeDesc typeDesc =
    new org.apache.axis.description.TypeDesc(
      DocumentUpdateRequestUpdateItems.class,
      true
    );
  ...
  static {
    ...
    elemField.setXmlName(
      new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs/types", "add")
    );
    elemField.setXmlType(
      new javax.xml.namespace.QName(
        "http://ec.europa.eu/sg/hrs/types",
   ...
   *                                 </ul> */
  private eu.cec.digit.circabc.repo.hrs.ws.DocumentUpdateRequestUpdateItemsUpdateDetails[] updateDetails;
  ...
  public DocumentUpdateRequestUpdateItems(
    ...
    eu.cec.digit.circabc.repo.hrs.ws.DocumentUpdateRequestUpdateItemsUpdateDetails[] updateDetails
  ) {
    this.remove = remove;
    this.add = add;
   ...
   *     </ul>
   */
  public eu.cec.digit.circabc.repo.hrs.ws.DocumentUpdateRequestUpdateItemsUpdateDetails[] getUpdateDetails() {
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    ...
    DocumentUpdateRequestUpdateItems other =
      (DocumentUpdateRequestUpdateItems) obj;
    if (obj == null) {
      return false;
    }
    if (this == obj) {
  ...
  public synchronized int hashCode() {
    ...
    if (getUpdateDetails() != null) {
      for (
        int i = 0;
        i < java.lang.reflect.Array.getLength(getUpdateDetails());
        i++
      ) {
