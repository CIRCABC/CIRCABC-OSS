...
public class SyncCategoryPost extends CircabcDeclarativeWebScript {
    ...
    try {
      if (
        ...
        throw new AccessDeniedException(
          "Only CIRCABC or Alfresco administrators can trigger a category sync"
        );
      }
      ...
      if (id == null || id.isEmpty()) {
        ...
        status.setMessage("Category ID is required");
        status.setRedirect(true);
        return null;
      }

      long start = System.currentTimeMillis();
      syncApi.syncCategory(id);
      long duration = System.currentTimeMillis() - start;

      Map<String, Object> model = new HashMap<>(3, 1.0f);
      model.put("message", "Category sync completed successfully");
