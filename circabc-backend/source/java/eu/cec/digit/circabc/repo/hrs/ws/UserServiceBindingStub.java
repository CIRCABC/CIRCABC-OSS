...
public class UserServiceBindingStub
  extends org.apache.axis.client.Stub
  implements eu.cec.digit.circabc.repo.hrs.ws.UserService_PortType {
  ...
  public UserServiceBindingStub() throws org.apache.axis.AxisFault {
    this(null);
  }

  public UserServiceBindingStub(
  ...
  public UserServiceBindingStub(javax.xml.rpc.Service service)
    throws org.apache.axis.AxisFault {
    if (service == null) {
    ...
    cachedSerQNames.add(qName);
    cls = eu.cec.digit.circabc.repo.hrs.ws.UserProfile.class;
    cachedSerClasses.add(cls);
  ...
  private static void _initOperationDesc1() {
    ...
    oper.setReturnClass(eu.cec.digit.circabc.repo.hrs.ws.UserProfile.class);
    oper.setReturnQName(
      new javax.xml.namespace.QName(
        "http://ec.europa.eu/sg/hrs/types",
        "profile"
  ...
  public eu.cec.digit.circabc.repo.hrs.ws.UserProfile getUserProfile(
    ...
    try {
      ...
      if (_resp instanceof java.rmi.RemoteException) {
        ...
        try {
          return (eu.cec.digit.circabc.repo.hrs.ws.UserProfile) _resp;
        } catch (java.lang.Exception _exception) {
          return (eu.cec.digit.circabc.repo.hrs.ws.UserProfile) org.apache.axis.utils.JavaUtils.convert(
            _resp,
            eu.cec.digit.circabc.repo.hrs.ws.UserProfile.class
          );
        }
      }
