...
public class SurveyProfileManagerServiceImpl extends ProfileManagerServiceImpl
     ...
     */
    private static final Log logger = LogFactory.getLog(SurveyProfileManagerServiceImpl.class);
    ...
    public Map<QName, String> getServiceRolesEnum() {
        ...
        map.put(PermissionModel.SURVEY_PERMISSION, CircabcServices.SURVEY.toString());
        return map;
    }
