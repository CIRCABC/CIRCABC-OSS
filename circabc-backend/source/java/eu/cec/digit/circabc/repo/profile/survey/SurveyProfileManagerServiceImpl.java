 ...
 * ****************************************************************************
 */
package eu.cec.digit.circabc.repo.profile.survey;
...
public class SurveyProfileManagerServiceImpl
  extends ProfileManagerServiceImpl
  implements SurveyProfileManagerService {

  private static final String PROFILE_PREFIX = "circaSurvey";
  ...
  private static final Log logger = LogFactory.getLog(
    SurveyProfileManagerServiceImpl.class
  );

  public SurveyProfileManagerServiceImpl() {
    services.add(CircabcServices.SURVEY.toString());
  }
  ...
  public List<QName> getQNameServiceRoles() {
    ...
    list.add(PermissionModel.SURVEY_PERMISSION);
    return list;
  }
  ...
  public Map<QName, String> getServiceRolesEnum() {
    ...
    map.put(
      PermissionModel.SURVEY_PERMISSION,
  ...
  public QName getNodeAspect() {
    return CircabcModel.ASPECT_SURVEY;
  }

  @Override
  public QName getNodeRootAspect() {
    return CircabcModel.ASPECT_SURVEY_ROOT;
  }
