...
public class UserWebServiceLocator extends org.apache.axis.client.Service
    ...
    private java.lang.String UserService_address =
            "http://dighbust.cc.cec.eu.int:11031/hermes/Proxy/1.14/UserWebServicePS";
    ...
    public UserWebServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
    ...
    public eu.cec.digit.circabc.repo.hrs.ws.UserService_PortType getUserService(
        ...
        try {
            eu.cec.digit.circabc.repo.hrs.ws.UserServiceBindingStub _stub =
                    new eu.cec.digit.circabc.repo.hrs.ws.UserServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface)
            throws javax.xml.rpc.ServiceException {
        try {
            if (eu.cec.digit.circabc.repo.hrs.ws.UserService_PortType.class.isAssignableFrom(
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs", "UserWebService");
    }

    public java.util.Iterator getPorts() {
        if (ports == null) {
            ports = new java.util.HashSet();
            ports.add(new javax.xml.namespace.QName("http://ec.europa.eu/sg/hrs", "UserService"));
        }
