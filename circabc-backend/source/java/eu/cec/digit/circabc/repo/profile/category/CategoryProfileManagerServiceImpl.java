...
public class CategoryProfileManagerServiceImpl
  ...
  private static Log logger = LogFactory.getLog(
    CategoryProfileManagerServiceImpl.class
  );
  ...
  public Map<QName, String> getServiceRolesEnum() {
    ...
    map.put(
      PermissionModel.CATEGORY_PERMISSION,
  ...
  public Profile updateProfile(
    ...
    Profile profile = super.updateProfile(
      nodeRef,
      profileName,
      servicesPermissions,
      updateProfileMap
    ...
    if (nodeService.hasAspect(nodeRef, CircabcModel.ASPECT_CATEGORY)) {
      ...
      for (final ChildAssociationRef childs : nodeService.getChildAssocs(
        ...
        if (nodeService.hasAspect(igNodeRef, CircabcModel.ASPECT_IGROOT)) {
          profiles.addAll(
            iGRootProfileManagerService.getProfilesRecursivly(igNodeRef)
          );
        }
      }
