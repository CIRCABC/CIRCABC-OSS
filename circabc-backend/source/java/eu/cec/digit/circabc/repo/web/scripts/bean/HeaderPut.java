...
public class HeaderPut extends CircabcDeclarativeWebScript {
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        if (c == null) {
            throw new WebScriptException(Status.STATUS_BAD_REQUEST, "Missing PUT body.");
        }
        ...
        try {
            ...
            if (!this.currentUserPermissionCheckerService.isCircabcAdmin()
                ...
                throw new AccessDeniedException("Not enough rights to form modifing a header");
            }
            ...
            throw new WebScriptException(
                    Status.STATUS_BAD_REQUEST, "Unable to parse JSON POST body: " + jsonErr.getMessage());
    ...
    private Map<String, Object> putModel(Status status, String id, String name, JSONObject description) throws JSONException {
        try {
