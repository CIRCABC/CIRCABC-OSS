 ...
 * @author beaurpi
 */
public class HelpSubcategoryGet extends DeclarativeWebScript {

  /** A logger for the class */
  static final Log logger = LogFactory.getLog(HelpSubcategoryGet.class);
  ...
  protected Map<String, Object> executeImpl(
    ...
    try {
      ...
      if ("".equals(id)) {
        throw new Exception("Subcategory ID is empty");
      }

      model.put("subcategory", helpApi.getHelpSubcategory(id));
    } catch (Exception e) {
