...
public class MachineTranslationServiceImpl
  ...
  public MachineTranslationServiceImpl() {
    ...
    username = CircabcConfiguration.getProperty(
      CircabcConfiguration.MT_REST_USERNAME
    );
    password = CircabcConfiguration.getProperty(
      CircabcConfiguration.MT_REST_PASSWORD
    );
  }
      ...
      return new JSONObject()
        ...
        .put(
          ...
          new JSONObject()
            .put(
              "ftpDestinations",
              new JSONArray().put(0, targetTranslationPath)
            )
        )
        .put("requesterCallback", requesterCallback)
        .put("errorCallback", errorCallback)
  ...
  public void sendMessage(
    ...
    try {
      ...
      String json = createTranslationRequest(
        applicationName,
        departmentNumber,
        documentToTranslate,
        domains,
