...
public class ManagementServiceImpl implements ManagementService {
   ...
   */
  public static final StoreRef storeRef = new StoreRef(
    StoreRef.PROTOCOL_WORKSPACE,
    "SpacesStore"
  );
  private static final MLText CATEGORY_ADMIN = new MLText(
    Locale.ENGLISH,
    "Category Administrator"
  );
  private static final MLText CIRCABC_ADMIN_TITLE = new MLText(
    Locale.ENGLISH,
    "Circabc Administrator"
  );
  private static final MLText ACCESS_TITLE = new MLText(
    Locale.ENGLISH,
    "Access"
  );
  private static final MLText AUTHOR_TITLE = new MLText(
    Locale.ENGLISH,
    "Author"
  );
  private static final MLText CONTRIB_TITLE = new MLText(
    Locale.ENGLISH,
    "Contributor"
  );
  private static final MLText LEADER_TITLE = new MLText(
    Locale.ENGLISH,
    "Leader"
  );
  private static final MLText REVIEWER_TITLE = new MLText(
    Locale.ENGLISH,
    "Reviewer"
  );
  private static final MLText SECRETARY_TITLE = new MLText(
    Locale.ENGLISH,
    "Secretary"
  );
  private static final MLText REGISTRED_TITLE = new MLText(
    Locale.ENGLISH,
    "Registered"
  );
  private static final MLText ANONYMOUS_TITLE = new MLText(
    Locale.ENGLISH,
    "Guest"
  );
   ...
   */
  private static final String GUEST_USER_HOME_PATH =
    "/app:company_home/app:guest_home";
  private static final String APP_ALFRESCO_DICTIONARY_LUCENE_PATH =
    "/app:dictionary";
  ...
  public void init() {
    dataTypeNodeRef = dictionaryService.getDataType(
  ...
  public SimplePath getNodePath(final String pathString)
    throws PathNotFoundException {
    if (pathString == null) {
      throw new PathNotFoundException(
        "The path as String is a mandatory parameter"
      );
    } else if (
      !pathString
        .toLowerCase()
        .startsWith(getRootSimplePath().toString().toLowerCase())
    ) {
      throw new PathNotFoundException(
    ...
    final StringTokenizer tokens = new StringTokenizer(
      pathString,
      String.valueOf(SimplePath.PATH_SEPARATOR),
      false
    );
    ...
    while (tokens.hasMoreTokens()) {
      ...
      iterNodeRef = nodeService.getChildByName(
        iterNodeRef,
    ...
    for (;;) {
      ...
      if (!includeContets) {
        final TypeDefinition typeDef =
          this.getDictionaryService().getType(type);
  ...
  public NodeRef createCircabc(final NodeRef parentNodeRef) {
    ...
    // Create circaBCNode
    final NodeRef circabcNodeRef = createFolder(
      parentNodeRef,
      getCircaBCFolderName()
    );
  ...
  public NodeRef createMTSpace(final NodeRef parentNodeRef) {
    ...
    mtNodeRef = null;
    mtLucenePath = null;
    String mtRootSpaceName = CircabcConfiguration.getProperty(
      CircabcConfiguration.MT_ROOT_NODE_NAME_PROPERTIES
    );
  ...
  private String getCircaBCFolderName() {
    return CircabcConfiguration.getProperty(
  ...
  public NodeRef createCategory(
    ...
    final NodeRef alfrescoCategoryNodeRef
  ) {
    final NodeRef circabcCategoryNodeRef = createFolder(
      parentNodeRef,
      folderName
    );
    ...
    final Map<QName, Serializable> updateProps = nodeService.getProperties(
      circabcCategoryNodeRef
    );
  ...
  public NodeRef createIGRoot(
    ...
    final NodeRef circabcIGRootNodeRef = createFolder(
      parentNodeRef,
      folderName
    );
    // add CircaBC aspect
    ...
    circabcIGRootProps.put(
      getIGRootProfileManagerService().getContactParamName(),
      circabcIGRootContact
    );
    nodeService.addAspect(
      circabcIGRootNodeRef,
    ...
    setCircabcIGRootDefaultSettings(
      parentNodeRef,
      circabcIGRootNodeRef,
      createOptionalProfiles
    );
  ...
  public NodeRef createLibrary(final NodeRef parentNodeRef) {
    final String circabcLibraryDescription = CircabcConfiguration.getProperty(
      CircabcConfiguration.LIBRARY_NODE_DESCRIPTION_PROPERTIES
    );
    final NodeRef circabcLibraryNodeRef = createFolder(
      parentNodeRef,
      CircabcConfiguration.getProperty(
        CircabcConfiguration.LIBRARY_NODE_NAME_PROPERTIES
      )
    );
    // add CircaBC aspect
    final Map<QName, Serializable> circabcLibraryRootProps = new HashMap<>();

    circabcLibraryRootProps.put(
      ContentModel.PROP_DESCRIPTION,
      circabcLibraryDescription
    );
    nodeService.addAspect(
      circabcLibraryNodeRef,
      CircabcModel.ASPECT_LIBRARY_ROOT,
      circabcLibraryRootProps
    );
  ...
  public NodeRef createNewsGroup(final NodeRef parentNodeRef) {
    final String circabcNewsGroupDescription = CircabcConfiguration.getProperty(
      CircabcConfiguration.NEWSGROUP_NODE_DESCRIPTION_PROPERTIES
    );
    final NodeRef circabcNewsGroupNodeRef = createNewsGroup(
      parentNodeRef,
      CircabcConfiguration.getProperty(
        CircabcConfiguration.NEWSGROUP_NODE_NAME_PROPERTIES
      )
    );
    // add CircaBC aspect
    final Map<QName, Serializable> circabcNewsGroupProps = new HashMap<>();

    circabcNewsGroupProps.put(
      ContentModel.PROP_DESCRIPTION,
      circabcNewsGroupDescription
    );
    nodeService.addAspect(
      circabcNewsGroupNodeRef,
      CircabcModel.ASPECT_NEWSGROUP_ROOT,
      circabcNewsGroupProps
    );
  ...
  public NodeRef createSurvey(final NodeRef parentNodeRef) {
    final String circabcSurveyDescription = CircabcConfiguration.getProperty(
      CircabcConfiguration.SURVEY_NODE_DESCRIPTION_PROPERTIES
    );
    final NodeRef circabcSurveyNodeRef = createSurvey(
      parentNodeRef,
      CircabcConfiguration.getProperty(
        CircabcConfiguration.SURVEY_NODE_NAME_PROPERTIES
      )
    );
    // add CircaBC aspect
    final Map<QName, Serializable> circabcSurveyProps = new HashMap<>();

    circabcSurveyProps.put(
      ContentModel.PROP_DESCRIPTION,
      circabcSurveyDescription
    );

    nodeService.addAspect(
      circabcSurveyNodeRef,
  ...
  public NodeRef createEventService(NodeRef parentNodeRef) {
    final String circabcEventDescription = CircabcConfiguration.getProperty(
      CircabcConfiguration.EVENT_NODE_DESCRIPTION_PROPERTIES
    );
    final NodeRef circabcEventNodeRef = createFolder(
      parentNodeRef,
      CircabcConfiguration.getProperty(
        CircabcConfiguration.EVENT_NODE_NAME_PROPERTIES
      )
    );
    // add Event aspect
    final Map<QName, Serializable> circabcEventProps = new HashMap<>();

    circabcEventProps.put(
      ContentModel.PROP_DESCRIPTION,
      circabcEventDescription
    );
    nodeService.addAspect(
      circabcEventNodeRef,
  ...
  public NodeRef createInformationService(NodeRef parentNodeRef) {
    ...
    final NodeRef circabcInformationNodeRef = createFolder(
      parentNodeRef,
      CircabcConfiguration.getProperty(
    ...
    circabcInformationProps.put(
      ContentModel.PROP_DESCRIPTION,
      circabcInformationDescription
    );
    nodeService.addAspect(
      circabcInformationNodeRef,
      CircabcModel.ASPECT_INFORMATION_ROOT,
      circabcInformationProps
    );
  ...
  private NodeRef createFolder(
    ...
    if (logger.isDebugEnabled()) {
      logger.debug(
        "create new Folder:" + folderName + " on parentNode: " + parentNodeRef
      );
    }
    try {
   ...
   * @return the FileInfo of the new Folder
   */
  private NodeRef createNewsGroup(
    final NodeRef parentNodeRef,
    final String newsGroupName
  ) {
    NodeRef newNodeRef = null;
    if (logger.isDebugEnabled()) {
      logger.debug(
    ...
    try {
      ...
      if (logger.isErrorEnabled()) {
        logger.error(
          "Impossible to create a newsgroup service under the node " +
          parentNodeRef,
          e
        );
      }
  ...
  private NodeRef createSurvey(
    ...
    if (logger.isDebugEnabled()) {
      logger.debug(
        "create new Folder:" + surveyName + " on parentNode: " + parentNodeRef
      );
    }
    try {
      final FileInfo fileInfo = fileFolderService.create(
        parentNodeRef,
        surveyName,
        SurveyModel.TYPE_SURVEY_SPACE
      );
      newNodeRef = fileInfo.getNodeRef();
    } catch (final RuntimeException e) {
      if (logger.isErrorEnabled()) {
        logger.error(
          "Impossible to create a survey service under the node " +
          parentNodeRef,
          e
        );
      }
  ...
  private void setCircabcDefaultSettings(final NodeRef nodeRef) {
    ...
    getCircabcRootProfileManagerService().createCircaSupportGroup();
    ...
    servicesPermissions = new HashMap<>();
    permissionsSet = new HashSet<>();
    profileName = getCircabcRootProfileManagerService()
      .getAllCircaUsersGroupName();

    permissionsSet.add(CircabcRootPermissions.CIRCABCACCESS.toString());
    servicesPermissions.put(CircabcServices.CIRCABC.toString(), permissionsSet);
    getCircabcRootProfileManagerService()
      .addProfile(nodeRef, profileName, servicesPermissions);
    getCircabcRootProfileManagerService()
      .addProfileTitles(nodeRef, profileName, REGISTRED_TITLE);
    ...
    getCircabcRootProfileManagerService()
      .addProfile(nodeRef, profileName, servicesPermissions);
    getCircabcRootProfileManagerService()
      .addProfileTitles(nodeRef, profileName, ANONYMOUS_TITLE);
    /*
    ...
    getCircabcRootProfileManagerService()
      .setAlfrescoAdminPermissions(nodeRef, permissions, true);
  }
  ...
  private void setCircabcCategoryDefaultSettings(final NodeRef nodeRef) {
    ...
    servicesPermissions.put(
      CircabcServices.CATEGORY.toString(),
      permissionsSet
    );
    ...
    // CircaBCAdmin
    final NodeRef circabcNodeRef = nodeService
      .getPrimaryParent(nodeRef)
      .getParentRef();
    final String circabcAdminGroup = getCircabcRootProfileManagerService()
      .getProfile(
        circabcNodeRef,
        CircabcRootProfileManagerService.Profiles.CIRCABC_ADMIN
      )
  ...
  private void setCircabcIGRootDefaultSettings(
    ...
    boolean createOptionalProfiles
  ) {
    ...
    if (createOptionalProfiles) {
      ...
      servicesPermissions = new HashMap<>();
      servicesPermissions.put(
        CircabcServices.DIRECTORY.toString(),
        permissionsSet
      );
      permissionsSet = new HashSet<>();
      ...
      getIGRootProfileManagerService()
        .addProfile(
          nodeRef,
          IGRootProfileManagerService.Profiles.ACCESS,
          servicesPermissions
        );
      getIGRootProfileManagerService()
        .addProfileTitles(
      ...
      getIGRootProfileManagerService()
        .addProfile(
          nodeRef,
          IGRootProfileManagerService.Profiles.AUTHOR,
          servicesPermissions
        );
      getIGRootProfileManagerService()
        .addProfileTitles(
      ...
      getIGRootProfileManagerService()
        .addProfile(
          nodeRef,
          IGRootProfileManagerService.Profiles.CONTRIBUTOR,
          servicesPermissions
        );
      getIGRootProfileManagerService()
        .addProfileTitles(
      ...
      getIGRootProfileManagerService()
        .addProfile(
          nodeRef,
          IGRootProfileManagerService.Profiles.IGLEADER,
          servicesPermissions
        );
      getIGRootProfileManagerService()
        .addProfileTitles(
      ...
      getIGRootProfileManagerService()
        .addProfile(
          nodeRef,
          IGRootProfileManagerService.Profiles.REVIEWER,
          servicesPermissions
        );
      getIGRootProfileManagerService()
        .addProfileTitles(
      ...
      getIGRootProfileManagerService()
        .addProfile(
          nodeRef,
          IGRootProfileManagerService.Profiles.SECRETARY,
          servicesPermissions
        );
      getIGRootProfileManagerService()
        .addProfileTitles(
    ...
    final String registredProfile = getCircabcRootProfileManagerService()
      .getAllCircaUsersGroupName();
    ...
    getIGRootProfileManagerService()
      .addProfile(nodeRef, registredProfile, servicesPermissions);
    getIGRootProfileManagerService()
      .addProfile(nodeRef, guestProfile, servicesPermissions);

    getIGRootProfileManagerService()
      .addProfileTitles(nodeRef, registredProfile, REGISTRED_TITLE);

    getIGRootProfileManagerService()
      .addProfileTitles(nodeRef, guestProfile, ANONYMOUS_TITLE);

    // CategoryAdmin
    final String circabcCategoryAdminGroup = getCategoryProfileManagerService()
      .getProfile(
        circabcCategoryNodeRef,
        CategoryProfileManagerService.Profiles.CIRCA_CATEGORY_ADMIN
      )
  ...
  private void setCircabcLibraryDefaultSettings(
    final NodeRef circabcIGRootNodeRef,
    final NodeRef nodeRef
  ) {
    final Map<String, Profile> profiles = getIGRootProfileManagerService()
      .getProfileMap(circabcIGRootNodeRef);
    ...
    if (profiles.containsKey(IGRootProfileManagerService.Profiles.ACCESS)) {
      ...
      servicesPermissions = new HashMap<>();
      servicesPermissions.put(
        CircabcServices.LIBRARY.toString(),
        permissionsSet
      );
    ...
    if (
      profiles.containsKey(IGRootProfileManagerService.Profiles.CONTRIBUTOR)
    ) {
      // Contributor
      permissionsSet = new HashSet<>();
      permissionsSet.add(LibraryPermissions.LIBACCESS.toString());
    ...
    final NodeRef circabcCategoryNodeRef = nodeService
      .getPrimaryParent(circabcIGRootNodeRef)
      .getParentRef();
  ...
  private void setCircabcNotifyRules(final NodeRef libraryNodeRef) {
    ...
    compositeActionNotify.setDescription(
  ...
  private void setCircabcNewsGroupDefaultSettings(
    ...
    if (profiles.containsKey(IGRootProfileManagerService.Profiles.ACCESS)) {
      ...
      servicesPermissions = new HashMap<>();
      servicesPermissions.put(
        CircabcServices.NEWSGROUP.toString(),
        permissionsSet
      );
  ...
  private void setCircabcSurveyDefaultSettings(
    ...
    if (profiles.containsKey(IGRootProfileManagerService.Profiles.ACCESS)) {
      ...
      servicesPermissions = new HashMap<>();
      servicesPermissions.put(
        CircabcServices.SURVEY.toString(),
        permissionsSet
      );
    ...
    permissionService.setPermission(
      nodeRef,
      circabcCategoryAdminGroup,
      SurveyPermissions.SURADMIN.toString(),
      true
    );
  ...
  private void setDefaultSurveyRules(final NodeRef surveyNodeRef) {
    {
      // Add CircaNewsGroup
      final CompositeAction compositeActionSurvey =
        actionService.createCompositeAction();

      // Create Action
      final Action actionSurvey = actionService.createAction(
        AddFeaturesActionExecuter.NAME
      );
      ...
      compositeActionSurvey.setDescription(
        "Add CircaSurvey Aspect Description"
      );
  ...
  private void setEventDefaultSettings(
    final NodeRef circabcIGRootNodeRef,
    final NodeRef nodeRef
  ) {
    final Map<String, Profile> profiles = getIGRootProfileManagerService()
  ...
  private void setInformationDefaultSettings(
    ...
    if (profiles.containsKey(IGRootProfileManagerService.Profiles.ACCESS)) {
      ...
      servicesPermissions = new HashMap<>();
      servicesPermissions.put(
        CircabcServices.INFORMATION.toString(),
        permissionsSet
      );
  ...
  public List<NodeRef> getCategoryHeaders(final NodeRef nodeRef) {
    if (!nodeService.hasAspect(nodeRef, ContentModel.ASPECT_GEN_CLASSIFIABLE)) {
      if (nodeService.hasAspect(nodeRef, CircabcModel.ASPECT_CATEGORY)) {
        logger.error(
          "A category is found without being linked to a Category Header."
        );

        throw new IllegalStateException(
          "All the Categories MUST be linked to a Category Header."
        );
      }
    ...
    final List<NodeRef> cats = (List<NodeRef>) nodeService.getProperty(
      nodeRef,
  ...
  public Map<NodeRef, List<NodeRef>> getCategoryHeadersMap() {
    ...
    final Map<NodeRef, List<NodeRef>> categoryHeaderMap = new HashMap<>(
      categories.size()
    );
  ...
  public Map<NodeRef, List<NodeRef>> getCategoryMap() {
    ...
    // construct the map to return
    final Map<NodeRef, List<NodeRef>> categoryMap = new HashMap<>(
      categories.size()
    );
    List<NodeRef> categoryHeaders;
  ...
  public List<NodeRef> getExistingCategoryHeaders() {
    ...
    final Collection<ChildAssociationRef> childRefs =
      categoryService.getChildren(
        circaBCHeadersNodeRef,
        Mode.SUB_CATEGORIES,
        Depth.IMMEDIATE
      );
    ...
    if (rootCategoryHeader == null) {
      ...
      if (rootCategoryHeader != null) {
        if (logger.isDebugEnabled()) {
          ...
          logger.debug(
            "CircaBCHeader found at:" + nodeService.getPath(rootCategoryHeader)
          );
        }
  ...
  public List<NodeRef> getCategories() {
    final List<FileInfo> childsAssoc = fileFolderService.listFolders(
      getCircabcNodeRef()
    );
  ...
  public List<NodeRef> getInterestGroups(final NodeRef category) {
    final List<ChildAssociationRef> assocs = getServiceRegistry()
      .getNodeService()
      .getChildAssocs(category);
  ...
  public NodeRef getCircabcNodeRef() {
    if (circabcNodeRef == null) {
      final List<NodeRef> circabcNodeRefs = getNodesFromPath(
        getCircabcLucenePath()
      );
      ...
      if (circabcNodeRef != null) {
        if (logger.isDebugEnabled()) {
          ...
          logger.debug(
            "CircaBC found at:" + nodeService.getPath(circabcNodeRef)
          );
        }
  ...
  public NodeRef getAlfrescoDictionaryNodeRef() {
    final List<NodeRef> nodeRefs = getNodesFromPath(
      getAlfrescoDictionaryLucenePath()
    );
    ...
    if (alfrescoDictionary != null) {
      if (logger.isDebugEnabled()) {
        ...
        logger.debug(
          "alfrescoDictionary found at:" +
          nodeService.getPath(alfrescoDictionary)
        );
      }
    }
  ...
  public String getAlfrescoDictionaryLucenePath() {
    if (alfrescoDictionaryPath == null) {
      alfrescoDictionaryPath =
        APP_COMPANY_HOME_PATH + APP_ALFRESCO_DICTIONARY_LUCENE_PATH;
    }
  ...
  private String getCategoryHeaderRootLucenePath() {
    if (categoryHeaderLucenePath == null) {
      categoryHeaderLucenePath =
        ...
        CircabcConfiguration.getProperty(
          CircabcConfiguration.ROOT_HEADER_NAME_PROPERTIES
        );
    }
  ...
  public boolean isCircabcUser(final String userName) {
    final String userGroupName = getCircabcRootProfileManagerService()
      .getMasterInvitedGroupName(getCircabcNodeRef());
  ...
  public boolean hasGuestVisibility(final NodeRef igRootNodeRef) {
    final Profile profile = getIGRootProfileManagerService()
      .getProfile(igRootNodeRef, CircabcConstant.GUEST_AUTHORITY);
    final Set<String> permissions = profile.getServicePermissions(
      CircabcServices.VISIBILITY.toString()
    );
  ...
  public boolean hasAllCircabcUsersVisibility(final NodeRef igRootNodeRef) {
    final String allUserGroupName = getCircabcRootProfileManagerService()
      .getAllCircaUsersGroupName();
    final Profile profile = getIGRootProfileManagerService()
      .getProfile(igRootNodeRef, allUserGroupName);
    final Set<String> permissions = profile.getServicePermissions(
      CircabcServices.VISIBILITY.toString()
    );
    if (permissions.contains(VisibilityPermissions.VISIBILITY.toString())) {
  ...
  public NodeRef getCurrentInterestGroup(final NodeRef currentNodeRef) {
    ...
    for (;;) {
      ...
      if (
        ...
        tempNodeRef = getMultilingualContentService()
          .getPivotTranslation(tempNodeRef);
      }

      if (
        !getNodeService().hasAspect(tempNodeRef, CircabcModel.ASPECT_IGROOT)
      ) {
        tempNodeRef = getNodeService()
  ...
  public NodeRef getCurrentLibrary(final NodeRef currentNodeRef) {
    ...
    if (getNodeService().hasAspect(tempNodeRef, CircabcModel.ASPECT_IGROOT)) {
      tempNodeRef = getFirstChildByAspect(
        tempNodeRef,
        CircabcModel.ASPECT_LIBRARY_ROOT
      );
    } else {
      for (;;) {
        ...
        if (
          !getNodeService()
            .hasAspect(tempNodeRef, CircabcModel.ASPECT_LIBRARY_ROOT)
        ) {
          tempNodeRef = getNodeService()
            .getPrimaryParent(tempNodeRef)
            .getParentRef();
  ...
  public NodeRef getCurrentTopic(final NodeRef currentNodeRef) {
    ...
    if (typeDef != null) {
      ...
      if (ForumModel.TYPE_TOPIC.equals(type)) {
        ...
        getDictionaryService().isSubClass(type, ForumModel.TYPE_TOPIC)
      ) {
        // Nothing to do
  ...
  public List<NodeRef> luceneSearch(
    ...
    final QueryParameterDefinition parentParamDef = new QueryParameterDefImpl(
      PARAM_QNAME_PARENT,
      dataTypeNodeRef,
      true,
      contextNodeRefName.toString()
    );
   ...
   */
  private NodeRef getFirstChildByAspect(
   ...
   */
  public void setNavigationPreferencesService(
    NavigationPreferencesService navigationPreferences
  ) {
