...
public class GroupsDocumentsDeletedDelete extends CircabcDeclarativeWebScript {
     ...
     */
    static final Log logger = LogFactory.getLog(GroupsDocumentsDeletedDelete.class);
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        try {
            if (!this.currentUserPermissionCheckerService.isGroupAdmin(id)) {
                throw new AccessDeniedException("User is not Group admin to remove a deleted document");
            }
