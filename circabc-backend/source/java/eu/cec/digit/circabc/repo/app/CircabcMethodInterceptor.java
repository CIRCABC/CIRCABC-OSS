...
public class CircabcMethodInterceptor implements MethodInterceptor {
  ...
  private static final Log logger = LogFactory.getLog(
    CircabcMethodInterceptor.class
  );
  ...
  public void init() {
    circabcServiceSimpleName =
      CircabcRootProfileManagerService.class.getSimpleName();
    categoryServiceSimpleName =
      CategoryProfileManagerServiceImpl.class.getSimpleName();
    ...
    logoPreferencesServiceSimpleName =
      LogoPreferencesServiceImpl.class.getSimpleName();
  }
    ...
    if (targetName.equals(igServiceSimpleName)) {
      switch (methodName) {
        ...
        case "updateProfile": {
          ...
          Map<String, Set<String>> servicesPermissions = (Map<
              String,
              Set<String>
            >) arguments[2];
      ...
      if (
        methodName.equals("createLdapUser") || methodName.equals("createUser")
      ) {
      ...
      if (methodName.equals("postHeader")) {
        ...
        if (header != null) {
          ...
          circabcService.updateHeader(
            headerNodeRef,
            header.getName(),
            header.getDescription().get("en")
          );
        }
      }
    } else if (targetName.equals(profilesApiImplSimpleName)) {
      if (
        methodName.equals("groupsIdProfilesPost") ||
      ...
      if (methodName.equals("groupsIdPut")) {
        io.swagger.model.InterestGroup group =
          (io.swagger.model.InterestGroup) arguments[1];
        ...
        if (group != null) {
          circabcService.updateInterestGroupPublic(
            igNodeRef,
            group.getIsPublic()
          );
          circabcService.updateInterestGroupRegistered(
            igNodeRef,
            group.getIsRegistered()
          );
          circabcService.updateInterestGroupApplication(
            igNodeRef,
            group.getAllowApply()
          );
        }
      ...
      if (methodName.equals("groupsIdMembersUserIdDelete")) {
        NodeRef igNodeRef = Converter.createNodeRefFromId(
          (String) arguments[0]
        );
      ...
      if (methodName.equals("categoriesIdGroupsPost")) {
        io.swagger.model.InterestGroupPostModel groupPostModel =
          (io.swagger.model.InterestGroupPostModel) arguments[1];
        io.swagger.model.InterestGroup group =
          (io.swagger.model.InterestGroup) result;
        if (group != null) {
      ...
      if (methodName.equals("selectCategoryLogoByLogoId")) {
        NodeRef categoryNodeRef = Converter.createNodeRefFromId(
          (String) arguments[0]
        );
      ...
      if (methodName.equals("headersIdCategoryPost")) {
        NodeRef headerNodeRef = Converter.createNodeRefFromId(
          (String) arguments[0]
        );
      ...
      targetName.equals(logoPreferencesServiceSimpleName) &&
