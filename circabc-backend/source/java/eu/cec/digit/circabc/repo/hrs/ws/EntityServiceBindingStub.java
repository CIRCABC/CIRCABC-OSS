...
public class EntityServiceBindingStub
  ...
  public EntityServiceBindingStub(
  ...
  public EntityServiceBindingStub(javax.xml.rpc.Service service)
    throws org.apache.axis.AxisFault {
    if (service == null) {
    ...
    cachedSerQNames.add(qName);
    cls =
      eu.cec.digit.circabc.repo.hrs.ws.ExternalPersonCreationRequestLinkedToOrganization.class;
    cachedSerClasses.add(cls);
    ...
    qName = new javax.xml.namespace.QName(
      "http://ec.europa.eu/sg/hrs/types",
      ">FindCurrentExternalEntityRequest>searchById"
    );
    cachedSerQNames.add(qName);
    ...
    cachedSerQNames.add(qName);
    cls =
      eu.cec.digit.circabc.repo.hrs.ws.FindCurrentExternalEntityRequestSearchForOrganization.class;
    cachedSerClasses.add(cls);
    cachedSerFactories.add(beansf);
    cachedDeserFactories.add(beandf);
    ...
    cachedSerQNames.add(qName);
    cls =
      eu.cec.digit.circabc.repo.hrs.ws.FindCurrentExternalEntityRequestSearchForPerson.class;
    cachedSerClasses.add(cls);
    cachedSerFactories.add(beansf);
    cachedDeserFactories.add(beandf);
    ...
    qName = new javax.xml.namespace.QName(
      "http://ec.europa.eu/sg/hrs/types",
      ">FindCurrentInternalEntityRequest>searchById"
    );
    cachedSerQNames.add(qName);
    cls = java.lang.String[].class;
    cachedSerClasses.add(cls);
    ...
    cachedSerQNames.add(qName);
    cls =
      eu.cec.digit.circabc.repo.hrs.ws.FindCurrentInternalEntityRequestSearchForOrganization.class;
    cachedSerClasses.add(cls);
    cachedSerFactories.add(beansf);
    cachedDeserFactories.add(beandf);
    ...
    cachedSerQNames.add(qName);
    cls =
      eu.cec.digit.circabc.repo.hrs.ws.FindCurrentInternalEntityRequestSearchForPerson.class;
    cachedSerClasses.add(cls);
    cachedSerFactories.add(beansf);
    cachedDeserFactories.add(beandf);
    ...
    cachedSerQNames.add(qName);
    cls =
      eu.cec.digit.circabc.repo.hrs.ws.CurrentExternalEntityCreationRequest.class;
    cachedSerClasses.add(cls);
    cachedSerFactories.add(beansf);
    cachedDeserFactories.add(beandf);
    ...
    qName = new javax.xml.namespace.QName(
      "http://ec.europa.eu/sg/hrs/types",
      "CurrentExternalEntityRetrievalOptions"
    );
    cachedSerQNames.add(qName);
    cls =
    ...
    qName = new javax.xml.namespace.QName(
      "http://ec.europa.eu/sg/hrs/types",
      "EntitySearchByExpressionRequest"
    );
    cachedSerQNames.add(qName);
    cls =
    ...
    cachedSerQNames.add(qName);
    cls =
      eu.cec.digit.circabc.repo.hrs.ws.ExternalOrganizationCreationRequest.class;
    cachedSerClasses.add(cls);
    cachedSerFactories.add(beansf);
    cachedDeserFactories.add(beandf);
    ...
    qName = new javax.xml.namespace.QName(
      "http://ec.europa.eu/sg/hrs/types",
      "FindCurrentInternalEntityRequest"
    );
    cachedSerQNames.add(qName);
    cls =
  ...
  private static void _initOperationDesc1() {
    ...
    oper.setReturnClass(
      eu.cec.digit.circabc.repo.hrs.ws.CurrentInternalEntity[].class
    );
    oper.setReturnQName(
      new javax.xml.namespace.QName(
        "http://ec.europa.eu/sg/hrs/types",
    ...
    oper.setReturnClass(
      eu.cec.digit.circabc.repo.hrs.ws.CurrentExternalEntity[].class
    );
    oper.setReturnQName(
      new javax.xml.namespace.QName(
        "http://ec.europa.eu/sg/hrs/types",
  ...
  public eu.cec.digit.circabc.repo.hrs.ws.CurrentInternalEntity[] findCurrentInternalEntity(
    ...
    try {
      java.lang.Object _resp = _call.invoke(
        new java.lang.Object[] { header, criteria, searchByExpressionRequest }
      );
      ...
      if (_resp instanceof java.rmi.RemoteException) {
        ...
        try {
          ...
          return (eu.cec.digit.circabc.repo.hrs.ws.CurrentInternalEntity[]) org.apache.axis.utils.JavaUtils.convert(
            _resp,
            eu.cec.digit.circabc.repo.hrs.ws.CurrentInternalEntity[].class
          );
        }
    ...
    try {
      ...
      if (_resp instanceof java.rmi.RemoteException) {
        ...
        try {
          ...
          return (eu.cec.digit.circabc.repo.hrs.ws.CurrentExternalEntity[]) org.apache.axis.utils.JavaUtils.convert(
            _resp,
            eu.cec.digit.circabc.repo.hrs.ws.CurrentExternalEntity[].class
          );
        }
