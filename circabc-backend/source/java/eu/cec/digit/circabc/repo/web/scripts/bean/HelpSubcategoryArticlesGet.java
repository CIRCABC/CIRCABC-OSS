...
public class HelpSubcategoryArticlesGet extends DeclarativeWebScript {

  static final Log logger = LogFactory.getLog(HelpSubcategoryArticlesGet.class);
  ...
  protected Map<String, Object> executeImpl(
    ...
    try {
      ...
      model.put("articles", helpApi.getSubcategoryArticles(id, loadContent));
    } catch (Exception e) {
