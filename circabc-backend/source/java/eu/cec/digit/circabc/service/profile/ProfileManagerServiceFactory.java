...
public class ProfileManagerServiceFactory implements BeanFactoryAware {
  ...
  private static final Log logger = LogFactory.getLog(
    ProfileManagerServiceFactory.class
  );
  private static final String profileManagerServiceFactory =
    "profileManagerServiceFactory";
  private static final String profileManagerServiceFactorySecure =
    "ProfileManagerServiceFactory";
   ...
   * of ProfileManagerService
   */
  private ProfileManagerService getProfileManagerService(
  ...
  public CircabcRootProfileManagerService getCircabcRootProfileManagerService() {
    if (secure) {
      return (CircabcRootProfileManagerService) this.factory.getBean(
          CircabcRootProfileManagerService.PROXIED_SERVICE_NAME
        );
    } else {
      return (CircabcRootProfileManagerService) this.factory.getBean(
          CircabcRootProfileManagerService.SERVICE_NAME
        );
    }
  }
  ...
  public CategoryProfileManagerService getCategoryProfileManagerService() {
    ...
    if (secure) {
      return (CategoryProfileManagerService) this.factory.getBean(
          CategoryProfileManagerService.PROXIED_SERVICE_NAME
        );
    } else {
      return (CategoryProfileManagerService) this.factory.getBean(
          CategoryProfileManagerService.SERVICE_NAME
        );
    }
  }
  ...
  public IGRootProfileManagerService getIGRootProfileManagerService() {
    if (secure) {
      return (IGRootProfileManagerService) this.factory.getBean(
          IGRootProfileManagerService.PROXIED_SERVICE_NAME
        );
    } else {
      return (IGRootProfileManagerService) this.factory.getBean(
          IGRootProfileManagerService.SERVICE_NAME
        );
    }
  }
  ...
  public LibraryProfileManagerService getLibraryProfileManagerService() {
    if (secure) {
      return (LibraryProfileManagerService) this.factory.getBean(
          LibraryProfileManagerService.PROXIED_SERVICE_NAME
        );
    } else {
      return (LibraryProfileManagerService) this.factory.getBean(
          LibraryProfileManagerService.SERVICE_NAME
        );
    }
  }
  ...
  public NewsGroupProfileManagerService getNewsGroupProfileManagerService() {
    if (secure) {
      return (NewsGroupProfileManagerService) this.factory.getBean(
          NewsGroupProfileManagerService.PROXIED_SERVICE_NAME
        );
    } else {
      return (NewsGroupProfileManagerService) this.factory.getBean(
          NewsGroupProfileManagerService.SERVICE_NAME
        );
    }
  }
  ...
  public SurveyProfileManagerService getSurveyProfileManagerService() {
    if (secure) {
      return (SurveyProfileManagerService) this.factory.getBean(
          SurveyProfileManagerService.PROXIED_SERVICE_NAME
        );
    } else {
      return (SurveyProfileManagerService) this.factory.getBean(
          SurveyProfileManagerService.SERVICE_NAME
        );
    }
  }
  ...
  public InformationProfileManagerService getInformationProfileManagerService() {
    if (secure) {
      return (InformationProfileManagerService) this.factory.getBean(
          InformationProfileManagerService.PROXIED_SERVICE_NAME
        );
    } else {
      return (InformationProfileManagerService) this.factory.getBean(
          InformationProfileManagerService.SERVICE_NAME
        );
    }
  }
  ...
  public EventProfileManagerService getEventProfileManagerService() {
    if (secure) {
      return (EventProfileManagerService) this.factory.getBean(
          EventProfileManagerService.PROXIED_SERVICE_NAME
        );
    } else {
      return (EventProfileManagerService) this.factory.getBean(
          EventProfileManagerService.SERVICE_NAME
        );
    }
  }
