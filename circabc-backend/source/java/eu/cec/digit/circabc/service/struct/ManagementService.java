...
public interface ManagementService {
  ...
  String DYNAMIC_AUTHORITY_CACHE_TIMOUT_CLEANUP =
    "dynamic.authority.cache.timeout.cleanup";
  ...
  String PROFILE_MAP_CACHE_TIMOUT_RESET_ON_READ =
    "profile.map.cache.timeout.reset.on.read";
  ...
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = {
      "parentNodeRef", "folderName", "alfrescoCategoryNodeRef",
    }
  )
  ...
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = {
      "parentNodeRef", "folderName", "circabcIGRootContact",
    }
  )
   ...
   */
  @NotAuditable
  List<SimplePath> getChildsPath(final NodeRef nodeRef)
