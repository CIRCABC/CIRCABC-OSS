...
public class GroupRequestsDaoServiceImpl implements GroupRequestsDaoService {
  ...
  public void updateRequestDeletion(
    ...
    try {
      ...
      if (body.getAgreement() == -1) {
        ...
        props.put("rejected_message", rejectedMessage.length() > 256 ? rejectedMessage.substring(0, 256) : rejectedMessage);
      }
  ...
  public int saveRequestDeletion(GroupDeletionRequest body) {
    ...
    try {
      props.put("id", null);
      props.put("from_username", body.getFrom() != null ? body.getFrom().getUserId() : "");
      props.put("request_date", body.getRequestDate() != null ? body.getRequestDate().toDate() : null);
      props.put("category_ref", body.getCategoryRef() != null ? body.getCategoryRef() : "");
      props.put("agreement", body.getAgreement() != null ? body.getAgreement() : "");
      props.put("reviewer", null);
      String justification = body.getJustification() != null ? body.getJustification() : "";
      props.put("justification", justification.length() > 256 ? justification.substring(0, 256) : justification);
      ...
      props.put("description", description.length() > 256 ? description.substring(0, 256) : description);
  ...
  public void deleteRequestDeletion(String group_id) {
    ...
    sqlSessionTemplate.delete("GroupRequests.delete_group_request_delete", props);
  }
}
