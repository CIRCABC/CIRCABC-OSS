...
public class PreviewPDFRenditionJob implements StatefulJob {
  ...
  public void execute(JobExecutionContext context)
    ...
    final int renderAmount = Integer.valueOf(
      (String) jobData.get("renderAmount")
    );
    String startYear = (String) jobData.get("startYear");

    final CircabcRenditionService circabcRenditionService =
      (CircabcRenditionService) circabcServiceRegistry.getService(
        CircabcServiceRegistry.CIRCABC_RENDITION_SERVICE
      );

    final NodeService nodeService = serviceRegistry.getNodeService();
    final RenditionService renditionService =
