...
/**
 * This service provides operations to manage interest group profiles
 *
 * @author duboiph
 ...
 */
// @PublicService
public interface IGRootProfileManagerService extends ProfileManagerService {
  String SERVICE_NAME = "igRootProfileManagerService";
  String PROXIED_SERVICE_NAME = "IGRootProfileManagerService";
  ...
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = {
      "rootNode", "userID", "message", "firstName", "lastName",
    }
  )
  ...
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = {
      "nodeRef", "profileName", "servicesPermissions",
    }
  )
  void addProfile(
    final NodeRef nodeRef,
   ...
   */
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = { "nodeRef", "userName" }
  )
  void changePassword(
    final NodeRef nodeRef,
  ...
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = {
      "nodeRef", "profileName", "cleanPermission",
    }
  )
  void deleteProfile(
    final NodeRef nodeRef,
   ...
   * @return
   */
  List<NodeRef> getRefInExportedProfile(
    final NodeRef nodeRef,
    final String profileName
  );
   ...
   */
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = { "rootNode", "userName" }
  )
  ...
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = {
      "nodeRef", "oldProfileName", "newProfileName",
    }
  )
  void renameProfile(
    NodeRef nodeRef,
  ...
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = {
      "nodeRef", "userID", "cleanPermission",
    }
  )
  void uninvitePerson(
    final NodeRef nodeRef,
  ...
  interface Profiles {
    /**
     * The profile name IGLEADER can never be added, removed or changed The profile IGLEADER is
     * created during the interestgroup creation process Must always exist
     */
    String IGLEADER = "IGLeader";

    String LEADER000 = "000";
    String LEADER = "Leader";

    // This type of profile allows everything on the library but is
    // sensitive to
    // inheritense cuting. Can access directory.
    ...
    // can edit (even others files), create, delete own but not delete
    // others
  ...
  interface Roles {
    /**
     * Constant for ROLE_IGLEADER
     */
    String IGLEADER = "ROLE_IGLEADER";
  }
}
