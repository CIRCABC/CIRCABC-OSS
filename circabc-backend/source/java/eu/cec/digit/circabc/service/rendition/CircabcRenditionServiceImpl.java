...
public class CircabcRenditionServiceImpl implements CircabcRenditionService {
  ...
  private static final Log logger = LogFactory.getLog(
    CircabcRenditionServiceImpl.class
  );
  ...
  public void addRequest(NodeRef nodeRef) {
    ...
    String hostName = CircabcConfiguration.getProperty(
      CircabcConfiguration.DOC_PREVIEW_RENDER_HOST
    );
    ...
    if (hostName == null) {
      try {
        ...
        logger.warn(
          "Error when retrieving machine name. Setting name to null.",
          e
        );
      }
    }
