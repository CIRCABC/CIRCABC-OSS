...
public class CircabcServiceDescriptor
  implements BeanFactoryAware, CircabcServiceRegistry {
  ...
  public CircabcRootProfileManagerService getCircabcRootProfileManagerService() {
    return (CircabcRootProfileManagerService) getService(
      ROOT_PROFILE_MANAGER_SERVICE
    );
  }

  public CategoryProfileManagerService getCategoryProfileManagerService() {
    return (CategoryProfileManagerService) getService(
      CATEGORY_PROFILE_MANAGER_SERVICE
    );
  }

  public IGRootProfileManagerService getIGRootProfileManagerService() {
    return (IGRootProfileManagerService) getService(
      IGROOT_PROFILE_MANAGER_SERVICE
    );
  }

  public LibraryProfileManagerService getLibraryProfileManagerService() {
    return (LibraryProfileManagerService) getService(
      LIBRARY_PROFILE_MANAGER_SERVICE
    );
  }

  public NewsGroupProfileManagerService getNewsGroupProfileManagerService() {
    return (NewsGroupProfileManagerService) getService(
      NEWSGROUP_PROFILE_MANAGER_SERVICE
    );
  }

  public SurveyProfileManagerService getSurveyProfileManagerService() {
    return (SurveyProfileManagerService) getService(
      SURVEY_PROFILE_MANAGER_SERVICE
    );
  }

  public InformationProfileManagerService getInformationProfileManagerService() {
    return (InformationProfileManagerService) getService(
      INFORMATION_PROFILE_MANAGER_SERVICE
    );
  }

  public EventProfileManagerService getEventProfileManagerService() {
    return (EventProfileManagerService) getService(
      EVENT_PROFILE_MANAGER_SERVICE
    );
  }

  public ProfileManagerServiceFactory getProfileManagerServiceFactory() {
    return (ProfileManagerServiceFactory) getService(
      PROFILE_MANAGER_SERVICE_FACTORY
    );
  }
  ...
  public NotificationSubscriptionService getNotificationSubscriptionService() {
    return (NotificationSubscriptionService) getService(
  ...
  public ServerConfigurationService getServerConfigurationService() {
    return (ServerConfigurationService) getService(
  ...
  public NavigationConfigService getNavigationConfigService() {
    return (NavigationConfigService) getService(
      NAVIGATION_CONFIGURATION_SERVICE
    );
  }

  public NodePreferencesService getgetNavigationPreferencesService() {
    return (NodePreferencesService) getService(
      NAVIGATION_CUSTOMISATION_SERVICE
    );
  }
  ...
  public NavigationPreferencesService getNavigationPreferencesService() {
    return (NavigationPreferencesService) getService(
      NAVIGATION_CUSTOMISATION_SERVICE
    );
  }
  ...
  public ProfileManagerServiceFactory getNonSecureProfileManagerServiceFactory() {
    return (ProfileManagerServiceFactory) getService(
      NON_SECURED_PROFILE_MANAGER_SERVICE_FACTORY
    );
  }
  ...
  public NotificationManagerService getNotificationManagerService() {
    return (NotificationManagerService) getService(
  ...
  public ApplicationCustomisationService getApplicationCustomisationService() {
    return (ApplicationCustomisationService) getService(
      APPLICATION_CUSTOMISATION_SERVICE
    );
  }
  ...
  public ApplicationCustomisationService getNonSecuredApplicationCustomisationService() {
    return (ApplicationCustomisationService) getService(
      NON_SECURED_APPLICATION_CUSTOMISATION_SERVICE
    );
  }
