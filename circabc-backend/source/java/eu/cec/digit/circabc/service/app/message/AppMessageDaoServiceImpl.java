...
public class AppMessageDaoServiceImpl implements AppMessageDaoService {
  ...
  private static final Log logger = LogFactory.getLog(
    AppMessageDaoServiceImpl.class
  );
  ...
  public List<AppMessageDAO> selectAppMessageTemplates(int page, int limit) {
    ...
    List<AppMessageDAO> result = (List<
        AppMessageDAO
      >) sqlSessionTemplate.selectList("AppMessage.select_app_messages", props);
    return result;
  }
  ...
  public AppMessageDAO getMessageTemplate(Integer id) {
    Map<String, Object> props = new HashMap<>();
    props.put("id", id);
    AppMessageDAO template = (AppMessageDAO) sqlSessionTemplate.selectOne(
  ...
  public List<DistributionEmailDAO> selectDistributionEmails(
    ...
    List<DistributionEmailDAO> result = (List<
        DistributionEmailDAO
