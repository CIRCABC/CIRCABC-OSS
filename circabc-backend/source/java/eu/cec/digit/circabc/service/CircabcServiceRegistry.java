...
public interface CircabcServiceRegistry {
  ...
  QName ROOT_PROFILE_MANAGER_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    CircabcRootProfileManagerService.PROXIED_SERVICE_NAME
  );
  QName CATEGORY_PROFILE_MANAGER_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    CategoryProfileManagerService.PROXIED_SERVICE_NAME
  );
  QName IGROOT_PROFILE_MANAGER_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    IGRootProfileManagerService.PROXIED_SERVICE_NAME
  );
  QName LIBRARY_PROFILE_MANAGER_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    LibraryProfileManagerService.PROXIED_SERVICE_NAME
  );
  QName NEWSGROUP_PROFILE_MANAGER_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    NewsGroupProfileManagerService.PROXIED_SERVICE_NAME
  );
  QName SURVEY_PROFILE_MANAGER_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    SurveyProfileManagerService.PROXIED_SERVICE_NAME
  );
  QName INFORMATION_PROFILE_MANAGER_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    InformationProfileManagerService.PROXIED_SERVICE_NAME
  );
  QName EVENT_PROFILE_MANAGER_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    EventProfileManagerService.PROXIED_SERVICE_NAME
  );

  QName PROFILE_MANAGER_SERVICE_FACTORY = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "ProfileManagerServiceFactory"
  );
  QName MANAGEMENT_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "ManagementService"
  );
  QName KEYWORDS_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "KeywordsService"
  );
  ...
  QName MAIL_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "CircabcMailService"
  );
  QName MAIL_TO_MEMBERS_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "MailToMembersService"
  );
  QName BULK_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "BulkService"
  );
  QName NOTIFICATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "NotificationService"
  );
  QName NOTIFICATION_SUBSCRIPTION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "NotificationSubscriptionService"
  );
  QName NOTIFICATION_MANAGER_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "NotificationManagerService"
  );
  QName DYNAMIC_PROPERTY_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "DynamicPropertiesService"
  );
  QName SERVER_CONFIGURATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "ServerConfigurationService"
  );
  QName NODE_CUSTOMISATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "NodePreferencesService"
  );
  QName MAIL_CUSTOMISATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "MailPreferencesService"
  );
  QName NAVIGATION_CUSTOMISATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "NavigationPreferencesService"
  );
  QName NAVIGATION_CONFIGURATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "navigationConfigService"
  );
  QName LOGO_CUSTOMISATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "LogoPreferencesService"
  );
  QName EVENT_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "EventService"
  );
  QName SHARE_SPACE_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "ShareSpaceService"
  );
  ...
  QName MODERATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "ModerationService"
  );
  QName SUPPORT_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "SupportService"
  );
  QName ATTACHEMENT_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "AttachementService"
  );
  QName STATISTICS_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "StatisticsService"
  );
  QName ASYNC_THREAD_POOL_EXECUTOR = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "AsyncThreadPoolExecutor"
  );
  QName TRANSLATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "TranslationService"
  );
  QName APPLICATION_CUSTOMISATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "ApplicationCustomisationService"
  );
  QName NON_SECURED_APPLICATION_CUSTOMISATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "applicationCustomisationService"
  );

  QName NON_SECURED_PROFILE_MANAGER_SERVICE_FACTORY = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "profileManagerServiceFactory"
  );
  ...
  QName NON_SECURED_ZIP_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "zipService"
  );
  QName NON_SECURED_BULK_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "bulkService"
  );
  QName NON_SECURED_INDEX_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "indexService"
  );
  QName NON_SECURED_DICTIONARY_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "dictionaryService"
  );
  QName NON_SECURED_TRANSACTION_SERVICE = QName.createQName(
    NamespaceService.ALFRESCO_URI,
    "transactionService"
  );
  QName NON_SECURED_NODE_SERVICE = QName.createQName(
    NamespaceService.ALFRESCO_URI,
    "nodeService"
  );
  QName NON_SECURED_SEARCH_SERVICE = QName.createQName(
    NamespaceService.ALFRESCO_URI,
    "searchService"
  );
  ...
  QName NON_SECURED_PERSON_SERVICE = QName.createQName(
    NamespaceService.ALFRESCO_URI,
    "personService"
  );
  QName NON_SECURED_TRANSLATION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "translationService"
  );
  QName CIRCABC_RENDITION_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "circabcRenditionService"
  );
  QName RENDITION_DAO_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "renditionDaoService"
  );

  QName CIRCABC_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "CircabcService"
  );
  QName NON_SECURED_CIRCABC_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "circabcService"
  );

  QName SECURITY_SERVICE = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "SecurityService"
  );

  QName CIRCABC_RENDITION_HELPER = QName.createQName(
    CircabcNameSpaceService.CEC_DIGIT_URI,
    "circabcRenditionHelper"
  );
