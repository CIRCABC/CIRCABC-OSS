...
public enum MailTemplate {
  ...
  GROUP_DELETE_REQUEST {
    public String getTemplateDirectoryName() {
      return "requestDeleteInterestGroup";
    }
    ...
    public String getDefaultSubject() {
      return translate("group_request_delete_template_mail_subject");
    }
  ...
  GROUP_DELETE_REQUEST_LEADERS {
    public String getTemplateDirectoryName() {
      return "requestDeleteInterestGroupLeaders";
    }
  ...
  NOTIFY_NEWS {
    ...
    public String getDefaultSubject() {
      return translate(
        "notification_message_news_subject",
        CircabcConfiguration.getApplicationName()
      );
    }
  ...
  CATEGORY_GROUP_REQUEST_ACCEPT {
    ...
    public String getDefaultSubject() {
      return translate(
        "category_group_request_acceptation_template_mail_subject"
      );
    }
  ...
  CATEGORY_GROUP_DELETE_REQUEST_REFUSE {
    public String getTemplateDirectoryName() {
      return "categoryGroupDeleteRequest";
    }
    ...
    public String getDefaultSubject() {
      return translate("category_group_delete_request_template_mail_subject");
    }
  ...
  NOTIFY_DELETE_BULK {
    public String getTemplateDirectoryName() {
      return "notifyDeleteDocumentsBulk";
    }
    ...
    public String getDefaultSubject() {
      return translate("delete_documents_bulk_template_mail_subject");
    }
  ...
  NOTIFY_EDIT_BULK {
    public String getTemplateDirectoryName() {
      return "notifyEditDocumentsBulk";
    }
    ...
    public String getDefaultSubject() {
      return translate("edit_documents_bulk_template_mail_subject");
    }
