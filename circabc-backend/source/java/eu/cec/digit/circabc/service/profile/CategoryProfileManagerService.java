...
public interface CategoryProfileManagerService extends ProfileManagerService {
  String SERVICE_NAME = "categoryProfileManagerService";
  String PROXIED_SERVICE_NAME = "CategoryProfileManagerService";
   ...
   * still contain users,
   *
   * @param nodeRef         rootNode the profile belongs to
   * @param profileName     profile name being deleted
   * @param cleanPermission if true it will parse all sub tree to clean all permission set to this
   *                        profile
   */
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = {
   ...
   * @param nodeRef     root og the Profile
   */
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = {
  ...
  interface Profiles {
    ...
    String CIRCA_CATEGORY_ADMIN = "CircaCategoryAdmin";

    String CIRCA_CATEGORY_MANAGE_MEMBERS = "CircaCategoryManageMembers";
  }
