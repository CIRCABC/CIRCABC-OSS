 ...
 */
// @PublicService
public interface CircabcRootProfileManagerService extends ProfileManagerService {
     ...
     */
    @Auditable(/*key = Auditable.Key.ARG_0, */ parameters = {"nodeRef", "permissions", "access"})
