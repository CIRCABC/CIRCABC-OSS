...
/**
 * This service provides operations to manage node with aspect CircaBC
 *
 ...
 */
// @PublicService
public interface CircabcRootProfileManagerService
  extends ProfileManagerService {
  String ALL_CIRCA_USERS_AUTHORITY = "GROUP_EVERYONE";
  String SERVICE_NAME = "circabcRootProfileManagerService";
  String PROXIED_SERVICE_NAME = "CircabcRootProfileManagerService";
  ...
  @NotAuditable
  String createAllCircaUsersGroup();

  @NotAuditable
  String createCircaSupportGroup();
   ...
   */
  @NotAuditable
  String getAllCircaUsersGroupName();
   ...
   */
  @NotAuditable
  String getPrefixedAllCircaUsersGroupName();
  ...
  /**
   * Add AlfrescoAdmin permissions to the current Node
   */
  @Auditable(
    /*key = Auditable.Key.ARG_0, */parameters = {
      "nodeRef", "permissions", "access",
    }
  )
  void setAlfrescoAdminPermissions(
    final NodeRef nodeRef,
  ...
  interface Profiles {
    ...
    String CIRCABC_ADMIN = "CircaBCAdmin";
  }
