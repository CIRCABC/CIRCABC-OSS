...
public class RenditionDaoServiceImpl implements RenditionDaoService {
  ...
  public void addRequest(Request request) {
    List<Request> existsRequests = (List<
        Request
      >) sqlSessionTemplate.selectList(
      "Rendition.select_request_exists",
  ...
  public List<Request> getRequests(String hostName) {
    return (List<Request>) sqlSessionTemplate.selectList(
      "Rendition.get_requests",
      hostName
    );
  }
  ...
  public List<Request> getRequestsForDocument(String documentId) {
    return (List<Request>) sqlSessionTemplate.selectList(
      "Rendition.get_requests_for_document",
