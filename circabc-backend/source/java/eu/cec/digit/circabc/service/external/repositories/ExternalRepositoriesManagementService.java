...
public interface ExternalRepositoriesManagementService {
  ...
  String PROPERTY_MAIL_TYPE =
    "publish_in_external_repositories_dialog_mail_type";
   ...
   */
  Map<String, Map<String, String>> getRepositoryDataForDocument(
    String documentId
  );
   ...
   */
  List<String> getInternalEntities(
    String firstName,
    String lastName,
    String ecasUserName
  );
   ...
   */
  List<String> getExternalEntities(
    String firstName,
    String lastName,
    String organization
  );
