...
import static eu.cec.digit.circabc.model.CircabcModel.ASPECT_NEWSGROUP_ROOT;

/**
 * This class contains the behaviour behind the 'ci:circaNewsGroupService' aspect. So far this
 * aspect is just used as a tag.
 *
 * @author Clinckart Stephane
 */
public class NewsGroupRootAspect extends AbstractAspect implements
