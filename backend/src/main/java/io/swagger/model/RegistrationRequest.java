...
/**
 * Data transfer object that encapsulates the properties required to register a document (typically
 * an incoming or outgoing mail) within an Interest Group.
 *
 * <p>Instances are populated from the JSON payload of a registration request and carry the metadata
 * describing the document, its senders and recipients, the uploaded content and any associated
 * translations.
 *
 * @author schwerr
 */
public class RegistrationRequest {
  ...
  /** User name under which the document is registered. */
  private String registrationUserName = null;

  /** Subject of the document being registered. */
  private String subject = null;

  /** Free-text comments associated with the registration. */
  private String comments = null;

  /** Identifiers of the senders of the document. */
  private List<String> senderIds = null;

  /** Identifiers of the recipients of the document. */
  private List<String> recipientIds = null;

  /** Type of mail being registered (e.g. incoming or outgoing). */
  private String mailType = null;

  /** Identifier of the previously uploaded content to register as the document. */
  private String uploadedContentId = null;

  /** Name of the file to register. */
  private String fileName = null;

  /** Identifiers of the translations associated with the document. */
