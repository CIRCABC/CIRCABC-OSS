...
public interface KeywordsService {
   ...
   */
  @Auditable(
    /*key = Auditable.Key.ARG_0, */ parameters = { "document", "keyword" }
  )
   ...
   *
   * @param id as NodeRef
   * @return the {@link Keyword} identified by the given node reference
   ...
   * @return the {@link Keyword} identified by the given node reference string
   * @throws InvalidNodeRefException if the id is invalid
   */
  @NotAuditable
   ...
   *
   * @param keyword the keyword whose existence is tested
  ...
  /**
   * Gets a collection of nodes (documents) that have all the given keywords
   *
   * @param parent  the container node under which the search is scoped
   * @param keyword the list of keywords to search for
   * @return a collection of {@link NodeRef} matching the given keywords
   */
  @Auditable(
    /*key = Auditable.Key.ARG_0, */ parameters = { "parent", "keyword" }
  )
  List<NodeRef> getNodesForKeywords(
   ...
   */
  @Auditable(
    /*key = Auditable.Key.ARG_0, */ parameters = { "document", "keywords" }
  )
