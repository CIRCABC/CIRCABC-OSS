...
public interface LogoPreferencesService {
   ...
   */
  @Auditable(
    /* key = Auditable.Key.ARG_0, */ parameters = { "ref", "name", "file" }
  )
  ...
  @Auditable(
    /* key = Auditable.Key.ARG_0, */ parameters = {
      "ref", "name", "inputStream",
    }
  )
  LogoDefinition addLogo(
    final NodeRef ref,
    final String name,
   ...
   * @throws CustomizationException If the logos cannot be resolved for the given reference
   */
  @Auditable(/* key = Auditable.Key.ARG_0, */ parameters = { "ref" })
  List<LogoDefinition> getAllLogos(final NodeRef ref)
   ...
   * @throws CustomizationException If the default configuration cannot be resolved for the given
   *                                reference
   */
  @Auditable(/* key = Auditable.Key.ARG_0, */ parameters = { "ref" })
  DefaultLogoConfiguration getDefault(final NodeRef ref)
    throws CustomizationException;
   ...
   */
  @Auditable(
    /* key = Auditable.Key.ARG_0, */ parameters = { "ref", "logoName" }
  )
  void removeLogo(final NodeRef ref, final String logoName)
    throws CustomizationException;
   ...
   *
   * @param ref      The node on which the logo is setted
   * @param logoReference The logo to set as default or null to set no logo
  ...
  void setDefault(final NodeRef ref, final NodeRef logoReference)
    throws CustomizationException;
   ...
   * @throws CustomizationException If the main page logo configuration cannot be applied to the
   *                                given reference
   */
  @Auditable(
    /* key = Auditable.Key.ARG_0, */ parameters = {
      "ref", "display", "height", "width", "sizeForced", "logoAtLeft",
    }
  )
   ...
   * @param width      The width of the logo
   * @param sizeForced If the defined sizes must be forced or are maximum
   * @throws CustomizationException If the configuration for the other pages cannot be applied to
   *                                the given reference
   */
  @Auditable(
    /* key = Auditable.Key.ARG_0, */ parameters = {
      "ref", "display", "height", "width", "sizeForced",
    }
  )
  ...
  /**
   * Retrieve the default logo configuration for the given node, optionally creating it when it does
   * not yet exist.
   *
   * @param ref             The node whose default logo configuration is requested
   * @param createIfMissing If <code>true</code>, a new configuration is created when none exists;
   *                        if <code>false</code>, no configuration is created when it is missing
   * @return The (possibly newly created) default logo configuration
   * @throws CustomizationException If the configuration cannot be resolved or created for the given
   *                                reference
   */
  @Auditable(
    /* key = Auditable.Key.ARG_0, */ parameters = { "ref", "createIfMissing" }
  )
  ...
  /**
   * Clear any cached logo configuration held by the service, forcing subsequent reads to be
   * resolved again from the repository.
   */
