...
public interface NodePreferencesService {
   ...
   * @param configElement  The final configuration element definition
   * @param fileName       The file name of the configuration file
   * @return {@code true} if the target customization file exists, {@code false} otherwise
   */
   ...
   * @param configElement  The final configuration element definition
   * @param fileName       The file name of the configuration file
   * @return The node reference of the target customization file
   ...
   *
   * @param customizationNode The node from which to resolve the owning customizable node
   * @return The customizable node that owns the given customization node, or {@code null} if the
   *         node is not located under a customization root
   */
   ...
   *
   * @param nodeRef        The customizable node holding the file to delete
   * @param configTypeRoot The configuration type root
   * @param configSubType  The configuration subtype
   * @param configElement  The final configuration element definition
   * @param fileName       The file name of the configuration file to remove
  ...
  /**
   * Update (refresh) the reference to the root preferences folder used as the top-level container
   * for node customizations.
   */
  @Auditable
