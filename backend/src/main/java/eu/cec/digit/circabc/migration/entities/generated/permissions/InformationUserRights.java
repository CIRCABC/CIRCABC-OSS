...
public class InformationUserRights extends XMLElement implements Serializable {
   ...
   */
  public InformationUserRights(
    final List<InformationPermissionItem> permissions,
  ...
  public InformationUserRights withPermissions(
    InformationPermissionItem... values
  ) {
    if (values != null) {
  ...
  public InformationUserRights withPermissions(
    Collection<InformationPermissionItem> values
  ) {
    if (values != null) {
