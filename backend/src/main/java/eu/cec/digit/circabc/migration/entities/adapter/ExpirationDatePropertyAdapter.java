...
/**
 * Adapt the ExpirationDate property.
 *
 * @author Yanick Pignot
 */

public class ExpirationDatePropertyAdapter extends PropertyAdapterBase {

  @Override
  public String marshal(TypedProperty typedProperty) {
    final String strValue = DateAdapterUtils.marshalDate(
      (Date) typedProperty.getValue()
    );
    return strValue;
  }
  ...
  public TypedProperty unmarshal(String propertyStringValue) throws Exception {
    ...
    return new TypedProperty.ExpirationDateProperty(date);
  }
}
