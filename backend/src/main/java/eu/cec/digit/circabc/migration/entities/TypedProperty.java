...
public interface TypedProperty extends Serializable {
   ...
   *
   * @see CircabcModel#PROP_CONTACT_INFORMATION
   * @author Yanick Pignot
   */
   ...
   *
   * @see CircabcModel#PROP_INF_INDEX_PAGE
   * @author Yanick Pignot
   */
   ...
   *
   * @see CircabcModel#PROP_INF_ADAPT
   * @author Yanick Pignot
   */
   ...
   *
   * @see EventModel#PROP_WEEK_START_DAY
   * @author Yanick Pignot
   */
  public class WeekStartDayProperty extends TypedPropertyBase {
    ...
    public WeekStartDayProperty(final String value) {
      ...
      if (!isValueInList(value, EventModel.WEEK_START_DAY_CONSTRAINT_VALUES)) {
        throw new IllegalArgumentException(
          "Ivalid value for Week Start Day: '" +
            value +
            "' not contained in " +
            listToString(EventModel.WEEK_START_DAY_CONSTRAINT_VALUES)
        );
      }
    }
  }
  ...
  public class StatusProperty extends TypedPropertyBase {
    ...
    public StatusProperty(final String value) {
      ...
      if (!isValueInList(value, VALUES)) {
        throw new IllegalArgumentException(
          "Ivalid value for Status property: '" +
            value +
            "' not contained in " +
            listToString(VALUES)
        );
   ...
   *
   * @see DocumentModel#PROP_ISSUE_DATE
   * @author Yanick Pignot
   */
   ...
   *
   * @see DocumentModel#PROP_REFERENCE
   * @author Yanick Pignot
   */
   ...
   *
   * @see DocumentModel#PROP_DYN_ATTR_1
   * @author Yanick Pignot
   */
   ...
   *
   * @see DocumentModel#PROP_DYN_ATTR_2
   * @author Yanick Pignot
   */
   ...
   *
   * @see DocumentModel#PROP_DYN_ATTR_3
   * @author Yanick Pignot
   */
   ...
   *
   * @see DocumentModel#PROP_DYN_ATTR_4
   * @author Yanick Pignot
   */
   ...
   *
   * @see DocumentModel#PROP_DYN_ATTR_5
   * @author Yanick Pignot
   */
  ...
  public class DynamicProperty6 extends TypedPropertyBase {
    ...
    public DynamicProperty6(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_6);
    }
  }
  ...
  public class DynamicProperty7 extends TypedPropertyBase {
    ...
    public DynamicProperty7(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_7);
    }
  }
  ...
  public class DynamicProperty8 extends TypedPropertyBase {
    ...
    public DynamicProperty8(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_8);
    }
  }
  ...
  public class DynamicProperty9 extends TypedPropertyBase {
    ...
    public DynamicProperty9(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_9);
    }
  }
  ...
  public class DynamicProperty10 extends TypedPropertyBase {
    ...
    public DynamicProperty10(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_10);
    }
  }
  ...
  public class DynamicProperty11 extends TypedPropertyBase {
    ...
    public DynamicProperty11(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_11);
    }
  }
  ...
  public class DynamicProperty12 extends TypedPropertyBase {
    ...
    public DynamicProperty12(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_12);
    }
  }
  ...
  public class DynamicProperty13 extends TypedPropertyBase {
    ...
    public DynamicProperty13(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_13);
    }
  }
  ...
  public class DynamicProperty14 extends TypedPropertyBase {
    ...
    public DynamicProperty14(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_14);
    }
  }
  ...
  public class DynamicProperty15 extends TypedPropertyBase {
    ...
    public DynamicProperty15(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_15);
    }
  }
  ...
  public class DynamicProperty16 extends TypedPropertyBase {
    ...
    public DynamicProperty16(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_16);
    }
  }
  ...
  public class DynamicProperty17 extends TypedPropertyBase {
    ...
    public DynamicProperty17(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_17);
    }
  }
  ...
  public class DynamicProperty18 extends TypedPropertyBase {
    ...
    public DynamicProperty18(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_18);
    }
  }
  ...
  public class DynamicProperty19 extends TypedPropertyBase {
    ...
    public DynamicProperty19(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_19);
    }
  }
  ...
  public class DynamicProperty20 extends TypedPropertyBase {
    ...
    public DynamicProperty20(final Serializable value) {
      super(value, DocumentModel.PROP_DYN_ATTR_20);
    }
  }
   ...
   *
   * @see DocumentModel#PROP_EXPIRATION_DATE
   * @author Yanick Pignot
   */
   ...
   *
   * @see DocumentModel#PROP_SECURITY_RANKING
   * @author Yanick Pignot
   */
  public class SecurityRankingProperty extends TypedPropertyBase {
    ...
    public SecurityRankingProperty(final String value) {
      ...
      if (!isValueInList(value, VALUES)) {
        throw new IllegalArgumentException(
          "Ivalid value for Security Ranking: '" +
            value +
            "' not contained in " +
            listToString(VALUES)
        );
   ...
   *
   * @see UserModel#PROP_ORGDEPNUMBER
   * @author Yanick Pignot
   */
   ...
   *
   * @see UserModel#PROP_POSTAL_ADDRESS
   * @author Yanick Pignot
   */
   ...
   *
   * @see UserModel#PROP_DESCRIPTION
   * @author Yanick Pignot
   */
   ...
   *
   * @see UserModel#PROP_GLOBAL_NOTIFICATION
   * @author Yanick Pignot
   */
   ...
   *
   * @see UserModel#PROP_VISISBILITY
   * @author Yanick Pignot
   */
