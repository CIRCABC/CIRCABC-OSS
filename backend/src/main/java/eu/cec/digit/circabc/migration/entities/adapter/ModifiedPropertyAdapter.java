...
/**
 * Adapt the modified date property.
 *
 * @author Yanick Pignot
 */

public class ModifiedPropertyAdapter extends PropertyAdapterBase {

  @Override
  public String marshal(TypedProperty typedProperty) {
    final String strValue = DateAdapterUtils.marshalDateTime(
  ...
  public TypedProperty unmarshal(String propertyStringValue) throws Exception {
    ...
    return new TypedProperty.ModifiedProperty(date);
  }
}
