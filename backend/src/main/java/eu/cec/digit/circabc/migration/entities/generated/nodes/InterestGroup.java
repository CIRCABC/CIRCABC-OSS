...
public class InterestGroup extends NamedNode implements Serializable {

  private static final long serialVersionUID = 1L;

  @XmlElement(
    name = "I18NContactInfo",
  ...
  public InterestGroup(
    ...
    final List<I18NProperty> i18NContactInfos,
    final ContactInfoProperty contactInfo,
    final KeywordDefinitions keywordDefinitions,
    final DynamicPropertyDefinitions dynamicPropertyDefinitions,
    final Notifications notifications,
    final Applications applications,
    final LogoDefinitions logoDefinitions,
    final Information information,
    final Library library,
    final Directory directory,
    final Events events,
    final Newsgroups newsgroups,
  ...
  public InterestGroup withDynamicPropertyDefinitions(
    DynamicPropertyDefinitions value
  ) {
  ...
  @Override
  public InterestGroup withExtendedProperties(
