...
@XmlType(name = "keywordDefinition", propOrder = { "i18NValues", "value" })
public class KeywordDefinition extends XMLElement implements Serializable {
   ...
   */
  public KeywordDefinition(
    final List<I18NProperty> i18NValues,
    final String value,
    final Integer id
  ) {
    super();
