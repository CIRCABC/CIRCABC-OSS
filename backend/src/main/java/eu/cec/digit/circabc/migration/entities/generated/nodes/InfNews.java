...
public class InfNews extends NamedNode implements Serializable {

  private static final long serialVersionUID = 1L;

  @XmlElement(
    namespace = "https://circabc.europa.eu/Import/PermissionsSchema/1.0"
  )
  protected Notifications notifications;

  @XmlElement(
    namespace = "https://circabc.europa.eu/Import/PropertiesSchema/1.0"
  )
  ...
  public String getNewsPattern() {
    return newsPattern;
  }

  public void setNewsPattern(String value) {
    this.newsPattern = value;
  }

  public String getNewsLayout() {
    return newsLayout;
  }

  public void setNewsLayout(String value) {
    this.newsLayout = value;
  }
  ...
  public void setNewsSize(Integer value) {
    this.newsSize = value;
  }
  ...
  public InfNews withNotifications(Notifications value) {
    setNotifications(value);
    return this;
  }

  public InfNews withNewsContent(String value) {
    setNewsContent(value);
    return this;
  }

  public InfNews withNewsPattern(String value) {
    setNewsPattern(value);
    return this;
  }

  public InfNews withNewsLayout(String value) {
    setNewsLayout(value);
    return this;
  }

  public InfNews withNewsSize(Integer value) {
    setNewsSize(value);
    return this;
  }

  public InfNews withNewsDate(Date value) {
    setNewsDate(value);
    return this;
  }

  public InfNews withNewsUrl(String value) {
    setNewsUrl(value);
    return this;
  }
  ...
  @Override
  public InfNews withName(NameProperty value) {
    setName(value);
    return this;
  }
  ...
  @Override
  public InfNews withTitle(TitleProperty value) {
    setTitle(value);
    return this;
  }
  ...
  @Override
  public InfNews withDescription(DescriptionProperty value) {
    setDescription(value);
    return this;
  }

  @Override
  public InfNews withOwner(OwnerProperty value) {
    setOwner(value);
    return this;
  }

  @Override
  public InfNews withNodeReference(NodeRef value) {
  ...
  public InfNews withExtendedProperties(ExtendedProperty... values) {
    if (values != null) {
      for (ExtendedProperty v : values) {
        getExtendedProperties().add(v);
      }
    }
    return this;
  }
  ...
  @Override
  public InfNews withCreated(CreatedProperty value) {
    setCreated(value);
    return this;
  }

  @Override
  public InfNews withCreator(CreatorProperty value) {
    setCreator(value);
    return this;
  }

  @Override
  public InfNews withModified(ModifiedProperty value) {
    setModified(value);
    return this;
  }

  @Override
  public InfNews withModifier(ModifierProperty value) {
    setModifier(value);
    return this;
  }
}
