...
@XmlType(
  ...
  propOrder = {
    "informationUserRights", "infSpaces", "infMLContents", "infContents",
  }
)
@XmlRootElement(name = "infSpace")
public class InfSpace extends NamedNode implements Serializable {
  ...
  public InfSpace(
    ...
    final InformationUserRights informationUserRights,
