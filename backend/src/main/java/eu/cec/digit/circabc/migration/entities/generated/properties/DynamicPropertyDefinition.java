...
@XmlType(
  name = "dynamicPropertyDefinition",
  propOrder = { "type", "i18NValues", "value", "selectionCases" }
)
  ...
  implements Serializable
{
   ...
   */
  public DynamicPropertyDefinition(
    final DynPropertyType type,
    final List<I18NProperty> i18NValues,
    final String value,
    final List<String> selectionCases,
    final Integer id
  ) {
    super();
    this.type = type;
  ...
  public DynamicPropertyDefinition withI18NValues(
  ...
  public DynamicPropertyDefinition withSelectionCases(
