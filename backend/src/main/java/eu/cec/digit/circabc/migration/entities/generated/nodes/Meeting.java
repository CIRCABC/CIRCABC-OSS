...
public class Meeting extends Appointment implements Serializable {
  ...
  public Meeting(
    ...
    final TimesOccurence timesOccurence,
    final SingleDate singleDate,
    final TimeZone timeZoneId,
    final String location,
    final AudienceClosed audienceClosed,
    final AudienceOpen audienceOpen,
    ...
    final List<MeetingRequestStatus> meetingRequestStatuses
  ) {
    super(
      appointmentTitle,
      language,
  ...
  public Meeting withMeetingRequestStatuses(
    Collection<MeetingRequestStatus> values
  ) {
    if (values != null) {
