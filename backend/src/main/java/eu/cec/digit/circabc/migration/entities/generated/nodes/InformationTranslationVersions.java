...
@XmlType(name = "informationTranslationVersions", propOrder = { "versions" })
  ...
  implements Serializable
{
   ...
   */
  public InformationTranslationVersions(
    final List<InformationTranslationVersion> versions
  ) {
    super();
  ...
  public InformationTranslationVersions withVersions(
    InformationTranslationVersion... values
  ) {
    if (values != null) {
  ...
  public InformationTranslationVersions withVersions(
    Collection<InformationTranslationVersion> values
  ) {
    if (values != null) {
