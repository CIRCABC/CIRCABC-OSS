...
@XmlSeeAlso({ ImportedProfile.class, AccessProfile.class })
public class EmptyAccessProfile extends XMLElement implements Serializable {
  ...
  public EmptyAccessProfile withI18NDescriptions(
  ...
  public EmptyAccessProfile withInformationPermission(
  ...
  public EmptyAccessProfile withDirectoryPermission(
    DirectoryPermissions value
  ) {
  ...
  public EmptyAccessProfile withNewsgroupPermission(
    NewsgroupPermissions value
  ) {
