...
public class MlContent extends NamedNode implements Serializable {
  ...
  public MlContent(
    ...
    final List<LibraryTranslation> translations,
    final Discussions discussions,
    final LocaleProperty pivotLang
  ) {
    super(
      nodeReference,
      extendedProperties,
