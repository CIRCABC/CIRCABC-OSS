...
public class Information extends TitledNode implements Serializable {
  ...
  public Information(
    ...
    final IndexPageProperty indexPage,
    final AdaptProperty adapt,
    final List<InfSpace> infSpaces,
    final List<InfMLContent> infMLContents,
    final List<InfContent> infContents
  ) {
    super(
      nodeReference,
      extendedProperties,
  ...
  public Information withDisplayOldInformation(
    DisplayOldInformationProperty value
  ) {
  ...
  @Override
  public Information withExtendedProperties(
