...
@XmlSeeAlso({ Person.class, Directory.class, Message.class, TitledNode.class })
public abstract class Node extends XMLNode implements Serializable {
   ...
   *
   * <p>This holds the NodeRef of the node in the source system this node was
   * migrated/exported from. It is written on export and, on import, is stored on
   * the created node as the {@code ci:originalNodeRef} property of the
   ...
   *
   * @param value the original (source) node reference
   */
