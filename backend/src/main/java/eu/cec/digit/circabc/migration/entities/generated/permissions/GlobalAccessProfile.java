...
@XmlSeeAlso({ RegistredUsers.class, Guest.class })
public class GlobalAccessProfile extends XMLElement implements Serializable {
  ...
  public GlobalAccessProfile(
    ...
    final SimpleInformationPermissions informationPermission,
    final SimpleLibraryPermissions libraryPermission,
    final SimpleDirectoryPermissions directoryPermission,
    final SimpleEventPermissions eventPermission,
    final SimpleNewsgroupPermissions newsgroupPermission,
  ...
  public GlobalAccessProfile withI18NDescriptions(
  ...
  public GlobalAccessProfile withInformationPermission(
    SimpleInformationPermissions value
  ) {
    setInformationPermission(value);
    return this;
  }

  public GlobalAccessProfile withLibraryPermission(
    SimpleLibraryPermissions value
  ) {
    setLibraryPermission(value);
    return this;
  }

  public GlobalAccessProfile withDirectoryPermission(
    SimpleDirectoryPermissions value
  ) {
  ...
  public GlobalAccessProfile withNewsgroupPermission(
    SimpleNewsgroupPermissions value
  ) {
