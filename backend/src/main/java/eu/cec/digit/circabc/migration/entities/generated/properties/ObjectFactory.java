...
public class ObjectFactory {
  ...
  private static final QName _ExpirationDate_QNAME = new QName(
    "https://circabc.europa.eu/Import/PropertiesSchema/1.0",
    "expirationDate"
  );
  private static final QName _Target_QNAME = new QName(
    "https://circabc.europa.eu/Import/PropertiesSchema/1.0",
    "target"
  );
  private static final QName _VersionNote_QNAME = new QName(
    "https://circabc.europa.eu/Import/PropertiesSchema/1.0",
    "versionNote"
  );
  private static final QName _VersionLabel_QNAME = new QName(
    "https://circabc.europa.eu/Import/PropertiesSchema/1.0",
    "versionLabel"
  );
  ...
  public JAXBElement<ExpirationDateProperty> createExpirationDate(
    ExpirationDateProperty value
  ) {
    return new JAXBElement<ExpirationDateProperty>(
      _ExpirationDate_QNAME,
      ExpirationDateProperty.class,
      null,
      value
    );
  }
  ...
  public JAXBElement<URLProperty> createTarget(URLProperty value) {
    return new JAXBElement<URLProperty>(
      _Target_QNAME,
      URLProperty.class,
      null,
      value
  ...
  public JAXBElement<VersionNoteProperty> createVersionNote(
    VersionNoteProperty value
  ) {
    return new JAXBElement<VersionNoteProperty>(
      _VersionNote_QNAME,
      VersionNoteProperty.class,
      null,
      value
    );
  }
  ...
  public JAXBElement<VersionLabelProperty> createVersionLabel(
    VersionLabelProperty value
  ) {
    return new JAXBElement<VersionLabelProperty>(
      _VersionLabel_QNAME,
      VersionLabelProperty.class,
      null,
      value
    );
  }
