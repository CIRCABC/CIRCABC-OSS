...
@XmlType(name = "circabc", propOrder = { "circabcAdmin", "categoryHeaders" })
@XmlRootElement(name = "circabc")
public class Circabc extends TitledNode implements Serializable {
  ...
  public Circabc(
    ...
    final CircabcAdmin circabcAdmin,
