...
public class LibraryContentVersion extends ContentNode implements Serializable {
  ...
  public LibraryContentVersion withSecurityRanking(
    SecurityRankingProperty value
  ) {
    setSecurityRanking(value);
    return this;
  }

  public LibraryContentVersion withExpirationDate(
    ExpirationDateProperty value
  ) {
  ...
  @Override
  public LibraryContentVersion withI18NDescriptions(
  ...
  @Override
  public LibraryContentVersion withExtendedProperties(
