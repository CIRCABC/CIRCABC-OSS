...
@XmlType(name = "link", propOrder = { "notifications", "libraryUserRights" })
@XmlSeeAlso({ SharedSpacelink.class })
public class Link extends NamedNode implements Serializable {
