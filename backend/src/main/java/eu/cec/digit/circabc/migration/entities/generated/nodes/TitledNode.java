...
@XmlType(
  name = "titledNode",
  propOrder = {
    "i18NTitles", "title", "i18NDescriptions", "description", "owner",
  }
)
@XmlSeeAlso(
  {
...
public abstract class TitledNode extends Node implements Serializable {
  ...
  @Override
  public TitledNode withExtendedProperties(
