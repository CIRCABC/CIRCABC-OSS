...
@XmlType(name = "newsgroups", propOrder = { "notifications", "fora", "topics" })
@XmlRootElement(name = "newsgroups")
public class Newsgroups extends TitledNode implements Serializable {
  ...
  @Override
  public Newsgroups withExtendedProperties(
