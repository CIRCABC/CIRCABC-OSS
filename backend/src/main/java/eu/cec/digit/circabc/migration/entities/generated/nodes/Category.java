...
@XmlType(name = "category", propOrder = { "categoryAdmin", "interestGroups" })
@XmlRootElement(name = "category")
public class Category extends NamedNode implements Serializable {
  ...
  public Category(
    ...
    final CategoryAdmin categoryAdmin,
    final List<InterestGroup> interestGroups
  ) {
    super(
      nodeReference,
      extendedProperties,
