...
public class HistoryMembershipsExpirationPostTest {

  private HistoryMembershipsExpirationPost webScript;
  ...
  public void setUp() throws Exception {
    webScript = new HistoryMembershipsExpirationPost();
  ...
  private void setField(String fieldName, Object value) throws Exception {
    Field field = HistoryMembershipsExpirationPost.class.getDeclaredField(
      fieldName
    );
