...
public class GuardsAdministrationGetTest {

  private GuardsAdministrationGet webScript;
  ...
  public void setUp() throws Exception {
    webScript = new GuardsAdministrationGet();
    guardsApi = mock(GuardsApi.class);

    Field field = GuardsAdministrationGet.class.getDeclaredField("guardsApi");
  ...
  public void testExecuteImpl_whenSuccess_thenReturnsGuardAuthorization()
    ...
    when(guardsApi.guardsAdministrationIdGet("test-node-id")).thenReturn(
      expected
    );
  ...
  public void testExecuteImpl_whenAccessDenied_thenReturnsGrantedFalse()
    throws Exception {
    when(req.getParameter("language")).thenReturn(null);
    when(guardsApi.guardsAdministrationIdGet("test-node-id")).thenThrow(
