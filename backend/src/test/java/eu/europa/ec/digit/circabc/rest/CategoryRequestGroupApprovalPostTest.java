...
public class CategoryRequestGroupApprovalPostTest {

  private CategoryRequestGroupApprovalPost webScript;
  ...
  public void setUp() throws Exception {
    webScript = new CategoryRequestGroupApprovalPost();
  ...
  private void setField(String fieldName, Object value) throws Exception {
    Field field = CategoryRequestGroupApprovalPost.class.getDeclaredField(
      fieldName
    );
  ...
  public void testExecuteImpl_whenCategoryAdmin_thenSuccess() throws Exception {
    ...
    verify(categoriesApi).categoriesIdGroupRequestApprovalPost(
      eq("cat-123"),
      any(GroupCreationRequestApproval.class),
      eq("admin")
    );
  }
