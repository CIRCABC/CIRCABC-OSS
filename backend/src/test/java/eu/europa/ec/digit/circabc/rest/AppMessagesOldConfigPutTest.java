...
public class AppMessagesOldConfigPutTest {

  private AppMessagesOldConfigPut webScript;
  ...
  public void setUp() throws Exception {
    webScript = new AppMessagesOldConfigPut();
  ...
  @Test
  public void testExecuteImpl_whenAlfrescoAdmin_thenSetsEnableOld()
    throws Exception {
    ...
    verify(appMessageApi).setEnableOldMessage(true);
  }

  @Test
  public void testExecuteImpl_whenCircabcAdmin_thenSetsEnableOld()
    throws Exception {
    when(currentUserPermissionCheckerService.isAlfrescoAdmin()).thenReturn(
      false
    );
    ...
    assertNotNull(result);
    verify(appMessageApi).setEnableOldMessage(false);
  }
  ...
  public void testExecuteImpl_whenNotAdmin_thenForbidden() throws Exception {
    ...
    verify(appMessageApi, never()).setEnableOldMessage(anyBoolean());
  }
  ...
  public void testExecuteImpl_whenUnexpectedException_thenInternalServerError()
    ...
    doThrow(new RuntimeException("DB error"))
      .when(appMessageApi)
      .setEnableOldMessage(anyBoolean());
  ...
  private void setField(String fieldName, Object value) throws Exception {
    Field field = AppMessagesOldConfigPut.class.getDeclaredField(fieldName);
