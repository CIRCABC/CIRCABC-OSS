...
public class AppMessageDaoServiceTest {
  ...
  @Test
  public void testAddAppMessageTemplate_whenCalled_thenInserts() {
  ...
  @Test
  public void testUpdateAppMessageTemplate_whenCalled_thenUpdates() {
    Date closure = new Date();
  ...
  public void testSelectDistributionEmails_whenSearchIsNull_thenUsesEmptyString() {
    ...
    List<DistributionEmailDAO> result = service.selectDistributionEmails(
      1,
      10,
      null
    );
