...
public class GuardsEditionGetTest {

  private GuardsEditionGet webScript;
  ...
  public void setUp() throws Exception {
    webScript = new GuardsEditionGet();
    guardsApi = mock(GuardsApi.class);

    Field field = GuardsEditionGet.class.getDeclaredField("guardsApi");
  ...
  public void testExecuteImpl_whenSuccess_thenReturnsGuardAuthorization()
    ...
    when(guardsApi.guardsEditionIdGet("test-node-id")).thenReturn(expected);
  ...
  public void testExecuteImpl_whenAccessDenied_thenReturnsGrantedFalse()
    throws Exception {
    when(req.getParameter("language")).thenReturn(null);
    when(guardsApi.guardsEditionIdGet("test-node-id")).thenThrow(
