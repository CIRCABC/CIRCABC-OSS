...
public class GroupRequestsDaoServiceTest {
  ...
  @Test
  public void testGetCountCategoryGroupCreationRequests() {
    when(
  ...
  @Test
  public void testGetCategoryGroupCreationRequests_converts() {
  ...
  @Test
  public void testGetCategoryGroupCreationRequests_empty() {
    when(
      sqlSessionTemplate.selectList(
        eq("GroupRequests.select_category_group_requests"),
        anyMap()
  ...
  @Test
  public void testGetCategoryGroupCreationRequests_leadersAndReviewer() {
    GroupCreationRequestDAO dao = new GroupCreationRequestDAO();
    dao.setId(2);
  ...
  @Test
  public void testExistsGroupDeleteRequest_true() {
    when(
      sqlSessionTemplate.selectOne(
  ...
  @Test
  public void testExistsGroupDeleteRequest_false() {
    when(
      sqlSessionTemplate.selectOne(
        eq("GroupRequests.select_count_group_delete_requests"),
        anyMap()
  ...
  @Test
  public void testUpdateGroupCreationRequestApproval() {
  ...
  @Test
  public void testGetCategoryGroupCreationRequestById_exists() {
    GroupCreationRequestDAO dao = new GroupCreationRequestDAO();
    dao.setId(5);
  ...
  @Test
  public void testGetCategoryGroupCreationRequestById_notExists() {
    when(
      sqlSessionTemplate.selectOne(
        eq("GroupRequests.select_category_group_request"),
        anyMap()
  ...
  @Test
  public void testGetCountCategoryGroupDeletionRequests() {
    when(
      sqlSessionTemplate.selectOne(
  ...
  @Test
  public void testDeleteRequestDeletion() {
  ...
  @Test
  public void testGetCategoryGroupDeletionRequests_converts() {
  ...
  @Test
  public void testGetCategoryGroupDeletionRequestById_notExists() {
    when(
      sqlSessionTemplate.selectOne(
  ...
  @Test
  public void testUpdateRequestDeletion() {
  ...
  @Test
  public void testUpdateRequestDeletion_rejected() {
    GroupDeletionRequest body = new GroupDeletionRequest();
    body.setId(1L);
    body.setAgreement(-1);
